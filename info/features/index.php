...
<div class="intec-content">
    <div class="intec-content-wrapper">
        ...
        <div>
            ...
            <div class="intec-ui intec-ui-control-numeric intec-ui-scheme-current" data-ui-control="numeric" data-ui-options="{'value': 1}">
                <button class="intec-ui-part-decrement" data-type="button" data-action="decrement">-</button>
                <input type="text" class="intec-ui-part-input" value="1" data-type="input" />
                <button class="intec-ui-part-increment" data-type="button" data-action="increment">+</button>
            </div>
            <h6>Варианты отображения</h6>
            <p>
                Имеет несколько вариантов отображения, необходимо добавить класс <code>.intec-ui-view-&lt;значение&gt;</code>, где &lt;значение&gt; - число.
            ...
            <div class="intec-ui-m-b-20">
                <div class="intec-grid intec-grid-wrap intec-grid-i-5">
                    ...
                    <div class="intec-grid-item-1">
                        <div class="intec-ui intec-ui-control-numeric intec-ui-scheme-current intec-ui-view-1" data-ui-control="numeric" data-ui-options="{'value': 1}">
                            <button class="intec-ui-part-decrement" data-type="button" data-action="decrement">-</button>
                            <input type="text" class="intec-ui-part-input" value="1" data-type="input" />
                            <button class="intec-ui-part-increment" data-type="button" data-action="increment">+</button>
                        </div>
                    ...
                    <div class="intec-grid-item-1">
                        <div class="intec-ui intec-ui-control-numeric intec-ui-scheme-current intec-ui-view-2" data-ui-control="numeric" data-ui-options="{'value': 1}">
                            <button class="intec-ui-part-decrement" data-type="button" data-action="decrement">-</button>
                            <input type="text" class="intec-ui-part-input" value="1" data-type="input" />
                            <button class="intec-ui-part-increment" data-type="button" data-action="increment">+</button>
                        </div>
                    ...
                    <div class="intec-grid-item-1">
                        <div class="intec-ui intec-ui-control-numeric intec-ui-scheme-current intec-ui-view-3" data-ui-control="numeric" data-ui-options="{'value': 1}">
                            <button class="intec-ui-part-decrement" data-type="button" data-action="decrement">-</button>
                            <input type="text" class="intec-ui-part-input" value="1" data-type="input" />
                            <button class="intec-ui-part-increment" data-type="button" data-action="increment">+</button>
                        </div>
                    ...
                    <div class="intec-grid-item-1">
                        <div class="intec-ui intec-ui-control-numeric intec-ui-scheme-current intec-ui-view-4" data-ui-control="numeric" data-ui-options="{'value': 1}">
                            <button class="intec-ui-part-decrement" data-type="button" data-action="decrement">-</button>
                            <input type="text" class="intec-ui-part-input" value="1" data-type="input" />
                            <button class="intec-ui-part-increment" data-type="button" data-action="increment">+</button>
                        </div>
            ...
            <div class="intec-grid intec-grid-wrap intec-grid-i-5">
                <?php foreach ($arSchemes as $sScheme) { ?>
                    <?php if (empty($sScheme)) { ?>
                        <div class="intec-grid-item-1">
                            <div class="intec-ui intec-ui-control-numeric" data-ui-control="numeric" data-ui-options="{'value': 1}">
                                <button class="intec-ui-part-decrement" data-type="button" data-action="decrement">-</button>
                                <input type="text" class="intec-ui-part-input" value="1" data-type="input" />
                                <button class="intec-ui-part-increment" data-type="button" data-action="increment">+</button>
                            </div>
                    ...
                    <?php } else { ?>
                        <div class="intec-grid-item-1">
                            <div class="intec-ui intec-ui-control-numeric intec-ui-scheme-<?= $sScheme ?>" data-ui-control="numeric" data-ui-options="{'value': 1}">
                                <button class="intec-ui-part-decrement" data-type="button" data-action="decrement">-</button>
                                <input type="text" class="intec-ui-part-input" value="1" data-type="input" />
                                <button class="intec-ui-part-increment" data-type="button" data-action="increment">+</button>
                            </div>
            ...
            <div class="intec-grid intec-grid-wrap intec-grid-i-5">
                ...
                <?php foreach ($arSizes as $sSize) { ?>
                    <div class="intec-grid-item-1">
                        <div class="intec-ui intec-ui-control-numeric intec-ui-scheme-current intec-ui-size-<?= $sSize ?>" data-ui-control="numeric" data-ui-options="{'value': 1}">
                            <button class="intec-ui-part-decrement" data-type="button" data-action="decrement">-</button>
                            <input type="text" class="intec-ui-part-input" value="1" data-type="input" />
                            <button class="intec-ui-part-increment" data-type="button" data-action="increment">+</button>
                        </div>
            ...
            <div class="intec-ui-m-b-20">
                <ul class="intec-ui intec-ui-control-tabs intec-ui-scheme-current" data-ui-control="tabs">
                    <li class="intec-ui-part-tab">
                        <a href="#tab-1" data-type="tab">Вкладка 1</a>
                    </li>
                    <li class="intec-ui-part-tab">
                        <a href="#tab-2" data-type="tab">Вкладка 2</a>
                    </li>
                    <li class="intec-ui-part-tab">
                        <a href="#tab-3" data-type="tab">Вкладка 3</a>
                    </li>
                </ul>
                <div class="intec-ui intec-ui-control-tabs-content">
                    <div id="tab-1" class="intec-ui-part-tab">
                        <div class="intec-ui-m-t-20">Контент первой вкладки.</div>
                    </div>
                    <div id="tab-2" class="intec-ui-part-tab">
                        <div class="intec-ui-m-t-20">Контент второй вкладки.</div>
                    </div>
                    <div id="tab-3" class="intec-ui-part-tab">
            ...
            <div class="intec-ui-m-b-20">
                <ul class="intec-ui intec-ui-control-tabs intec-ui-mod-block intec-ui-scheme-current" data-ui-control="tabs">
                    <li class="intec-ui-part-tab">
                        <a href="#block-tab-1" data-type="tab">Вкладка 1</a>
                    </li>
                    <li class="intec-ui-part-tab">
                        <a href="#block-tab-2" data-type="tab">Вкладка 2</a>
                    </li>
                    <li class="intec-ui-part-tab">
                        <a href="#block-tab-3" data-type="tab">Вкладка 3</a>
                    </li>
                </ul>
                <div class="intec-ui intec-ui-control-tabs-content">
                    <div id="block-tab-1" class="intec-ui-part-tab">
                        <div class="intec-ui-m-t-20">Контент первой вкладки.</div>
                    </div>
                    <div id="block-tab-2" class="intec-ui-part-tab">
                        <div class="intec-ui-m-t-20">Контент второй вкладки.</div>
                    </div>
                    <div id="block-tab-3" class="intec-ui-part-tab">
                        <div class="intec-ui-m-t-20">Контент третьей вкладки.</div>
                    </div>
                </div>
            </div>
            ...
            <div class="intec-ui-m-b-20">
                <div class="intec-grid intec-grid-wrap intec-grid-i-10">
                    <div class="intec-grid-item-1">
                        ...
                        <ul class="intec-ui intec-ui-control-tabs intec-ui-scheme-current" data-ui-control="tabs">
                            <li class="intec-ui-part-tab">
                                <a href="#block-view-0-tab-1" data-type="tab">Вкладка 1</a>
                            </li>
                            <li class="intec-ui-part-tab">
                                <a href="#block-view-0-tab-2" data-type="tab">Вкладка 2</a>
                            </li>
                            <li class="intec-ui-part-tab">
                                <a href="#block-view-0-tab-3" data-type="tab">Вкладка 3</a>
                            </li>
                        </ul>
                        <div class="intec-ui intec-ui-control-tabs-content">
                            <div id="block-view-0-tab-1" class="intec-ui-part-tab">
                                <div class="intec-ui-m-t-20">Контент первой вкладки.</div>
                            </div>
                            <div id="block-view-0-tab-2" class="intec-ui-part-tab">
                                <div class="intec-ui-m-t-20">Контент второй вкладки.</div>
                            </div>
                            <div id="block-view-0-tab-3" class="intec-ui-part-tab">
                                <div class="intec-ui-m-t-20">Контент третьей вкладки.</div>
                            </div>
                        </div>
                    </div>
                    <div class="intec-grid-item-1">
                        ...
                        <ul class="intec-ui intec-ui-control-tabs intec-ui-scheme-current intec-ui-view-1" data-ui-control="tabs">
                            <li class="intec-ui-part-tab">
                                <a href="#block-view-1-tab-1" data-type="tab">Вкладка 1</a>
                            </li>
                            <li class="intec-ui-part-tab">
                                <a href="#block-view-1-tab-2" data-type="tab">Вкладка 2</a>
                            </li>
                            <li class="intec-ui-part-tab">
                                <a href="#block-view-1-tab-3" data-type="tab">Вкладка 3</a>
                            </li>
                        </ul>
                        <div class="intec-ui intec-ui-control-tabs-content">
                            <div id="block-view-1-tab-1" class="intec-ui-part-tab">
                                <div class="intec-ui-m-t-20">Контент первой вкладки.</div>
                            </div>
                            <div id="block-view-1-tab-2" class="intec-ui-part-tab">
                                <div class="intec-ui-m-t-20">Контент второй вкладки.</div>
                            </div>
                            <div id="block-view-1-tab-3" class="intec-ui-part-tab">
                                <div class="intec-ui-m-t-20">Контент третьей вкладки.</div>
                            </div>
                        </div>
                    </div>
                    <div class="intec-grid-item-1">
                        ...
                        <ul class="intec-ui intec-ui-control-tabs intec-ui-scheme-current intec-ui-view-2" data-ui-control="tabs">
                            <li class="intec-ui-part-tab">
                                <a href="#block-view-2-tab-1" data-type="tab">Вкладка 1</a>
                            </li>
                            <li class="intec-ui-part-tab">
                                <a href="#block-view-2-tab-2" data-type="tab">Вкладка 2</a>
                            </li>
                            <li class="intec-ui-part-tab">
                                <a href="#block-view-2-tab-3" data-type="tab">Вкладка 3</a>
                            </li>
                        </ul>
                        <div class="intec-ui intec-ui-control-tabs-content">
                            <div id="block-view-2-tab-1" class="intec-ui-part-tab">
                                <div class="intec-ui-m-t-20">Контент первой вкладки.</div>
                            </div>
                            <div id="block-view-2-tab-2" class="intec-ui-part-tab">
                                <div class="intec-ui-m-t-20">Контент второй вкладки.</div>
                            </div>
                            <div id="block-view-2-tab-3" class="intec-ui-part-tab">
                                <div class="intec-ui-m-t-20">Контент третьей вкладки.</div>
                            </div>
                        </div>
                    </div>
                ...
                <?php foreach ($arSchemes as $sScheme) { ?>
                    <?php if (empty($sScheme)) { ?>
                        <div class="intec-grid-item-1">
                            ...
                            <ul class="intec-ui intec-ui-control-tabs" data-ui-control="tabs">
                                <li class="intec-ui-part-tab">
                                    <a href="#block-scheme-default-tab-1" data-type="tab">Вкладка 1</a>
                                </li>
                                <li class="intec-ui-part-tab">
                                    <a href="#block-scheme-default-tab-2" data-type="tab">Вкладка 2</a>
                                </li>
                                <li class="intec-ui-part-tab">
                                    <a href="#block-scheme-default-tab-3" data-type="tab">Вкладка 3</a>
                                </li>
                            </ul>
                            <div class="intec-ui intec-ui-control-tabs-content">
                                <div id="block-scheme-default-tab-1" class="intec-ui-part-tab">
                                    <div class="intec-ui-m-t-20">Контент первой вкладки.</div>
                                </div>
                                <div id="block-scheme-default-tab-2" class="intec-ui-part-tab">
                                    <div class="intec-ui-m-t-20">Контент второй вкладки.</div>
                                </div>
                                <div id="block-scheme-default-tab-3" class="intec-ui-part-tab">
                                    <div class="intec-ui-m-t-20">Контент третьей вкладки.</div>
                                </div>
                            </div>
                        </div>
                    <?php } else { ?>
                        <div class="intec-grid-item-1">
                            ...
                            <ul class="intec-ui intec-ui-control-tabs intec-ui-scheme-<?= $sScheme ?>" data-ui-control="tabs">
                                <li class="intec-ui-part-tab active">
                                    <a href="#block-scheme-<?= $sScheme ?>-tab-1" data-type="tab">Вкладка 1</a>
                                </li>
                                <li class="intec-ui-part-tab">
                                    <a href="#block-scheme-<?= $sScheme ?>-tab-2" data-type="tab">Вкладка 2</a>
                                </li>
                                <li class="intec-ui-part-tab">
                                    <a href="#block-scheme-<?= $sScheme ?>-tab-3" data-type="tab">Вкладка 3</a>
                                </li>
                            </ul>
                            <div class="intec-ui intec-ui-control-tabs-content">
                                <div id="block-scheme-<?= $sScheme ?>-tab-1" class="intec-ui-part-tab">
                                    <div class="intec-ui-m-t-20">Контент первой вкладки.</div>
                                </div>
                                <div id="block-scheme-<?= $sScheme ?>-tab-2" class="intec-ui-part-tab">
                                    <div class="intec-ui-m-t-20">Контент второй вкладки.</div>
                                </div>
                                <div id="block-scheme-<?= $sScheme ?>-tab-3" class="intec-ui-part-tab">
                                    <div class="intec-ui-m-t-20">Контент третьей вкладки.</div>
                                </div>
                            </div>
                        </div>
