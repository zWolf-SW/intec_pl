		...
		<div class="landing-block-card js-animation fadeIn col-md-12 col-lg-12 g-flex-centered">
			<div class="g-pa-30 w-100">
				<div class="landing-block-node-card-header text-uppercase u-heading-v2-4--bottom text-left g-brd-primary g-mb-20">
					<h6 class="landing-block-node-subtitle g-font-weight-700 g-letter-spacing-1 g-color-primary g-mb-20">About us</h6>
					<h2 class="landing-block-node-title h1 u-heading-v2__title g-line-height-1_3 g-font-weight-700 g-color-white">Help make<br> money</h2>
				</div>
