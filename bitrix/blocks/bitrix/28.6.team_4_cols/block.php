		...
		<div class="row g-mx-minus-25 justify-content-center landing-block-inner">
			<div class="landing-block-card-member col-12 col-md-3 col-lg-3 g-px-25 g-pb-0 js-animation fadeInUp">
				...
				<div class="text-center">
					...
					<h5 class="landing-block-node-member-name g-font-weight-700 mb-1">Alex Taylor</h5>
					<div class="landing-block-node-member-post g-color-primary">
						<p>Founder</p>
					</div>
					<hr class="landing-block-node-member-line g-brd-gray-light-v4 g-my-15">
					<a class="landing-block-node-member-email d-block g-transition-0_2 g-color-gray-dark-v2--hover g-font-size-13"
			...
			<div class="landing-block-card-member col-12 col-md-3 col-lg-3 g-px-25 g-pb-0 js-animation fadeInUp">
				...
				<div class="text-center">
					<img class="landing-block-node-member-photo u-shadow-v29 g-width-110 g-height-110 rounded-circle g-mb-40"
						 ...
						 alt="Image Description">
					<h5 class="landing-block-node-member-name g-font-weight-700 mb-1">Kate Metu</h5>
					<div class="landing-block-node-member-post g-color-primary">
						<p>Manager</p>
					</div>
					<hr class="landing-block-node-member-line g-brd-gray-light-v4 g-my-15">
			...
			<div class="landing-block-card-member col-12 col-md-3 col-lg-3 g-px-25 g-pb-0 js-animation fadeInUp">
				...
				<div class="text-center">
					<img class="landing-block-node-member-photo u-shadow-v29 g-width-110 g-height-110 rounded-circle g-mb-40"
						 ...
						 alt="Image Description">
					<h5 class="landing-block-node-member-name g-font-weight-700 mb-1">Daniel Wearne</h5>
					<div class="landing-block-node-member-post g-color-primary">
						<p>Developer</p>
					</div>
					<hr class="landing-block-node-member-line g-brd-gray-light-v4 g-my-15">
			...
			<div class="landing-block-card-member col-12 col-md-3 col-lg-3 g-px-25 g-pb-0 js-animation fadeInUp">
				...
				<div class="text-center">
					<img class="landing-block-node-member-photo u-shadow-v29 g-width-110 g-height-110 rounded-circle g-mb-40"
						 ...
						 alt="Image Description">
					<h5 class="landing-block-node-member-name g-font-weight-700 mb-1">Tina Krueger</h5>
					<div class="landing-block-node-member-post g-color-primary">
						<p>Designer</p>
					</div>
					<hr class="landing-block-node-member-line g-brd-gray-light-v4 g-my-15">
