...
<div class="basket-empty">
    ...
    <div class="basket-empty-title">
        <?= Loc::getMessage('C_BASKET_DEFAULT_2_TEMPLATE_EMPTY_TITLE') ?>
    </div>
    <div class="basket-empty-description">
        <?= Loc::getMessage('C_BASKET_DEFAULT_2_TEMPLATE_EMPTY_DESCRIPTION') ?>
    </div>
    <div class="basket-empty-button">
        <?= Html::tag('a', Loc::getMessage('C_BASKET_DEFAULT_2_TEMPLATE_EMPTY_URL'), [
            'class' => [
                'intec-ui' => [
                    '',
                    'control-button',
