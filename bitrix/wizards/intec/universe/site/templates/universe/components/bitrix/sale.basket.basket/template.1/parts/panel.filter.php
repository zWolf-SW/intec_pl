...
?>
<div class="basket-filter-wrap intec-grid-item intec-grid-item-850-1">
    <?= Html::beginTag('div', [
        'class' => 'basket-filter',
        'data-entity' => 'basket-items-list-header'
    ]) ?>
        <div class="intec-grid intec-grid-a-v-center intec-grid-wrap intec-grid-i-v-8">
            <div class="basket-filter-control-wrap intec-grid-item-3 intec-grid-item-650-1">
                <?= Html::beginTag('div', [
