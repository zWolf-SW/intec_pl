...
<?php $vButtons = function (&$arItem) use (&$arResult, &$arVisual) { ?>
    ...
    <?php $fRender = function (&$arItem, $bOffer = false) use (&$arResult, &$arVisual, &$arParentValues) { ?>
        ...
        <?= Html::beginTag('div', [
            'class' => 'catalog-products-viewed-item-image-buttons',
            ...
            <?php if ($arParentValues['DELAY'] && $arItem['CAN_BUY']) { ?>
                ...
                <?= Html::beginTag('div', [
                    'class' => [
                        'catalog-products-viewed-item-image-button',
                        'catalog-products-viewed-item-image-button-delay',
                        'intec-cl-text-hover'
                    ],
                ...
                <?= Html::beginTag('div', [
                    'class' => [
                        'catalog-products-viewed-item-image-button',
                        'catalog-products-viewed-item-image-button-delayed',
                        'intec-cl-text'
                    ],
                    'data' => [
                        'basket-id' => $arItem['ID'],
                ...
                <?= Html::endTag('div') ?>
            <?php } ?>
            <?php if ($arVisual['COMPARE']['USE']) { ?>
                <?= Html::beginTag('div', [
                    'class' => [
                        'catalog-products-viewed-item-image-button',
                        'catalog-products-viewed-item-image-button-compare',
                        'intec-cl-text-hover'
                    ],
                    'data' => [
                        'compare-id' => $arItem['ID'],
                        'compare-action' => 'add',
                        'compare-code' => $arVisual['COMPARE']['CODE'],
                        'compare-state' => 'none',
                ...
                <?= Html::beginTag('div', [
                    'class' => [
                        'catalog-products-viewed-item-image-button',
                        'catalog-products-viewed-item-image-button-compared',
                        'intec-cl-text'
                    ],
                    'data' => [
                        'compare-id' => $arItem['ID'],
