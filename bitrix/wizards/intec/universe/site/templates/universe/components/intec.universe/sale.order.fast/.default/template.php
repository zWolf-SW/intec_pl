...
<?= Html::beginTag('div', [
            ...
            ?>
                <div class="sale-order-fast-part sale-order-fast-part-product intec-grid-item-auto">
                    <div class="sale-order-fast-product">
                        ...
                        <div class="sale-order-fast-product-info">
                            <div class="intec-grid intec-grid-wrap intec-grid-a-h-start intec-grid-a-v-center intec-grid-i-12">
                                ...
                                <?php if ($arVisual['ARTICLE']['SHOW']) { ?>
                                    <div class="intec-grid-item-auto intec-grid-item-shrink-1">
                                        <div class="sale-order-fast-product-article">
                                            <?= Loc::getMessage('C_SALE_ORDER_FAST_DEFAULT_ARTICLE', [
                                                '#ARTICLE#' => $arVisual['ARTICLE']['VALUE']
                                            ]) ?>
                                        </div>
                                    </div>
                                <?php } ?>
                            ...
                            <div class="sale-order-fast-fields intec-ui-form-fields">
                                ...
                                ?>
                                    <?= Html::beginTag('div', [
                                        ...
                                        <label class="sale-order-fast-field-title intec-ui-form-field-title" for="input-<?=$arProperty['ID']?>">
                                            <?= $sName ?>
                                        </label>
                                        ...
                                        <div class="sale-order-fast-field-content intec-ui-form-field-content">
                                            <?php if ($arProperty['TYPE'] === 'STRING' || $arProperty['TYPE'] === 'NUMBER') { ?>
                                                <?= Html::textInput($sInput, $sValue, [
                                                    'class' => 'intec-ui intec-ui-control-input intec-ui-mod-block intec-ui-mod-round-2 intec-ui-size-4',
                                                    'id' => 'input-'.$arProperty['ID']
                                                ]) ?>
                                ...
                                <?php if ($arResult['FIELDS']['COMMENT']['USE']) { ?>
                                    <div class="sale-order-fast-field sale-order-fast-field-comment intec-ui-form-field">
                                        <label class="sale-order-fast-field-title intec-ui-form-field-title" for="textarea-comment">
                            ...
                            <?php if ($arResult['AVAILABLE']) { ?>
                                <?php if ($arResult['CONSENT']['SHOW']) { ?>
                                    <div class="sale-order-fast-footer-consent">
                                        <label class="intec-ui intec-ui-control-checkbox intec-ui-scheme-current intec-ui-size-2">
                                            <input type="checkbox" onchange="disableButton(!this.checked)" checked="checked">
                                            <span class="intec-ui-part-selector"></span>
                                ...
                                <div class="sale-order-fast-footer-parts intec-grid intec-grid-nowrap intec-grid-500-wrap intec-grid-i-h-10 intec-grid-a-v-center">
                                    <div class="sale-order-fast-footer-part intec-grid-item-auto intec-grid-item-500-1">
                                        <input class="sale-order-fast-submit-button intec-ui intec-ui-control-button intec-ui-mod-round-3 intec-ui-scheme-current intec-ui-size-4" data-role="submit" type="submit" value="<?= $arResult['MESSAGES']['BUTTON'] ?>" />
                                    </div>
    ...
    <script>
        ...
        var button = $('[data-role="submit"]', root);
