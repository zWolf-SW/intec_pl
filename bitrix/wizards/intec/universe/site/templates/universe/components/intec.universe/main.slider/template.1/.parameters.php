...
if (!empty($arCurrentValues['IBLOCK_ID'])) {
    ...
    $arTemplateParameters['PRODUCT_USE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_1_PRODUCT_USE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'REFRESH' => 'Y'
    ];
    ...
    if ($arCurrentValues['PRODUCT_USE'] === 'Y') {
        $arTemplateParameters['PROPERTY_PRODUCT'] = [
            'PARENT' => 'DATA_SOURCE',
            'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_1_PROPERTY_PRODUCT'),
            'TYPE' => 'LIST',
    ...
    $arTemplateParameters['MOBILE_BLOCK_SEPARATED'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_1_MOBILE_BLOCK_SEPARATED'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
...
if (!empty($arCurrentValues['PROPERTY_HEADER'])) {
    ...
    if ($arCurrentValues['HEADER_SHOW'] === 'Y') {
        ...
        $arTemplateParameters['HEADER_VIEW'] = [
            ...
            'TYPE' => 'LIST',
            'VALUES' => [
                1 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_1_VIEW', ['#NUMBER#' => 1]),
                2 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_1_VIEW', ['#NUMBER#' => 2]),
                3 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_1_VIEW', ['#NUMBER#' => 3]),
                4 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_1_VIEW', ['#NUMBER#' => 4]),
                5 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_1_VIEW', ['#NUMBER#' => 5])
            ],
            'DEFAULT' => 1
        ];
    }
...
$arTemplateParameters['BUTTON_SHOW'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_1_BUTTON_SHOW'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'Y'
];

if ($arCurrentValues['BUTTON_SHOW'] === 'Y' && !empty($arCurrentValues['PROPERTY_BUTTON_SHOW'])) {
