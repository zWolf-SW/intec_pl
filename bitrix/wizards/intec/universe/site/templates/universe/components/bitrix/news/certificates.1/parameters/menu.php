...
$arTemplateParameters[$sPrefix.'TEMPLATE'] = [
    ...
    'NAME' => Loc::getMessage('C_NEWS_CERTIFICATES_1_'.$sPrefix.'TEMPLATE'),
    'TYPE' => 'LIST',
    'VALUES' => $arTemplates,
    'ADDITIONAL_VALUES' => 'Y',
    'REFRESH' => 'Y'
...
$arTemplateParameters[$sPrefix.'ROOT'] = [
    'PARENT' => 'DETAIL_SETTINGS',
    'NAME' => Loc::getMessage('C_NEWS_CERTIFICATES_1_'.$sPrefix.'ROOT'),
    'TYPE' => 'LIST',
    'VALUES' => $arMenuTypes,
    'ADDITIONAL_VALUES' => 'Y'
];
...
$arTemplateParameters[$sPrefix.'CHILD'] = [
    'PARENT' => 'DETAIL_SETTINGS',
    'NAME' => Loc::getMessage('C_NEWS_CERTIFICATES_1_'.$sPrefix.'CHILD'),
    'TYPE' => 'LIST',
    'VALUES' => $arMenuTypes,
    'ADDITIONAL_VALUES' => 'Y'
];
...
$arTemplateParameters[$sPrefix.'LEVEL'] = [
    'PARENT' => 'DETAIL_SETTINGS',
    'NAME' => Loc::getMessage('C_NEWS_CERTIFICATES_1_'.$sPrefix.'LEVEL'),
    'TYPE' => 'LIST',
    'VALUES' => [
        '1' => '1',
        '2' => '2',
...
if (!empty($sTemplate)) {
    $arTemplateParameters = ArrayHelper::merge($arTemplateParameters, Component::getParameters(
        ...
        function ($sKey, &$arParameter) {
            ...
            $arParameter['NAME'] = Loc::getMessage('C_NEWS_CERTIFICATES_1_MENU').'. '.$arParameter['NAME'];
