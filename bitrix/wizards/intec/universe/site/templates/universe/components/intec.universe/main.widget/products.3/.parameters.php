...
$arTemplateParameters['HIDE_NOT_AVAILABLE_OFFERS'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_3_HIDE_NOT_AVAILABLE_OFFERS'),
    'TYPE' => 'LIST',
    'VALUES' => [
        'N' => Loc::getMessage('C_WIDGET_PRODUCTS_3_HIDE_NOT_AVAILABLE_OFFERS_SHOW'),
        'L' => Loc::getMessage('C_WIDGET_PRODUCTS_3_HIDE_NOT_AVAILABLE_OFFERS_END'),
        'Y' => Loc::getMessage('C_WIDGET_PRODUCTS_3_HIDE_NOT_AVAILABLE_OFFERS_HIDE')
    ],
    'DEFAULT' => 'N'
];
...
$arTemplateParameters['LIST_URL'] = [
    ...
    'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_3_LIST_URL'),
    'TYPE' => 'STRING',
        ...
        foreach ($arCurrentValues['PRICE_CODE'] as $sPrice) {
            if (!empty($sPrice))
                $arTemplateParameters['PROPERTY_OLD_PRICE_' . $sPrice] = [
                    'PARENT' => 'PRICES',
                    'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_3_PROPERTY_OLD_PRICE', ['#PRICE_CODE#' => $arPrices[$sPrice]." (".$sPrice.")"]),
                    'TYPE' => 'LIST',
...
if (!empty($arIBlock)) {
    ...
    $arTemplateParameters['PROPERTY_REQUEST_USE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_3_PROPERTY_REQUEST_USE'),
        'TYPE' => 'LIST',
        'VALUES' => $hPropertiesCheckbox,
        'ADDITIONAL_VALUES' => 'Y'
    ];
    ...
    $arTemplateParameters['PROPERTY_MARKS_SHARE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_3_PROPERTY_MARKS_SHARE'),
        'TYPE' => 'LIST',
        'VALUES' => $hPropertiesCheckbox,
        'ADDITIONAL_VALUES' => 'Y',
        'REFRESH' => 'Y'
...
$arTemplateParameters['ACTION'] = [
    ...
    'VALUES' => [
        ...
        'request' => Loc::getMessage('C_WIDGET_PRODUCTS_3_ACTION_REQUEST')
    ],
    'DEFAULT' => 'none',
    'REFRESH' => 'Y'
];
...
if ($bOffersIblockExist) {
    ...
    if ($arCurrentValues['OFFERS_USE'] === 'Y') {
        ...
        $arTemplateParameters['OFFERS_PROPERTY_PICTURE_DIRECTORY'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_3_OFFERS_PROPERTY_PICTURE_DIRECTORY'),
            'TYPE' => 'LIST',
        ...
        $arTemplateParameters['OFFERS_VARIABLE_SELECT'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_3_OFFERS_VARIABLE_SELECT'),
            'TYPE' => 'STRING'
        ];
    }
}
...
$arTemplateParameters['PRICE_DISCOUNT_PERCENT'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_3_PRICE_DISCOUNT_PERCENT'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['PRICE_DISCOUNT_PERCENT'] === 'Y') {
    $arTemplateParameters['PRICE_DISCOUNT_ECONOMY'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_3_PRICE_DISCOUNT_ECONOMY'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
}
...
$arTemplateParameters['PURCHASE_REQUEST_BUTTON_TEXT'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_3_PURCHASE_REQUEST_BUTTON_TEXT'),
    'TYPE' => 'STRING',
    'DEFAULT' => Loc::getMessage('C_WIDGET_PRODUCTS_3_PURCHASE_REQUEST_BUTTON_TEXT_DEFAULT')
];

/** Блок "Показать все" */
$arTemplateParameters['BLOCKS_FOOTER_SHOW'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_3_BLOCKS_FOOTER_SHOW'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['BLOCKS_FOOTER_SHOW'] === 'Y') {
    $arTemplateParameters['BLOCKS_FOOTER_ALIGN'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_3_BLOCKS_FOOTER_ALIGN'),
        'TYPE' => 'LIST',
        'VALUES' => [
            'left' => Loc::getMessage('C_WIDGET_PRODUCTS_3_ALIGN_LEFT'),
            'center' => Loc::getMessage('C_WIDGET_PRODUCTS_3_ALIGN_CENTER'),
    ...
    $arTemplateParameters['BLOCKS_FOOTER_BUTTON_SHOW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_3_BLOCKS_FOOTER_BUTTON_SHOW'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'REFRESH' => 'Y'
    ];
    ...
    if ($arCurrentValues['BLOCKS_FOOTER_BUTTON_SHOW'] === 'Y') {
        $arTemplateParameters['BLOCKS_FOOTER_BUTTON_TEXT'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_3_BLOCKS_FOOTER_BUTTON_TEXT'),
            'TYPE' => 'STRING',
            'DEFAULT' => Loc::getMessage('C_WIDGET_PRODUCTS_3_BLOCKS_FOOTER_BUTTON_TEXT_DEFAULT')
        ];
    }
}