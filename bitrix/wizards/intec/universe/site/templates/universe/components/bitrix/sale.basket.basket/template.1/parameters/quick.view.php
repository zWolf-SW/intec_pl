...
$arTemplateParameters[$sPrefix.'TEMPLATE'] = [
    ...
    'NAME' => Loc::getMessage('C_BASKET_TEMPLATE_DEFAULT_1_QUICK_VIEW_TEMPLATE'),
    'TYPE' => 'LIST',
    'VALUES' => $arTemplates,
    'REFRESH' => 'Y'
];
...
$arTemplateParameters[$sPrefix.'IBLOCK_TYPE'] = [
    'PARENT' => 'ADDITIONAL_SETTINGS',
    'NAME' => Loc::getMessage('C_BASKET_TEMPLATE_DEFAULT_1_QUICK_VIEW_IBLOCK_TYPE'),
    'TYPE' => 'LIST',
    'MULTIPLE' => 'N',
...
if ($arCurrentValues[$sPrefix.'IBLOCK_TYPE'] !== '') {
    ...
    $arTemplateParameters[$sPrefix.'IBLOCK_ID'] = [
        'PARENT' => 'ADDITIONAL_SETTINGS',
        'NAME' => Loc::getMessage('C_BASKET_TEMPLATE_DEFAULT_1_QUICK_VIEW_IBLOCK_ID'),
        'TYPE' => 'LIST',
        'MULTIPLE' => 'N',
        'DEFAULT' => 'N',
        'VALUES' => $arIBlock,
...
if (!empty($arCurrentValues['IBLOCK_ID'])) {
    ...
    $arTemplateParameters[$sPrefix . 'PROPERTY_CODE'] = [
        'PARENT' => 'ADDITIONAL_SETTINGS',
        'NAME' => Loc::getMessage('C_BASKET_TEMPLATE_DEFAULT_1_QUICK_VIEW_PROPERTY_CODE'),
        'TYPE' => 'LIST',
        'MULTIPLE' => 'Y',
        'ADDITIONAL_VALUES' => 'Y',
    ...
    $arTemplateParameters = ArrayHelper::merge($arTemplateParameters, Component::getParameters(
        ...
        function ($sKey, &$arParameter) use (&$arQuickViewParametersUsed) {
            if (ArrayHelper::isIn($sKey, $arQuickViewParametersUsed)) {
                ...
                $arParameter['NAME'] = Loc::getMessage('C_BASKET_TEMPLATE_DEFAULT_1_QUICK_VIEW') . ' ' . $arParameter['NAME'];
