...
if ($arMenu['SHOW']) {
    ...
    if ($arParams['USE_FILTER'] === 'Y' && $arParams['FILTER_TYPE'] === 'vertical')
        $arMenu['MARGIN'] = $arMenu['TEMPLATE'] == 3 && $arParams['SECTIONS_ROOT_MENU_SHOW'] === 'Y';
    ...
    $arMenu['PARAMETERS'] = ArrayHelper::merge($arMenu['PARAMETERS'], [
        ...
        'SECTIONS_ROOT_MENU_SHOW' => $arParams['SECTIONS_ROOT_MENU_SHOW'],
