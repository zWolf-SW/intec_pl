...
if (!empty($arCurrentValues['IBLOCK_ID'])) {
    ...
    $arTemplateParameters['SEE_ALL_SHOW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('A_SEE_ALL_SHOW'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'REFRESH' => 'Y'
    ];

    $arTemplateParameters['HIDDE_NON_ACTIVE'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('A_HIDDE_NON_ACTIVE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
    ...
    if ($arCurrentValues['SEE_ALL_SHOW'] === 'Y') {
        $arTemplateParameters['SEE_ALL_POSITION'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('A_SEE_ALL_POSITION'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'N'
        ];
        $arTemplateParameters['SEE_ALL_TEXT'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('A_SEE_ALL_TEXT'),
            'TYPE' => 'STRING',
            'DEFAULT' => Loc::getMessage('A_SEE_ALL_TEXT_DEFAULT')
        ];
        $arTemplateParameters['SEE_ALL_URL'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('A_SEE_ALL_URL'),
            'TYPE' => 'STRING'
        ];
    }
}