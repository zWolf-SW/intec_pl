...
$arTemplateParameters['SECOND_PHONE_SHOW'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_FOOTER_TEMPLATE_1_SECOND_PHONE_SHOW'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['CONTACTS_USE'] === 'Y') {
    ...
    if (Loader::includeModule('iblock')) {
        ...
        if ($arCurrentValues['SECOND_PHONE_SHOW'] === 'Y') {
            $arTemplateParameters['SECOND_PHONE_ELEMENT'] = [
                'PARENT' => 'BASE',
                'NAME' => Loc::getMessage('C_FOOTER_TEMPLATE_1_SECOND_PHONE_ELEMENT'),
                'TYPE' => 'LIST',
                'VALUES' => $arElements->asArray(function ($iId, $arElement) use (&$arCurrentValues) {
                    $arElements = $arCurrentValues['CONTACTS_ELEMENTS'];
