        ...
        <div class="catalog-element-offer-price-range-items">
            <?php foreach ($arItem['ITEM_PRICES'] as $arPrice) { ?>
                <div class="catalog-element-offer-price-range-item intec-grid intec-grid-a-v-baseline">
                    <div class="catalog-element-offer-price-range-item-text intec-grid-item-auto intec-grid-item-shrink-1">
                    ...
                    <div class="catalog-element-offer-price-range-item-value intec-grid-item-auto intec-grid-item-shrink-1">
