...
<div class="ns-bitrix c-catalog-store-amount c-catalog-store-amount-default" id="<?= $sTemplateId ?>">
    <div class="intec-content">
        <div class="intec-content-wrapper">
            <?php if ($arVisual['TITLE']['SHOW']) { ?>
                <div class="catalog-store-amount-title">
            ...
            <?php if (($bShowMessageBlock || $arResult['IS_SKU']) && !$arVisual['SHOW_EMPTY_STORE']) { ?>
                <?= Html::tag('div', Loc::getMessage('C_CATALOG_STORE_AMOUNT_DEFAULT_TEMPLATE_EMPTY_EVERYWHERE'), [
                    'class' => [
                        'intec-ui' => [
                            '',
                            'control-alert',
