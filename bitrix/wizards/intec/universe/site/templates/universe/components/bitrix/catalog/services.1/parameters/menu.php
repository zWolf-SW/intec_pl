...
$arTemplateParameters[$sPrefix.'ROOT'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_CATALOG_SERVICES_1_'.$sPrefix.'ROOT'),
    'TYPE' => 'LIST',
    'VALUES' => $arMenuTypes,
    'ADDITIONAL_VALUES' => 'Y'
];
...
$arTemplateParameters[$sPrefix.'CHILD'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_CATALOG_SERVICES_1_'.$sPrefix.'CHILD'),
    'TYPE' => 'LIST',
    'VALUES' => $arMenuTypes,
    'ADDITIONAL_VALUES' => 'Y'
];
...
$arTemplateParameters[$sPrefix.'LEVEL'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_CATALOG_SERVICES_1_'.$sPrefix.'LEVEL'),
    'TYPE' => 'LIST',
    'VALUES' => [
        '1' => '1',
        '2' => '2',
...
if (!empty($sTemplate)) {
    $arTemplateParameters = ArrayHelper::merge($arTemplateParameters, Component::getParameters(
        ...
        function ($sKey, &$arParameter) {
            $arParameter['NAME'] = Loc::getMessage('C_CATALOG_SERVICES_1_MENU').'. '.$arParameter['NAME'];
