...
$arTemplateParameters['ORDER_FAST_USE'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_4_ORDER_FAST_USE'),
    'TYPE' => 'CHECKBOX',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['ORDER_FAST_USE'] == 'Y') {
    ...
    $arTemplateParameters['ORDER_FAST_TEMPLATE'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_4_ORDER_FAST_TEMPLATE'),
        'TYPE' => 'LIST',
        'VALUES' => $arTemplates,
        'ADDITIONAL_VALUES' => 'Y',
        'REFRESH' => 'Y'
    ...
    if (!empty($sTemplate)) {
        $arTemplateParameters = ArrayHelper::merge($arTemplateParameters, Component::getParameters(
            ...
            function ($sKey, &$arParameter) use (&$sLevel, &$arParametersCommon) {
                ...
                $arParameter['NAME'] = Loc::getMessage('C_WIDGET_PRODUCTS_4_ORDER_FAST').'. '.$arParameter['NAME'];
