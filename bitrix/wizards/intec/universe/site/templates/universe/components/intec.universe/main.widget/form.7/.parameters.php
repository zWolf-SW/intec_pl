...
$arTemplateParameters['FORM_ID'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::GetMessage('C_WIDGET_FORM_7_FORM_ID'),
    'TYPE' => 'LIST',
    'VALUES' => $arForms,
    'ADDITIONAL_VALUES' => 'Y',
    'REFRESH' => 'Y'
...
if (!empty($arCurrentValues['FORM_ID'])) {
    ...
    $arTemplateParameters['FORM_TEMPLATE'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::GetMessage('C_WIDGET_FORM_7_FORM_TEMPLATE'),
        'TYPE' => 'LIST',
        'VALUES' => $arTemplates,
        'ADDITIONAL_VALUES' => 'Y'
    ];
    $arTemplateParameters['FORM_TITLE'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::GetMessage('C_WIDGET_FORM_7_FORM_TITLE'),
        'TYPE' => 'STRING'
    ];
}
...
$arTemplateParameters['SETTINGS_USE'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_WIDGET_FORM_7_SETTINGS_USE'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['SETTINGS_USE'] !== 'Y') {
    $arTemplateParameters['CONSENT_SHOW'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('C_WIDGET_FORM_7_CONSENT_SHOW'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'REFRESH' => 'Y'
    ];
...
if ($arCurrentValues['SETTINGS_USE'] === 'Y' || $arCurrentValues['CONSENT_SHOW'] === 'Y') {
    $arTemplateParameters['CONSENT_URL'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::GetMessage('C_WIDGET_FORM_7_CONSENT_URL'),
        'TYPE' => 'STRING',
...
$arTemplateParameters['WIDE'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::GetMessage('C_WIDGET_FORM_7_WIDE'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['WIDE'] !== 'Y') {
    $arTemplateParameters['BORDER_STYLE'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::GetMessage('C_WIDGET_FORM_7_BORDER_STYLE'),
        'TYPE' => 'LIST',
        'VALUES' => [
            'squared' => Loc::getMessage('C_WIDGET_FORM_7_BORDER_STYLE_SQUARED'),
            'rounded' => Loc::getMessage('C_WIDGET_FORM_7_BORDER_STYLE_ROUNDED')
        ],
        'DEFAULT' => 'squared'
    ];
}
...
$arTemplateParameters['TITLE'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::GetMessage('C_WIDGET_FORM_7_TITLE'),
    'TYPE' => 'STRING'
];
$arTemplateParameters['DESCRIPTION'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::GetMessage('C_WIDGET_FORM_7_DESCRIPTION'),
    'TYPE' => 'STRING'
];
$arTemplateParameters['BUTTON_TEXT'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::GetMessage('C_WIDGET_FORM_7_BUTTON'),
    'TYPE' => 'STRING'
];