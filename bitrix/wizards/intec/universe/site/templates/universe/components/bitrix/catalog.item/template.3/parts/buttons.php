...
<?= Html::beginTag('div', [
    ...
    <?php if (!$bOffers) { ?>
        <?php if ($arItem['CAN_BUY']) { ?>
            <?= Html::beginTag('div', [
                ...
                <span class="catalog-item-button-content intec-ui-part-content">
                    ...
                    <span>
                        <?= Loc::getMessage('C_CATALOG_ITEM_TEMPLATE_3_TEMPLATE_BASKET_ADD') ?>
                    </span>
                </span>
            ...
            <?= Html::endTag('div') ?>
            <?= Html::tag('div', Loc::getMessage('C_CATALOG_ITEM_TEMPLATE_3_TEMPLATE_BASKET_ADDED'), [
                'class' => [
                    'catalog-item-button',
        ...
        <?php } else { ?>
            ...
            <?php } else { ?>
                <?= Html::tag('div', Loc::getMessage('C_CATALOG_ITEM_TEMPLATE_3_TEMPLATE_BASKET_UNAVAILABLE'), [
                    'class' => [
                        'catalog-item-button',
                        'catalog-item-button-default',
        ...
        <?php } ?>
    <?php } else { ?>
        <?= Html::tag('a', Loc::getMessage('C_CATALOG_ITEM_TEMPLATE_3_TEMPLATE_BASKET_DETAIL'), [
            'class' => [
                'catalog-item-button',
                'catalog-item-button-default',
                'intec-cl-background',
