...
$arTemplateParameters['IBLOCK_TYPE'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_MENU_VERTICAL_2_PARAMETERS_IBLOCK_TYPE'),
    'TYPE' => 'LIST',
...
$arTemplateParameters['IBLOCK_ID'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_MENU_VERTICAL_2_PARAMETERS_IBLOCK_ID'),
    'TYPE' => 'LIST',
...
if (!empty($arIBlock)) {
    ...
    $arTemplateParameters['PROPERTY_PICTURE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MENU_VERTICAL_2_PARAMETERS_PROPERTY_PICTURE'),
        'TYPE' => 'LIST',
