                            ...
                            <div class="intec-grid-item-auto">
                                <?= Html::beginTag('a', [
                                    ...
                                    <span class="widget-all-desktop intec-cl-text-hover">
                                        ...
                                        <?php } else { ?>
                                            <?= Loc::getMessage('C_SHARES_TEMP2_TEMPLATE_LINK_ALL_BLOCK_TEXT_DEFAULT') ?>
                                        <?php } ?>
                                    </span>
                    ...
                    ?>
                        <?= Html::beginTag('div', [
                            ...
                            <?= Html::beginTag('div', [
                                ...
                                <div class="widget-item-content intec-grid intec-grid-nowrap intec-grid-500-wrap intec-grid-a-v-stretch intec-grid-a-h-center">
                                    <div class="intec-grid-item-3 intec-grid-item-500-1">
                                        <?= Html::tag($sTag, null, [
                                            'class' => [
                                                'widget-item-picture',
                                                'intec-image-effect'
                                    ...
                                    <div class="intec-grid-item intec-grid-item-shrink-1 intec-grid-item-500-1">
                                        <div class="widget-item-information">
                                            <?php if ($arItem['DATA']['HEADER']['SHOW']) { ?>
                                                <?= Html::tag('div', $arItem['DATA']['HEADER']['VALUE'], [
                                                    'class' => 'widget-item-period',
                                                    'title' => $arItem['DATA']['HEADER']['VALUE']
                                                ]) ?>
                                            <?php } ?>
                                            ...
                                            <?php if ($arItem['DATA']['PREVIEW']['SHOW']) { ?>
                                                <?= Html::tag('div', $arItem['DATA']['PREVIEW']['VALUE'], [
                                                ...
                                                <?php if (!defined('EDITOR')) { ?>
                                                    <script type="text/javascript">
                                                        template.load(function (data) {
                                                            ...
                                                            'name': '[Component] intec.universe:main.shares (template.2) > Timer',
