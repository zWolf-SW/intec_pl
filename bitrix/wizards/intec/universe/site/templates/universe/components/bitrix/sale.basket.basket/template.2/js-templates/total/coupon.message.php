...
<div class="basket-coupon-messages">
    {{#COUPON_LIST}}
        <div class="basket-coupon-message" data-state="{{CLASS}}">
                ...
                <?= Html::tag('span', Loc::getMessage('C_BASKET_DEFAULT_2_TEMPLATE_COUPON_MESSAGE_DELETE'), [
                ...
                <div class="basket-coupon-message-description">
                    <?= Html::tag('span', Loc::getMessage('C_BASKET_DEFAULT_2_TEMPLATE_COUPON_MESSAGE_DESCRIPTION')) ?>
