...
# Fix SUPPLIER_ID (NOT NULL => DEFAULT NULL)
if($arColumn = \Bitrix\Main\Application::getConnection()->query("SHOW COLUMNS FROM acrit_wb_task WHERE Field = 'SUPPLIER_ID';")->fetch()){
	if($arColumn['Null'] == 'NO'){
		\Bitrix\Main\Application::getConnection()->query("ALTER TABLE acrit_wb_task MODIFY COLUMN SUPPLIER_ID varchar(36) default null;");
	}
}
