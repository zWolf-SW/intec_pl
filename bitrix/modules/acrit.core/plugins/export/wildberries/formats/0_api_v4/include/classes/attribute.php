...
class AttributeTable extends Entity\DataManager {
	...
	public static function getMap() {
		...
		return array(
			...
			'POPULAR' => new Entity\StringField('POPULAR', array(
				'title' => Helper::getMessage($strLang.'POPULAR'),
			)),
			'UNIT' => new Entity\StringField('UNIT', array(
				'title' => Helper::getMessage($strLang.'UNIT'),
			)),
			'CHARACTER_TYPE' => new Entity\StringField('CHARACTER_TYPE', array(
				'title' => Helper::getMessage($strLang.'CHARACTER_TYPE'),
			)),
