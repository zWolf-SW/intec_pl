...
class TaskTable extends Entity\DataManager {
	...
	public static function getMap() {
		...
		return array(
			...
			'METHOD' => new Entity\StringField('METHOD', array(
				'title' => Helper::getMessage($strLang.'METHOD'),
			)),
			...
			'RESPONSE' => new Entity\StringField('RESPONSE', array(
				'title' => Helper::getMessage($strLang.'RESPONSE'),
			)),
			'RESPONSE_CODE' => new Entity\IntegerField('RESPONSE_CODE', array(
				'title' => Helper::getMessage($strLang.'RESPONSE_CODE'),
			)),
