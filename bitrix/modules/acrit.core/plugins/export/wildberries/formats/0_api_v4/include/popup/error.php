...
# Get headers
$arResponseHeaders = $this->API->getResponseHeaders();
$arRequestHeaders = $this->API->getRequestHeaders();
...
$strDisplayMessageTitle = static::getMessage('ERROR_EXPORT_ITEMS_BY_API', ['#METHOD#' => $strMethod]);
...
<div>
	...
	<div style="display:none; word-break:break-all;">
		<?$strQueryResultJson = \Bitrix\Main\Web\Json::encode($arQueryResult, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);?>
		<?Helper::P($strQueryResultJson);?>
	</div>
</div>
...
<div style="margin-top:8px;">
	<div>
		<a href="#" class="acrit-inline-link" data-role="acrit_wb_preview_error_json">
			<?=static::getMessage('ERROR_PREVIEW_REQUEST_HEADERS');?>
		</a>
	</div>
	<div style="display:none; word-break:break-all;">
		<?Helper::P(implode('<br/>', $arRequestHeaders));?>
	</div>
</div>
<div style="margin-top:8px;">
	<div>
		<a href="#" class="acrit-inline-link" data-role="acrit_wb_preview_error_json">
			<?=static::getMessage('ERROR_PREVIEW_RESPONSE_HEADERS');?>
		</a>
	</div>
	<div style="display:none; word-break:break-all;">
		<?Helper::P(implode('<br/>', $arResponseHeaders));?>
	</div>
</div>
<script>
