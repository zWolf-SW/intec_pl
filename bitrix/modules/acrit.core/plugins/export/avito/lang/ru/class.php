...
// Outdated
$MESS[$strMessPrefix.'OUTDATED_SUFFIX'] = ' - НЕ ПОДДЕРЖИВАЕТСЯ';
$MESS[$strMessPrefix.'OUTDATED_MESSAGE'] = '<b>Внимание!</b> В связи с изменениями в документации Avito, данный формат не всегда будет соответствовать всем требованиям. Для корректной выгрузки используйте новый формат - <span style="color:green;">Авито XML v.3 (все типы объявлений)</span>.';
...
$MESS[$strMessPrefix.'VIDEO_TARIFF'] = 'Как выбрать тариф для бизнеса на Авито';
...
$MESS[$strMessPrefix.'FIELD_AUCTION_PRICE_NAME'] = 'Cтавка за целевое действие (в копейках)';
$MESS[$strMessPrefix.'FIELD_AUCTION_PRICE_DESC'] = 'Cтавка за целевое действие (в копейках)';
$MESS[$strMessPrefix.'FIELD_AUCTION_PRICE_LAST_DATE_NAME'] = 'Дата действия ставки за целевое действие';
$MESS[$strMessPrefix.'FIELD_AUCTION_PRICE_LAST_DATE_DESC'] = 'Дата (в формате «YYYY-MM-DD»), до которой включительно будет действовать ставка из поля «AuctionPrice». После этой даты ставка за целевое действие станет минимальной.';
...
$MESS[$strMessPrefix.'FIELD_CONTACT_METHOD_NAME'] = 'Контактный телефон';
$MESS[$strMessPrefix.'FIELD_CONTACT_METHOD_DESC'] = 'Способ связи – одно значение из списка. В категории «Квартиры» для объявлений о продаже (OperationType = «Продам») или аренде на длительный срок (LeaseType = «На длительный срок»):
<ul>
...
Если способ связи не указан, будет установлено значение по умолчанию – «По телефону и в сообщениях»<br/><br/>
Примечание: ранее аналогичный элемент назывался AllowEmail, в нем «Да» соответствует «По телефону и в сообщениях, а «Нет» – «По телефону». Указанные в AllowEmail значения продолжают обрабатываться Автозагрузкой. Если вы хотите изменить способ связи, то используйте для этого элемент ContactMethod.';
$MESS[$strMessPrefix.'FIELD_CONTACT_METHOD_DEFAULT'] = 'По телефону и в сообщениях';
...
$MESS[$strMessPrefix.'FIELD_IMAGE_URLS_NAME'] = 'Фотографии в виде HTTP-ссылки';
$MESS[$strMessPrefix.'FIELD_IMAGE_URLS_DESC'] = 'Допустимые графические форматы фотографий: JPEG, PNG. Максимально допустимый размер файла изображения – 30 Мб.<br/><br/>
Для каждой категории определено максимальное количество фотографий, которые можно прикрепить к объявлению (все фотографии свыше этого количества игнорируются).<br/><br/>
Пример: <code>http://img.test.ru/8F7B-4A4F3A0F2BA1.jpg | http://img.test.ru/8F7B-4A4F3A0F2XA3.jpg</code>';

$MESS[$strMessPrefix.'FIELD_IMAGE_NAMES_NAME'] = 'Фотографии в виде названий файлов.';
$MESS[$strMessPrefix.'FIELD_IMAGE_NAMES_DESC'] = 'Элемент используется при загрузке файла c объявлениями и архива с фотографиями вручную через Личный кабинет.<br/>
Допустимые графические форматы фотографий: JPEG, PNG. Максимально допустимый размер файла изображения – 30 Мб.<br/>
Для каждой категории определено максимальное количество фотографий, которые можно прикрепить к объявлению (все фотографии свыше этого количества игнорируются)<br/>
Пример: <code>a1.jpg | a2.jpg | a3.jpg</code>';
