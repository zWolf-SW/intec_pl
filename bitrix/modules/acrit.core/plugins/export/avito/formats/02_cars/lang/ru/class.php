...
Только для новых автомобилей.';
$MESS[$strMessPrefix.'FIELD_AVAILABILITY_NAME'] = 'Статус нового автомобиля';
	$MESS[$strMessPrefix.'FIELD_AVAILABILITY_DESC'] = 'Только для новых автомобилей. Возможные значения:
<ul>
	<li>В наличии</li>
	<li>В пути</li>
</ul>';
