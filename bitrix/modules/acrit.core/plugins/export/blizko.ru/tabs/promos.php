			...
			<select multiple="true" type="text" name="PROFILE[PARAMS][YANDEX_MARKET_EXPORT_PROMOCODES_FIELDS][]" >
				...
				if(\Bitrix\Main\Loader::includeModule('sale')){
					...
					while ($discount = $discountIterator->fetch()) {
						$selected = is_array($arProfile['PARAMS']['YANDEX_MARKET_EXPORT_PROMOCODES_FIELDS']) && (in_array($discount['ID'], $arProfile['PARAMS']['YANDEX_MARKET_EXPORT_PROMOCODES_FIELDS'])) ? 'selected="selected"' : '';
