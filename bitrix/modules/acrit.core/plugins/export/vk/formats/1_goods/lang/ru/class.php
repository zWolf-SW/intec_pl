...
$MESS[$strMessPrefix."FIELD_URL_NAME"] = "Ссылка на сайт товара";
	$MESS[$strMessPrefix."FIELD_URL_DESC"] = "Максимальная длина - 50 символов";
$MESS[$strMessPrefix."FIELD_DIMENSION_WIDTH_NAME"] = "Ширина в миллиметрах";
	$MESS[$strMessPrefix."FIELD_DIMENSION_WIDTH_DESC"] = "Положительное число, минимальное значение 0, максимальное значение 100000.";
$MESS[$strMessPrefix."FIELD_DIMENSION_HEIGHT_NAME"] = "Высота в миллиметрах";
	$MESS[$strMessPrefix."FIELD_DIMENSION_HEIGHT_DESC"] = "Положительное число, минимальное значение 0, максимальное значение 100000.";
$MESS[$strMessPrefix."FIELD_DIMENSION_LENGTH_NAME"] = "Глубина в миллиметрах";
	$MESS[$strMessPrefix."FIELD_DIMENSION_LENGTH_DESC"] = "Положительное число, минимальное значение 0, максимальное значение 100000.";
$MESS[$strMessPrefix."FIELD_WEIGHT_NAME"] = "Вес в граммах";
	$MESS[$strMessPrefix."FIELD_WEIGHT_DESC"] = "Положительное число, минимальное значение 0, максимальное значение 100000000.";
$MESS[$strMessPrefix."FIELD_SKU_NAME"] = "Артикул товара";
	$MESS[$strMessPrefix."FIELD_SKU_DESC"] = "Произвольная строка, максимальная длина - 50 символов";
...
$MESS[$strMessPrefix."FIELD_MAIN_VARIANT_NAME"] = "Основная вариация товара";
	$MESS[$strMessPrefix."FIELD_MAIN_VARIANT_DESC"] = "Укажите 1, если товар является основной вариацией, 0 если нет.";
