...
// General
$MESS[$strMessPrefix.'NAME'] = 'СДЕК.Маркет (Новый)';
...
$MESS[$strMessPrefix.'FIELD_AMOUNT_NAME'] = 'Остаток товара';
	$MESS[$strMessPrefix.'FIELD_AMOUNT_DESC'] = 'Остаток товара.';
...
$MESS[$strMessPrefix.'FIELD_WEIGHT_NAME'] = 'Вес товара, кг';
	$MESS[$strMessPrefix.'FIELD_WEIGHT_DESC'] = 'Укажите вес товара в килограммах.';
