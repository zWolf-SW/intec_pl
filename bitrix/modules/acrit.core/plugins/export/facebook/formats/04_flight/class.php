...
class FacebookFlight extends UniversalPlugin {

   CONST DATE_UPDATED = '2021-09-20';

   protected static $bSubclass = true;
   # General
   protected $strDefaultFilename = 'facebook_flight.xml';
   ...
   public function getUniversalFields($intProfileId, $intIBlockId) {
      $arResult = [];
      $arResult['origin_airport'] = ['REQUIRED' => true];
      $arResult['destination_airport'] = ['REQUIRED' => true];
      $arResult['image.url'] = [
      ...
      $arResult['description'] = [
          'FIELD' => 'DETAIL_TEXT', 'FIELD_PARAMS' => ['HTMLSPECIALCHARS' => 'skip'], 'REQUIRED' => true
      ];
      $arResult['url'] = ['FIELD' => 'DETAIL_PAGE_URL', 'REQUIRED' => true];
      $arResult['origin_city'] = [];
      $arResult['destination_city'] = [];
      $arResult['price'] = [
