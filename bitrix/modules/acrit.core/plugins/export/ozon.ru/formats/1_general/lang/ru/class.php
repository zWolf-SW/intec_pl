...
// General
$MESS[$strMessPrefix . 'NAME'] = 'Ozon.Ru API (не поддерживается)';
...
$MESS[$strLang.'ERROR_OZON_OLD_TITLE'] = 'Формат не поддерживается!';
$MESS[$strLang.'ERROR_OZON_OLD_DESCR'] = 'В связи с изменениями в API Ozon, данный формат выгрузки <b>не поддерживается</b>. Используйте формат «<b>OZON.RU API v2 (универсальный)</b>».';
