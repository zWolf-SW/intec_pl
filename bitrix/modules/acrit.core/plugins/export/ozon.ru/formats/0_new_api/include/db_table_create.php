...
$arIndexList = [];
$resIndex = $obDatabase->query("SHOW INDEX FROM acrit_ozon_attribute_value;");
...
if(!in_array('ix_perf_acrit_ozon_attribute_value_1', $arIndexList)){
	$obDatabase->query("ALTER TABLE acrit_ozon_attribute_value ADD INDEX ix_perf_acrit_ozon_attribute_value_1(`CATEGORY_ID`);");
}
if(!in_array('ix_perf_acrit_ozon_attribute_value_2', $arIndexList)){
	$obDatabase->query("ALTER TABLE acrit_ozon_attribute_value ADD INDEX ix_perf_acrit_ozon_attribute_value_2(`ATTRIBUTE_ID`);");
}
if(!in_array('ix_perf_acrit_ozon_attribute_value_3', $arIndexList)){
	$obDatabase->query("ALTER TABLE acrit_ozon_attribute_value ADD INDEX ix_perf_acrit_ozon_attribute_value_3(`ATTRIBUTE_ID`, `SESSION_ID`);");
}
if(!in_array('ix_perf_acrit_ozon_attribute_value_4', $arIndexList)){
	$obDatabase->query("ALTER TABLE acrit_ozon_attribute_value ADD INDEX ix_perf_acrit_ozon_attribute_value_4(`ATTRIBUTE_ID`, `DICTIONARY_ID`);");
}
if(!in_array('ix_perf_acrit_ozon_attribute_value_5', $arIndexList)){
	$obDatabase->query("ALTER TABLE acrit_ozon_attribute_value ADD INDEX ix_perf_acrit_ozon_attribute_value_5(`CATEGORY_ID`, `ATTRIBUTE_ID`, `DICTIONARY_ID`);");
}
if(!in_array('ix_perf_acrit_ozon_attribute_value_6', $arIndexList)){
	$obDatabase->query("ALTER TABLE acrit_ozon_attribute_value ADD INDEX ix_perf_acrit_ozon_attribute_value_6(`VALUE_ID`);");
}
