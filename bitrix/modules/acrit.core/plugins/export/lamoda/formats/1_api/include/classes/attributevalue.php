...
class AttributeValueTable extends Entity\DataManager {
	...
	public static function getTableName(){
		return 'acrit_lamoda_attribute_value';
	}
	...
	public static function getMap() {
		...
		return array(
			...
			'ATTRIBUTE_CODE' => new Entity\StringField('ATTRIBUTE_CODE', array(
				'title' => Helper::getMessage($strLang.'ATTRIBUTE_CODE'),
			)),
