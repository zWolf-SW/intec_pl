<?
/**
 * Acrit Core: create tables for lamoda.kz api
 * @documentation https://api.sellercenter.lamoda.kz/docs/
 */

namespace Acrit\Core\Export\Plugins\LamodaKzHelpers;
...
$arTables = [
	'acrit_lamoda_attribute' => [
		...
		'PRIMARY KEY (ID)',
		'KEY `ix_perf_acrit_lamoda_attribute_1` (`ATTRIBUTE_ID`)',
	],
	'acrit_lamoda_attribute_value' => [
		'ID' => 'int(11) NOT NULL auto_increment',
		'PROFILE_ID' => 'int(11) NOT NULL',
		'CATEGORY_ID' => 'int(11) NOT NULL',
		'ATTRIBUTE_ID' => 'int(11) NOT NULL',
		...
		'TIMESTAMP_X' => 'DATETIME NOT NULL',
		'PRIMARY KEY (ID)',
		'KEY `ix_perf_acrit_lamoda_attribute_value_1` (`VALUE_ID`)',
	],
	'acrit_lamoda_category' => [
		'ID' => 'int(11) NOT NULL auto_increment',
		'CATEGORY_ID' => 'int(11) NOT NULL',
		'NAME' => 'TEXT NOT NULL',
		'CODE' => 'TEXT NOT NULL',
		...
		'TIMESTAMP_X' => 'DATETIME NOT NULL',
		'PRIMARY KEY (ID)',
		'KEY `ix_perf_acrit_lamoda_category_1` (`CATEGORY_ID`)',
	],
	'acrit_lamoda_task' => [
		'ID' => 'int(11) NOT NULL auto_increment',
		...
		'PRIMARY KEY (ID)',
		'KEY `ix_perf_acrit_lamoda_task_1` (`TASK_ID`)',
		'KEY `ix_perf_acrit_lamoda_task_2` (`PROFILE_ID`)',
	],
	'acrit_lamoda_history' => [
		'ID' => 'int(11) NOT NULL auto_increment',
		'MODULE_ID' => 'VARCHAR(50) DEFAULT \'acrit.exportproplus\'',
		'PROFILE_ID' => 'int(11) NOT NULL',
		'TASK_ID' => 'int(11) NOT NULL',
		'TASK_ID_LAMODA' => 'int(11) NOT NULL',
		...
		'TIMESTAMP_X' => 'DATETIME NOT NULL',
		'PRIMARY KEY (ID)',
		'KEY `ix_perf_acrit_lamoda_history_1` (`PROFILE_ID`, `MODULE_ID`)',
		'KEY `ix_perf_acrit_lamoda_history_2` (`TASK_ID_LAMODA`)',
		'KEY `ix_perf_acrit_lamoda_history_3` (`TASK_ID`, `OFFER_ID`)',
	],
	'acrit_lamoda_history_stock' => [
		'ID' => 'int(11) NOT NULL auto_increment',
		'MODULE_ID' => 'VARCHAR(50) DEFAULT \'acrit.exportproplus\'',
		'PROFILE_ID' => 'int(11) NOT NULL',
...
$strSql = "SHOW COLUMNS FROM acrit_lamoda_history LIKE 'TASK_ID_LAMODA'";
if(!$obDatabase->query($strSql)->fetch()){
	$obDatabase->startTransaction();
	$obDatabase->query("ALTER TABLE acrit_lamoda_history CHANGE TASK_ID TASK_ID_LAMODA int(11) NOT NULL;");
	$obDatabase->query("ALTER TABLE acrit_lamoda_history ADD TASK_ID int(11) NOT NULL AFTER PROFILE_ID;");
