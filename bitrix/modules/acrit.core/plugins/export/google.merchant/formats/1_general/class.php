...
class GoogleMerchantGeneral extends GoogleMerchant {
	...
	public function getFields($intProfileID, $intIBlockID, $bAdmin=false){
		...
		*/
		...
		$arResult[] = new Field(array(
			'CODE' => 'PRODUCT_HIGHLIGHT',
			'DISPLAY_CODE' => 'product_highlight',
			'NAME' => static::getMessage('FIELD_PRODUCT_HIGHLIGHT_NAME'),
			'SORT' => 663,
			'DESCRIPTION' => static::getMessage('FIELD_PRODUCT_HIGHLIGHT_DESC'),
			'REQUIRED' => false,
			'MULTIPLE' => true,
			'DEFAULT_VALUE' => array(
				array(
        ...
        $arResult[] = new Field(array(
			'CODE' => 'PRODUCT_LENGTH',
			'DISPLAY_CODE' => 'product_length',
			'NAME' => static::getMessage('FIELD_PRODUCT_LENGTH_NAME'),
			'SORT' => 1060,
			'DESCRIPTION' => static::getMessage('FIELD_PRODUCT_LENGTH_DESC'),
			'REQUIRED' => false,
			'MULTIPLE' => false,
			'DEFAULT_VALUE' => array(
				array(
        ...
        $arResult[] = new Field(array(
			'CODE' => 'PRODUCT_WIDTH',
			'DISPLAY_CODE' => 'product_width',
			'NAME' => static::getMessage('FIELD_PRODUCT_WIDTH_NAME'),
			'SORT' => 1061,
			'DESCRIPTION' => static::getMessage('FIELD_PRODUCT_WIDTH_DESC'),
			'REQUIRED' => false,
			'MULTIPLE' => false,
			'DEFAULT_VALUE' => array(
				array(
        ...
        $arResult[] = new Field(array(
			'CODE' => 'PRODUCT_HEIGHT',
			'DISPLAY_CODE' => 'product_height',
			'NAME' => static::getMessage('FIELD_PRODUCT_HEIGHT_NAME'),
			'SORT' => 1062,
			'DESCRIPTION' => static::getMessage('FIELD_PRODUCT_HEIGHT_DESC'),
			'REQUIRED' => false,
			'MULTIPLE' => false,
			'DEFAULT_VALUE' => array(
				array(
        ...
        $arResult[] = new Field(array(
			'CODE' => 'PRODUCT_WEIGHT',
			'DISPLAY_CODE' => 'product_weight',
			'NAME' => static::getMessage('FIELD_PRODUCT_WEIGHT_NAME'),
			'SORT' => 1063,
			'DESCRIPTION' => static::getMessage('FIELD_PRODUCT_WEIGHT_DESC'),
			'REQUIRED' => false,
			'MULTIPLE' => false,
			'DEFAULT_VALUE' => array(
				array(
		...
		if($bAdmin){
			$arResult[] = new Field(array(
				'SORT' => 1070,
				'NAME' => static::getMessage('HEADER_PRODUCT_DETAIL'),
				'IS_HEADER' => true,
			));
		}
		$arResult[] = new Field(array(
			'CODE' => 'PRODUCT_DETAIL_SECTION_NAME',
			'DISPLAY_CODE' => 'product_detail -> section_name',
			'NAME' => static::getMessage('FIELD_PRODUCT_DETAIL_SECTION_NAME_NAME'),
			'SORT' => 1071,
			'DESCRIPTION' => static::getMessage('FIELD_PRODUCT_DETAIL_SECTION_NAME_DESC'),
			'REQUIRED' => false,
			'MULTIPLE' => false,
			'DEFAULT_VALUE' => array(
				array(
		...
		$arResult[] = new Field(array(
			'CODE' => 'PRODUCT_DETAIL_ATTRIBUTE_NAME',
			'DISPLAY_CODE' => 'product_detail -> attribute_name',
			'NAME' => static::getMessage('FIELD_PRODUCT_DETAIL_ATTRIBUTE_NAME_NAME'),
			'SORT' => 1072,
			'DESCRIPTION' => static::getMessage('FIELD_PRODUCT_DETAIL_ATTRIBUTE_NAME_DESC'),
			'REQUIRED' => false,
			'MULTIPLE' => false,
			'DEFAULT_VALUE' => array(
				array(
		...
		$arResult[] = new Field(array(
			'CODE' => 'PRODUCT_DETAIL_ATTRIBUTE_VALUE',
			'DISPLAY_CODE' => 'product_detail -> attribute_value',
			'NAME' => static::getMessage('FIELD_PRODUCT_DETAIL_ATTRIBUTE_VALUE_NAME'),
			'SORT' => 1073,
			'DESCRIPTION' => static::getMessage('FIELD_PRODUCT_DETAIL_ATTRIBUTE_VALUE_DESC'),
			'REQUIRED' => false,
			'MULTIPLE' => false,
			'DEFAULT_VALUE' => array(
				array(
	...
	public function processElement($arProfile, $intIBlockID, $arElement, $arFields){
		...
		if(!Helper::isEmpty($arFields['PRODUCT_HIGHLIGHT']))
			$arXmlTags['g:product_highlight'] = Xml::addTag($arFields['PRODUCT_HIGHLIGHT']);
		...
		if(!Helper::isEmpty($arFields['PRODUCT_LENGTH']))
			$arXmlTags['g:product_length'] = Xml::addTag($arFields['PRODUCT_LENGTH']);
		if(!Helper::isEmpty($arFields['PRODUCT_WIDTH']))
			$arXmlTags['g:product_width'] = Xml::addTag($arFields['PRODUCT_WIDTH']);
		if(!Helper::isEmpty($arFields['PRODUCT_HEIGHT']))
			$arXmlTags['g:product_height'] = Xml::addTag($arFields['PRODUCT_HEIGHT']);
		if(!Helper::isEmpty($arFields['PRODUCT_WEIGHT']))
			$arXmlTags['g:product_weight'] = Xml::addTag($arFields['PRODUCT_WEIGHT']);
		if(!Helper::isEmpty($arFields['PRODUCT_DETAIL_ATTRIBUTE_NAME'])){                     
			$arXmlTags['g:product_detail'] = $this->getXmlTag_ProductDetail($intProfileID, $arFields);
        }        
		#
    ...
    /**
	 *	Get XML tag: <g:product_detail>
	 */
	protected function getXmlTag_ProductDetail($intProfileID, $arFields){        
        $arResult = array();
        if(!Helper::isEmpty($arFields['PRODUCT_DETAIL_SECTION_NAME'])) {
            $arResult['g:section_name'] = array(
                array(
                    '#' => $arFields['PRODUCT_DETAIL_SECTION_NAME'],
                ),
            );
        }
		if(!Helper::isEmpty($arFields['PRODUCT_DETAIL_ATTRIBUTE_NAME'])) {            
			$arResult['g:attribute_name'] = array(
				array(
					'#' => $arFields['PRODUCT_DETAIL_ATTRIBUTE_NAME'],
				),
			);
		}
		if(!Helper::isEmpty($arFields['PRODUCT_DETAIL_ATTRIBUTE_VALUE'])) {
			$arResult['g:attribute_value'] = array(
				array(
					'#' => $arFields['PRODUCT_DETAIL_ATTRIBUTE_VALUE'],
				),
			);
		}
        return array(
