...
class AccesstokenTable extends Entity\DataManager {
	...
	public static function getTableName(){
		return 'acrit_onliner_access_token';
	}
	...
	public static function getMap() {
		...
		return array(
			...
			'ACCESS_TOKEN' => new Entity\StringField('ACCESS_TOKEN', array(
				'title' => Helper::getMessage($strLang.'ACCESS_TOKEN'),
			)),
			'EXPIRES_IN' => new Entity\IntegerField('EXPIRES_IN', array(
				'title' => Helper::getMessage($strLang.'EXPIRES_IN'),
			)),
			'TIME' => new Entity\StringField('TIME', array(
				'title' => Helper::getMessage($strLang.'TIME'),
			)),
		);
	}
