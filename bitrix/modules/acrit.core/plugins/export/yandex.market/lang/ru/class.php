...
$MESS[$strMessPrefix.'EXPORT_NEW_DATE_FORMAT'] = 'Старый формат даты в заголовке yml файла';
	$MESS[$strMessPrefix.'EXPORT_NEW_DATE_FORMAT_HINT'] = 'Старый формат даты в заголовке yml файла 2023-06-09 08:38 В новом формате дата будет выглядеть так: 2023-06-09T08:38:00+03:00';
...
$MESS[$strMessPrefix.'FIELD_PURCHASE_PRICE_NAME'] = 'Закупочная цена';
	$MESS[$strMessPrefix.'FIELD_PURCHASE_PRICE_DESC'] = 'Закупочная цена товара. Она нужна для расчета наценки и настройки <a href="https://yandex.ru/support/pricelabs/rate/rate-marg.html" target="_blank">стратегии по маржинальности в PriceLabs</a>.';
...
$MESS[$strMessPrefix.'FIELD_PICKUP_OPTIONS_COST_NAME'] = 'Стоимость самовывоза';
	$MESS[$strMessPrefix.'FIELD_PICKUP_OPTIONS_COST_DESC'] = 'Стоимость самовывоза.<br/><br/>Обязательны к заполнению как <code>cost</code>, так и <code>days</code>.<br/><br/><a href="https://yandex.ru/support/partnermarket/elements/pickup-options.html#pickup-options" target="_blank">Подробное описание элемента</a>.';
$MESS[$strMessPrefix.'FIELD_PICKUP_OPTIONS_DAYS_NAME'] = 'Cрок поставки товара в пункт выдачи';
	$MESS[$strMessPrefix.'FIELD_PICKUP_OPTIONS_DAYS_DESC'] = 'Cрок поставки товара в пункт выдачи в рабочих днях.<br/><br/>Обязательны к заполнению как <code>cost</code>, так и <code>days</code>.<br/><br/><a href="https://yandex.ru/support/partnermarket/elements/pickup-options.html#pickup-options" target="_blank">Подробное описание элемента</a>.';
...
$MESS[$strMessPrefix.'FIELD_CPA_NAME'] = 'Возможность заказа на Маркете';
	$MESS[$strMessPrefix.'FIELD_CPA_DESC'] = 'Возможность заказать товар на Маркете:
	<ul>
		<li>1 — товар можно заказать на Маркете.</li>
		<li>0 — товар можно заказать только на сайте магазина.</li>
	</ul>
	<p>Значение по умолчанию: 1.</p>
	<p>Алкоголь, лекарственные средства и товары, подлежащие маркировке, с кодами идентификации из системы «<a href="https://честныйзнак.рф/" target="_blank">Честный ЗНАК</a>» не удастся разместить по модели DBS (Delivery by Seller, продажи с доставкой магазина).
	Поэтому для них элемент всегда принимает значение 0.</p>
';
