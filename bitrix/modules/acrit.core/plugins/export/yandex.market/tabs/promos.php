...
if($obPlugin->getIsPromoSpecialPrice()){
...
// EXPORT PROMOCARD
if($obPlugin->getIsPromoPromoCard()){
...
if($obPlugin->getIsPromoSpecialPrice() || $obPlugin->getIsPromoNM() || $obPlugin->getIsPromoGift()){
