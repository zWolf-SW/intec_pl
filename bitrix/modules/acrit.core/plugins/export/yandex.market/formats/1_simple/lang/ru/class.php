...
';
$MESS[$strMessPrefix.'FIELD_CONDITION_QUALITY_NAME'] = 'Описание состояния товара';
	$MESS[$strMessPrefix.'FIELD_CONDITION_QUALITY_DESC'] = 'Подробно опишите дефекты товара, насколько они заметны и где их искать.';
$MESS[$strMessPrefix.'FIELD_MIN_QUANTITY_NAME'] = 'Минимальное количество одинаковых товаров в заказе';
	$MESS[$strMessPrefix.'FIELD_MIN_QUANTITY_DESC'] = 'Минимальное количество одинаковых товаров в заказе (для случаев, когда покупка возможна только комплектом, а не поштучно).<br/><br/>
	Элемент используется только в категориях Автошины, Грузовые шины, Мотошины, Диски.<br/><br/>
	Если элемент не указан, используется значение по умолчанию — 1.<br/><br/>
	<a href="https://yandex.ru/support/partnermarket/elements/min-quantity.html" target="_blank">Подробное описание элемента</a>.';
