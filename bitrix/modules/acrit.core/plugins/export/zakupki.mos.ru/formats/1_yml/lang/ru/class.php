...
$MESS[$strHead.'HEADER_GENERAL'] = 'Общие данные';
	...
	$MESS[$strName.'oksm'] = 'Страна происхождения';
		$MESS[$strHint.'oksm'] = 'Страна происхождения товара (числовой код в соответствии со справочником <a href="https://old.zakupki.mos.ru/api/cssp/data/exchange/v1.1/oksm" target="_blank">ОКСМ</a>).';
