...
if(is_null($arProfile['PARAMS']['JSON_ELEMENT_FIELDS'])){
	$arProfile['PARAMS']['JSON_ELEMENT_FIELDS'] = implode(PHP_EOL, $arDefaultElementFields);
}
if(is_null($arProfile['PARAMS']['JSON_OFFER_FIELDS'])){
	$arProfile['PARAMS']['JSON_OFFER_FIELDS'] = implode(PHP_EOL, $arDefaultOfferFields);
}
