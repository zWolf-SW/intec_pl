...
class Response {
	...
	private $strRequest = ''; // private string
	private $arRequest = []; // private array
	private $strRequestUrl = ''; // private string
	...
	public function setRequest(string $strRequest){
	...
	public function setRequestArray(array $arRequest){
	...
	public function setRequestUrl(string $strRequestUrl){
