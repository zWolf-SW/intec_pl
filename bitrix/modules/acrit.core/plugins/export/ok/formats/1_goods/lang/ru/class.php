...
// General
$MESS[$strMessPrefix.'NAME'] = 'Одноклассники (товары)';

// Headers

$MESS[$strMessPrefix."FIELD_NAME_NAME"] = "Название товара";
$MESS[$strMessPrefix."FIELD_DESCRIPTION_NAME"] = "Описание товара";
$MESS[$strMessPrefix."FIELD_MAIN_PHOTO_ID_NAME"] = "Изображения товара";
$MESS[$strMessPrefix."FIELD_CATEGORY_NAME"] = "Название категории товара";
$MESS[$strMessPrefix."FIELD_CATEGORY_PHOTO_NAME"] = "Картинка категории";
$MESS[$strMessPrefix."FIELD_PRICE_NAME"] = "Цена товара";
$MESS[$strMessPrefix."FIELD_CURRENCY_NAME"] = "Валюта";
$MESS[$strMessPrefix."FIELD_AVAILABLE_NAME"] = "Доступность товара";

# Steps
$MESS[$strMessPrefix.'STEP_EXPORT'] = 'Экспорт в OK';
...
$MESS[$strMessPrefix.'ALBUMS_TABLE_NOTE'] = 'Данная таблица замен сработает лишь в том случае, если поле "Название подборки товаров" установлено в значение "ID (раздел)".';
