			...
			<table class="acrit-exp-plugin-settings" style="width:100%;">
				<tbody>
					...
					<tr>
						...
						<td width="60%" class="adm-detail-content-cell-r">
							<input type="text" name="PROFILE[PARAMS][ACCESS_TOKEN]" id="acrit_exp_plugin_access_token" value="<?=$this->arProfile['PARAMS']['ACCESS_TOKEN'];?>" size="90" />
						</td>
					</tr>
					...
					<tr>
						...
						<td width="60%" class="adm-detail-content-cell-r">
							...
							<?if(strlen($this->arProfile['PARAMS']['GROUP_ID'])):?>
								&nbsp;
								<?=$this->showFileOpenLink('', static::getMessage('SETTINGS_GROUP_ID_URL'));?>
							<?endif?>
