<?
/**
 * Acrit Core: Orders integration plugin for tiu.ru
 * Documentation: https://public-api.docs.tiu.ru/
 */

namespace Acrit\Core\Orders\Plugins\TiuRuHelpers;
...
class Request {
	const URL = 'https://my.tiu.ru/api/v1';
