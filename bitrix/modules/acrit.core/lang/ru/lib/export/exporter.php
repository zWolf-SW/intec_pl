...
$MESS['ACRIT_EXP_LOG_PROCESS_NO_ITEMS_FOR_EXPORT'] = 'Не найдено товаров для выгрузки.';
...
# Errors
$MESS['ACRIT_EXP_EXPORT_ERROR_EMPTY_RESPONSE'] = 'Пустой ответ центра обновлений.';
$MESS['ACRIT_EXP_EXPORT_ERROR_BAD_RESPONSE'] = 'Неожиданный ответ центра обновлений.';
$MESS['ACRIT_EXP_EXPORT_ERROR_WRONG_RESPONSE'] = 'Ошибочный ответ центра обновлений.';
$MESS['ACRIT_EXP_EXPORT_ERROR_EXPIRED_RESPONSE'] = 'Для продолжения работы выгрузки необходимо продлить лицензию модуля экспорта.';
$MESS['ACRIT_EXP_EXPORT_ERROR_EXPORTFILE_GENERAL'] = 'Ошибка выгрузки.';
$MESS['ACRIT_EXP_EXPORT_ERROR_FILE_PERMISSIONS'] = 'Ошибка работы с файлами. Проверьте права доступа на выгружаемый файл и родительскую папку.';
$MESS['ACRIT_EXP_EXPORT_ERROR_HANDLER'] = 'Выгрузка прервана обработчиком OnExportStart.';
$MESS['ACRIT_EXP_EXPORT_ERROR_FORMAT_NOT_FOUND'] = 'Настроенный в профиле формат выгрузки не существует в модуле.';
$MESS['ACRIT_EXP_EXPORT_ERROR_NO_ITEMS_FOR_EXPORT'] = 'Не найдены товары для выгрузки.';

# Email
$MESS['ACRIT_EXP_EXPORT_EMAIL_NOTIFY_SUBJECT'] = '#DOMAIN#: экспорт завершён: [#MODULE_ID#, профиль #PROFILE_ID#] "#FORMAT_NAME#"';
$MESS['ACRIT_EXP_EXPORT_EMAIL_NOTIFY_SUBJECT_ERROR'] = '#DOMAIN#: ошибка экспорта: [#MODULE_ID#, профиль #PROFILE_ID#]';
$MESS['ACRIT_EXP_EXPORT_EMAIL_NOTIFY_BODY_ERROR'] = 'Произошла ошибка при выгрузке:<br>
Домен: #DOMAIN#<br>
Модуль: #MODULE_ID#<br>
Профиль: [#PROFILE_ID#] #FORMAT_NAME#<br>
<br>
Текст ошибки:<br>
<b>#ERROR#</b><br>
';
