...
$MESS['ACRIT_EXP_TAB_BASIC_NAME'] = 'Общие настройки';
	$MESS['ACRIT_EXP_TAB_BASIC_DESC'] = 'Общие настройки создаваемых заказов';
$MESS['ACRIT_EXP_TAB_CONTACTS_NAME'] = 'Покупатель';
	$MESS['ACRIT_EXP_TAB_CONTACTS_DESC'] = 'Данные пользователя, прикрепляемого к заказу магазина';
$MESS['ACRIT_EXP_TAB_STAGES_NAME'] = 'Статусы';
	$MESS['ACRIT_EXP_TAB_STAGES_DESC'] = 'Сопоставление со статусами заказов магазина';
$MESS['ACRIT_EXP_TAB_FIELDS_NAME'] = 'Свойства';
	$MESS['ACRIT_EXP_TAB_FIELDS_DESC'] = 'Сопоставление со свойствами заказов магазина';
...
$MESS['ACRIT_EXP_TAB_LOG_NAME'] = 'Лог';
	$MESS['ACRIT_EXP_TAB_LOG_DESC'] = 'Лог профиля';
$MESS['ACRIT_EXP_TAB_SPECIAL_NAME'] = 'Настройки площадки';
    $MESS['ACRIT_EXP_TAB_SPECIAL_DESC'] = 'Дополнительные настройки площадки';
$MESS['ACRIT_EXP_TAB_ORDERS_NAME'] = 'Работа с заказами';
    $MESS['ACRIT_EXP_TAB_ORDERS_DESC'] = 'Работа с заказами';
// Popup: SelectField
