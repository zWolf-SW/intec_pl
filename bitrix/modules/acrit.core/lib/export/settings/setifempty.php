...
class SettingsSetIfEmpty extends SettingsBase {
	...
	public static function isShown($obField, $arParams){
		if(in_array($obField->getModuleId(), array_slice(\Acrit\Core\Export\Exporter::getInstance($obField->getModuleId())->getExportModules(true), -3))){
			return true;
		}
		return false;
	}
