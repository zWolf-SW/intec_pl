...
abstract class Plugin {
	...
	public static function getLangCode($code) {
		return 'ACRIT_CRM_PLUGIN_' . static::getCode() . '_' . $code;
	}
	...
	public function addToLog($strMessage){
		return Log::getInstance($this->strModuleId, 'crm')->add($strMessage, $this->intProfileId);
	}
	...
	protected function logAndPrintError($strLangPhraseID, $intProfileID){
		...
		if(strlen($strMessage)){
			Log::getInstance($this->strModuleId, 'crm')->add($strMessage, $intProfileID);
	...
	public function getOption($name) {
		...
		if ($name && $this->arProfile['ID']) {
			$arProfile = Helper::call($this->strModuleId, 'CrmProfiles', 'getProfiles', [$this->arProfile['ID']]);
	...
	public function setOption($name, $value) {
		...
		if ($name && $this->arProfile['ID']) {
			...
			$obResult = Helper::call($this->strModuleId, 'CrmProfiles', 'update', [$this->arProfile['ID'], [
