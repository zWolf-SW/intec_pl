    ...
    <tr>
        <td colspan="2">
            <div class="adm-info-message">
                <a href="https://www.acrit-studio.ru/technical-support/configuring-the-module-export-on-trade-portals/nastroyka-profiley-integratsii-s-crm-obshchaya-instruktsiya/" target="_blank"><?=GetMessage("ACRIT_CRM_GENERAL_HELP_PROFILES"); ?></a><br />
                <?
                if ($help_link):
