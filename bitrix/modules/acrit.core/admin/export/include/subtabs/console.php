...
$arCommands = array(
	...
	array(
		'TITLE' => 'findByFilter',
		'COMMAND' => 'Debug::findByFilter([\'%DETAIL_TEXT\' => \'Demo_Text\'])',
		'TEXT_MODE' => 'N',
		'HINT' => Loc::getMessage('ACRIT_EXP_TAB_CONSOLE_findByFilter'),
	),
	array(
		'TITLE' => 'generateFirst',
	...
	array(
		'TITLE' => 'getFilter',
		'COMMAND' => 'Debug::getFilter()',
		'TEXT_MODE' => 'Y',
		'HINT' => Loc::getMessage('ACRIT_EXP_TAB_CONSOLE_getFilter'),
	),
	array(
		'TITLE' => 'getOffersFilter',
		'COMMAND' => 'Debug::getOffersFilter()',
		'TEXT_MODE' => 'Y',
		'HINT' => Loc::getMessage('ACRIT_EXP_TAB_CONSOLE_getOffersFilter'),
	),
	array(
		'TITLE' => 'showFilter',
