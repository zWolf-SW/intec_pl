...
$strDownloadUrl = $APPLICATION->getCurPageParam(http_build_query([
	'download' => 'fields',
...
<?if($intThisIBlockID):?>
	<div data-role="download-fields">
		<a href="<?=$strDownloadUrl;?>" title="<?=Loc::getMessage('ACRIT_EXP_STRUCTURE_IBLOCK_DOWNLOAD_FIELDS_TITLE');?>">
			<span><?=Loc::getMessage('ACRIT_EXP_STRUCTURE_IBLOCK_DOWNLOAD_FIELDS');?></span>
		</a>
	</div>
