...
// Name
$obTabControl->BeginCustomField('PROFILE[NAME]', Loc::getMessage('ACRIT_EXP_FIELD_NAME'), true);
?>
	<tr id="tr_NAME">
		<td>
...
?>
    <tr id="tr_DIRECTION">
        <td>
	        <?//=Helper::ShowHint(Loc::getMessage('ACRIT_CRM_GENERAL_DIRECTION_HINT'));?>
...
?>
    <tr id="tr_START_DATE">
        <td>
	        <?=Helper::ShowHint(Loc::getMessage('ACRIT_CRM_GENERAL_START_DATE_HINT'));?>
...
// Help
$obTabControl->BeginCustomField('PROFILE[CONNECT_CRED][help]', Loc::getMessage('ACRIT_CRM_GENERAL_HELP'), true);
$help_link = $obPlugin->getHelpLink();
$profile_name = $obPlugin->getName();
?>
    <tr>
        <td colspan="2">
            <div class="adm-info-message">
                <a href="https://www.acrit-studio.ru/technical-support/configuring-the-module-export-on-trade-portals/nastroyka-profiley-integratsii-s-zakazami-obshchaya-instruktsiya/" target="_blank"><?=GetMessage("ACRIT_CRM_GENERAL_HELP_PROFILES"); ?></a><br />
				<?
				if ($help_link):
					echo '<a href="' . $help_link . '" target="_blank">' . GetMessage("ACRIT_CRM_GENERAL_HELP_CUR_PROFILE", ['#NAME#' => $profile_name]) . '</a>';
				endif;
				?>
            </div>
        </td>
	...
	<?
$obTabControl->EndCustomField('PROFILE[CONNECT_CRED][help]');
