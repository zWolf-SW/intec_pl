<?
$MESS["CLU_REDIS_LIST_ADD"] = "Добавить";
$MESS["CLU_REDIS_LIST_ADD_TITLE"] = "Добавить подключение к redis";
$MESS["CLU_REDIS_LIST_REFRESH"] = "Обновить";
$MESS["CLU_REDIS_LIST_ID"] = "ID";
$MESS["CLU_REDIS_LIST_FLAG"] = "Состояние";
$MESS["CLU_REDIS_LIST_STATUS"] = "Статус";
$MESS["CLU_REDIS_LIST_WEIGHT"] = "Использовать (%)";
$MESS["CLU_REDIS_LIST_HOST"] = "Сервер";
$MESS["CLU_REDIS_LIST_EDIT"] = "Изменить";
$MESS["CLU_REDIS_LIST_DELETE"] = "Удалить";
$MESS["CLU_REDIS_LIST_DELETE_CONF"] = "Удалить подключение?";
$MESS["CLU_REDIS_LIST_START_USING"] = "Начать использовать";
$MESS["CLU_REDIS_LIST_STOP_USING"] = "Прекратить использовать";
$MESS["CLU_REDIS_UPTIME"] = "время работы";
$MESS["CLU_REDIS_LIST_TITLE"] = "Подключения к redis";
