...
<?= Html::beginTag('component', [
    'is' => 'v-dialog',
    'content-class' => 'intec-editor-dialog intec-editor-dialog-auto intec-editor-dialog-container-script intec-editor-dialog-theme-default',
    'persistent' => true,
    'max-width' => '960',
    'v-model' => 'display',
    ...
    <div class="intec-editor-dialog-wrapper">
        ...
        <div class="intec-editor-dialog-title" data-align="left">
            {{ $root.$localization.getMessage('dialogs.containerScript.title') }}
        </div>
