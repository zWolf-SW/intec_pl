...
<?= Html::beginTag('component', [
    'is' => 'v-dialog',
    'content-class' => 'intec-editor-dialog intec-editor-dialog-auto intec-editor-dialog-container-paste intec-editor-dialog-theme-default',
    'persistent' => true,
    'max-width' => '960',
    'v-model' => 'display',
    ...
    <div class="intec-editor-dialog-wrapper">
        ...
        <div class="intec-editor-dialog-title" data-align="left">
            {{ $root.$localization.getMessage('dialogs.containerPaste.title') }}
        </div>
        <div class="intec-editor-dialog-content">
            <div class="intec-editor-dialog-content-wrapper">
                <div class="intec-editor-dialog-content-part">
                    <div class="intec-editor-dialog-area">
                    ...
                    <div class="intec-editor-dialog-buttons">
                        <?= Html::beginTag('button', [
                            ...
                            {{ $root.$localization.getMessage('dialogs.containerPaste.buttons.paste') }}
                        <?= Html::endTag('button') ?>
                    </div>
                </div>
            </div>
