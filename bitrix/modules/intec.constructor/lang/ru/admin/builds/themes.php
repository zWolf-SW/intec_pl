...
$MESS['list.rows.actions.apply.to'] = 'Применить к';
$MESS['list.rows.actions.apply.to.all'] = 'Всем';
$MESS['list.rows.actions.delete'] = 'Удалить';
$MESS['list.rows.actions.delete.confirm'] = 'Вы действительно хотите удалить эту тему?';