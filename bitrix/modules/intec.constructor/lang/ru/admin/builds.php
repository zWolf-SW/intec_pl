...
$MESS['list.rows.actions.properties'] = 'Свойства';
$MESS['list.rows.actions.templates'] = 'Шаблоны';
$MESS['list.rows.actions.themes'] = 'Темы';
$MESS['list.rows.actions.export'] = 'Экспорт';
$MESS['list.rows.actions.delete'] = 'Удалить';
$MESS['list.rows.actions.delete.confirm'] = 'Вы действительно хотите удалить эту сборку?';