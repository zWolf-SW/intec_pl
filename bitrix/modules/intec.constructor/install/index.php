...
class intec_constructor extends CModule
{
    ...
    function InstallDB()
    {
        ...
        $DB->Query('CREATE TABLE IF NOT EXISTS `constructor_builds_templates_containers_layouts_zones_links`(
          `containerId` int(11) NOT NULL,
          `layoutZoneCode` varchar(255) NOT NULL,
          PRIMARY KEY (`containerId`, `layoutZoneCode`)
        );');
    ...
    function UnInstallDB()
    {
        ...
        $DB->Query('DROP TABLE IF EXISTS
           ...
           `constructor_builds_templates_containers_layouts_zones_links`,
    ...
    function DoInstall()
    {
        ...
        if (Loader::includeModule('security')) {
            ...
            $arFilterMasks[] = [
                'SITE_ID' => '',
                'MASK' => '/bitrix/admin/constructor_*'
            ];
    ...
    function DoUninstall()
    {
        ...
        if (Loader::includeModule('security')) {
            ...
            while ($arFilterMask = $rsFilterMasks->GetNext())
                if ($arFilterMask['FILTER_MASK'] != '/bitrix/admin/constructor_*')
                    $arFilterMasks[] = [
                        'SITE_ID' => $arFilterMask['SITE_ID'],
                        'MASK' => $arFilterMask['FILTER_MASK']
                    ];
