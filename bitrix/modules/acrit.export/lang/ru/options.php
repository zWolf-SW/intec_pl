<?
$MESS['ACRIT_CORE_TAB_GENERAL_NAME'] = 'Общие настройки';
	$MESS['ACRIT_CORE_TAB_GENERAL_DESC'] = 'Общие настройки';
$MESS['ACRIT_CORE_TAB_LOG_NAME'] = 'Лог';
	$MESS['ACRIT_CORE_TAB_LOG_DESC'] = 'Общий лог модуля';
$MESS['ACRIT_CORE_TAB_AGENTS_NAME'] = 'Агенты (старое)';
	$MESS['ACRIT_CORE_TAB_AGENTS_DESC'] = 'Агенты (для старого ядра модуля)';
$MESS['ACRIT_CORE_TAB_SUPPORT_NAME'] = 'Опции и техподдержка (старое)';
	$MESS['ACRIT_CORE_TAB_SUPPORT_DESC'] = 'Опции и техподдержка (для старого ядра модуля)';

// Old core
$MESS["ACRIT_EXPORT_OP_PHP_PATH"] = "Путь к php:";
...
$MESS["SC_SET_BITRIX_CLOUD_MONITORING_EMAIL"] = "admin@acrit.ru";
...
$MESS["ACRIT_EXPORT_MARKET_CATEGORIES_UPDATE_BUTTON"] = "Обновить категории выгрузки относительно Торговых порталов";
$MESS["ACRIT_EXPORT_SET_CRON_AGENTS_OPTIONS_BUTTON"] = "Отключить агенты на хитах";
$MESS["ACRIT_EXPORT_SET_BITRIX_CLOUD_MONITORING_BUTTON_ON"] = "Включить мониторинг работы модуля";
$MESS["ACRIT_EXPORT_SET_BITRIX_CLOUD_MONITORING_BUTTON_OFF"] = "Отключить мониторинг работы модуля";
$MESS["SC_SET_CRON_AGENTS_INFO"] = "Пошаговая инструкция запуска агентов на Cron";
$MESS["ACRIT_EXPORT_SET_CRON_AGENTS_OPTIONS_STEPS"] = "
<ol type=\"1\">
...
$MESS["ACRIT_EXPORT_JQUERY_REQUIRE"] = "Отсутствует либо неисправна библиотека jQuery";
?>