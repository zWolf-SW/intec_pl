CREATE TABLE IF NOT EXISTS `acrit_export_profile`(
...
CREATE TABLE IF NOT EXISTS `acrit_export_profile_data`(
    `ID` int(11) NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `acrit_export_profile_tools`(
    `ID` int(11) NOT NULL auto_increment,
    `PROFILE_ID` int(11) NOT NULL,
