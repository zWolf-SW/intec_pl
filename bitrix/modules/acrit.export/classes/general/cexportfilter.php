...
class CAcritExportCatalog extends CAcritCatalogCondCtrlIBlockFields{
        ...
        $arControlList = array(
            "CondAcritCatpriceSetContains" => array(
                ...
                "JS_VALUE" => array(
                    ...
                    "popup_params" => array(
                        "lang" => LANGUAGE_ID,
                        "IBLOCK_ID" => CAcritExportProps::$arIBlockFilter[0],
                        "discount" => "Y"
                    ),
                    "param_id" => "n"
                ),
            ),
            "CondExportAvailability" => array(
                "ID" => "CondExportAvailability",
...
class CAcritExportPrices extends CAcritCatalogCondCtrlIBlockFields{
	public static function GetClassName(){
		return __CLASS__;
	}
...
class CAcritExportProps extends CAcritCatalogCondCtrlIBlockProps{
...
class CAcritExportCatalogCond extends CAcritGlobalCondTree{
	public static function GetClassName(){
		return __CLASS__;
	}
	...
	public function OnConditionControlBuildList(){
        if( !$this->boolError && !isset( $this->arControlList ) ){
            ...
            $basicEvents = array_merge( $basicEvents, array(
                    array(
                        "TO_CLASS" => "CAcritExportPrices",
                        "TO_METHOD" => "GetControlDescr"
                    ),
                    array(
                        "TO_CLASS" => "CAcritExportCatalog",
                        "TO_METHOD" => "GetControlDescr"
                    ),
                )
            );
            foreach( $basicEvents as $arEvent ){
                if( $arEvent["TO_CLASS"] == "CAcritCatalogCondCtrlIBlockProps" ){
                    $arEvent["TO_CLASS"] = "CAcritExportProps";
                    $arEvent["TO_MODULE_ID"] = "acrit.export";
                    $arEvent["TO_NAME"] = "CAcritExportProps::GetControlDescr (acrit.export)";
                }
