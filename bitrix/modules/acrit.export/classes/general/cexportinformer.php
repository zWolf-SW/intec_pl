...
class CExportInformer{
    ...
    private function GetMarketModulesInfo(){
        ...
        if( CAcritExportTools::ArrayValidate( $arModuleList["MODULE"] ) ){
    ...
    public function GetModuleUpdatesInfo(){
        ...
        if( CAcritExportTools::ArrayValidate( $arModuleList["MODULE"] ) ){
            foreach( $arModuleList["MODULE"] as $arModule ){
                ...
                if( CAcritExportTools::ArrayValidate( $arModule["#"] )
                    && CAcritExportTools::ArrayValidate( $arModule["#"]["VERSION"] )
                ){
                    $bHasUpdates = true;
                }
            }
