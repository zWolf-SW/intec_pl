...
class CExportProfileDB{
    ...
    private $profileTableName = "acrit_export_profile";
    private $dataTableName = "acrit_export_profile_data";
    private $toolsTableName = "acrit_export_profile_tools";
