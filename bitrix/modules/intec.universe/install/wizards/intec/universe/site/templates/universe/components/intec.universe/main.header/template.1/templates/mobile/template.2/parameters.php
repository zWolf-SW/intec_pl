...
$arReturn['MOBILE_SEARCH_TYPE'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_HEADER_TEMP1_MOBILE_TEMP2_SEARCH_TYPE'),
    'TYPE' => 'LIST',
    'VALUES' => [
        'page' => Loc::getMessage('C_HEADER_TEMP1_MOBILE_TEMP2_SEARCH_TYPE_PAGE'),
        'popup' => Loc::getMessage('C_HEADER_TEMP1_MOBILE_TEMP2_SEARCH_TYPE_POPUP')
    ],
    'DEFAULT' => 'page'
];
