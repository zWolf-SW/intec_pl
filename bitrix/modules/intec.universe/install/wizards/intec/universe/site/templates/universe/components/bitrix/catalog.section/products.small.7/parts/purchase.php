            ...
            <?php if ($arItem['CAN_BUY']) { ?>
                ...
                <?= Html::beginTag('div', [
                    ...
                    <?= Html::beginTag('a', [
                        ...
                        <?= Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_7_BASKET_ADDED') ?>
                    <?= Html::endTag('a') ?>
                <?= Html::endTag('div') ?>
            <?php } else { ?>
                ...
                <?php } else { ?>
                    <?= Html::beginTag('div', [
                        ...
                        <?= Html::tag('div', Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_7_UNAVAILABLE'), [
                            'class' => [
                                'catalog-section-item-purchase-button',
                                'intec-cl-background',
                                'intec-cl-background-light-hover'
                            ],
                            'title' => Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_7_UNAVAILABLE')
                        ]) ?>
                    <?= Html::endTag('div') ?>
                <?php } ?>
            <?php } ?>
        <?php } else if ($arItem['ACTION'] === 'detail') { ?>
            <div class="catalog-section-item-purchase-detail">
                <?= Html::beginTag($arResult['QUICK_VIEW']['DETAIL'] ? 'div' : 'a', [
                    ...
                    <?= Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_7_MORE_INFO') ?>
