...
$arTemplateParameters['ACTION'] = [
    ...
    'VALUES' => [
        ...
        'request' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_ACTION_REQUEST')
    ],
    'DEFAULT' => 'none'
];
...
if ($arCurrentValues['COUNTER_SHOW'] === 'Y') {
    $arTemplateParameters['COUNTER_MESSAGE_MAX_SHOW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_COUNTER_MESSAGE_MAX_SHOW'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'Y'
    ];
}
...
if ($bBase) {
    ...
    if (Loader::includeModule('intec.measures')) {
        $arTemplateParameters['MEASURES_USE'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_MEASURES_USE'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'N',
            'REFRESH' => 'Y'
        ];
...
if (!empty($arIBlock)) {
    ...
    $arTemplateParameters['PROPERTY_MARKS_SHARE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_PROPERTY_MARKS_SHARE'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertiesCheckbox,
        'ADDITIONAL_VALUES' => 'Y',
        'REFRESH' => 'Y'
    ...
    $arTemplateParameters['OFFERS_PROPERTY_PICTURE_DIRECTORY'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_OFFERS_PROPERTY_PICTURE_DIRECTORY'),
        'TYPE' => 'LIST',
...
$arTemplateParameters['OFFERS_PROPERTIES_SHOW'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_OFFERS_PROPERTIES_SHOW'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'Y'
];
if ($arCurrentValues['INFORMATION_PAYMENT_SHOW'] === 'Y') {
    $arTemplateParameters['OFFERS_PROPERTIES_PREVIEW_COUNT'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_OFFERS_PROPERTIES_PREVIEW_COUNT'),
        'TYPE' => 'STRING',
        'DEFAULT' => 2
    ];
    ...
    $arTemplateParameters['OFFERS_PROPERTIES_DELIMITER'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_OFFERS_PROPERTIES_DELIMITER'),
        'TYPE' => 'STRING',
        'DEFAULT' => ','
    ];
}
...
$arTemplateParameters['OFFERS_VARIABLE_SELECT'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_OFFERS_VARIABLE_SELECT'),
    'TYPE' => 'STRING'
];
...
$arTemplateParameters['PROPERTY_ACCESSORIES'] = [
    'PARENT' => 'DATA_SOURCE',
    'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_PROPERTY_ACCESSORIES'),
    'TYPE' => 'LIST',
    'VALUES' => $arPropertiesElementMultiple,
    'ADDITIONAL_VALUES' => 'Y',
    'REFRESH' => 'Y'
...
if (!empty($arCurrentValues['PROPERTY_ACCESSORIES'])) {
    $arTemplateParameters['PRODUCTS_ACCESSORIES_SHOW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_PRODUCTS_ACCESSORIES_SHOW'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'REFRESH' => 'Y'
    ];
    ...
    if (!empty($arCurrentValues['PRODUCTS_ACCESSORIES_SHOW'] === 'Y')) {
        $arTemplateParameters['PRODUCTS_ACCESSORIES_EXPANDED'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_PRODUCTS_ACCESSORIES_EXPANDED'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'N'
        ];
        $arTemplateParameters['PRODUCTS_ACCESSORIES_VIEW'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_PRODUCTS_ACCESSORIES_VIEW'),
            'TYPE' => 'LIST',
            'VALUES' => [
                'tile' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_PRODUCTS_ACCESSORIES_VIEW_TILE'),
                'list' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_PRODUCTS_ACCESSORIES_VIEW_LIST'),
                'link' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_PRODUCTS_ACCESSORIES_VIEW_LINK')
            ],
            'DEFAULT' => 'tile',
            'REFRESH' => 'Y'
        ];
        ...
        if ($arCurrentValues['PRODUCTS_ACCESSORIES_VIEW'] === 'link') {
            $arTemplateParameters['PRODUCTS_ACCESSORIES_LINK'] = [
                'PARENT' => 'VISUAL',
                'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_PRODUCTS_ACCESSORIES_LINK'),
                'TYPE' => 'STRING',
                'DEFAULT' => '/accessories/'
            ];
            $arTemplateParameters['PRODUCTS_ACCESSORIES_LINK_REQUEST_NAME'] = [
                'PARENT' => 'VISUAL',
                'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_PRODUCTS_ACCESSORIES_LINK_REQUEST_NAME'),
                'TYPE' => 'STRING',
                'DEFAULT' => 'PRODUCT_ID'
            ];
        } else {
    ...
    $arTemplateParameters['PRODUCTS_ACCESSORIES_NAME'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_PRODUCTS_ACCESSORIES_NAME'),
        'TYPE' => 'STRING',
        'DEFAULT' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_PRODUCTS_ACCESSORIES_NAME_DEFAULT')
    ];
}
...
$arTemplateParameters['PURCHASE_REQUEST_BUTTON_TEXT'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_PURCHASE_REQUEST_BUTTON_TEXT'),
    'TYPE' => 'STRING',
    'DEFAULT' => Loc::getMessage('C_CATALOG_ELEMENT_CATALOG_DEFAULT_2_PURCHASE_REQUEST_BUTTON_TEXT_DEFAULT')
];