...
$arParams = ArrayHelper::merge([
    ...
    'PRODUCT_SLIDER_NAVIGATION_VIEW' => 'shadow',
    'MEASURE_SHOW' => 'N',
...
$arBlocks = [
    'HEADER' => [
        ...
        'ALIGN' => $arParams['BLOCKS_HEADER_ALIGN']
    ],
    'PRODUCT_DAY_TIMER' => [
        'SHOW' => $arParams['PRODUCT_DAY_TIMER_SHOW'] === 'Y'
    ]
];
...
$arVisual = [
    ...
    'MARKS' => [
        ...
        'TEMPLATE' => !empty($arParams['MARKS_TEMPLATE']) ? $arParams['MARKS_TEMPLATE'] : null
    ],
    'COMPARE' => [
    ...
    'BUTTONS' => [
        ...
        'NAVIGATION' => [
            'VIEW' => ArrayHelper::fromRange(['shadow', 'border'], $arParams['PRODUCT_SLIDER_NAVIGATION_VIEW'])
        ]
    ]
];

if (empty($arVisual['BUTTONS']['BASKET']['TEXT']))
    $arVisual['BUTTONS']['BASKET']['TEXT'] = Loc::getMessage('C_WIDGET_PRODUCTS_SMALL_1_BASKET_ADD');

if (empty($arVisual['BUTTONS']['ORDER']['TEXT']))
    $arVisual['BUTTONS']['ORDER']['TEXT'] = Loc::getMessage('C_WIDGET_PRODUCTS_SMALL_1_ORDER');
...
foreach ($arResult['ITEMS'] as &$arItem) {
    ...
    $arItem['MARKS']['SHARE'] = !empty($arItem['MARKS']['SHARE']);
