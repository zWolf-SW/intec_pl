...
$arSvg = [
    'CONFIRM_REMOVE_PRODUCT_CLOSE' => FileHelper::getFileData(__DIR__.'/svg/alert.form.close.icon.svg'),
    'CONFIRM_REMOVE_PRODUCT_DELAY' => FileHelper::getFileData(__DIR__.'/svg/item.desktop.action.delay.svg')
];
                ...
                <?= Html::beginTag('div', [
                    ...
                    <?php if (ArrayHelper::isIn('top', $arParams['TOTAL_BLOCK_DISPLAY'])) { ?>
                        <?= Html::tag('div', '', [
                            ...
                            'data' => [
                                'code' => 'basket-total-top',
                                'entity' => 'basket-total-block',
                                'fixed' => $arParams['TOTAL_BLOCK_FIXED_MODE'] == 'Y' ? 'true' : 'false',
                                'sticky' => 'nulled'
                            ]
                        ]) ?>
                    <?php } ?>
                    ...
                    <?php if (ArrayHelper::isIn('bottom', $arParams['TOTAL_BLOCK_DISPLAY'])) { ?>
                        <?= Html::tag('div', '', [
                            ...
                            'data' => [
                                'code' => 'basket-total-bottom',
                                'entity' => 'basket-total-block',
                                'fixed' => $arParams['TOTAL_BLOCK_FIXED_MODE'] == 'Y' && !ArrayHelper::isIn('top', $arParams['TOTAL_BLOCK_DISPLAY']) ? 'true' : 'false'
                            ]
                        ]) ?>
                    <?php } ?>
                    <?php if ($arParams['CONFIRM_REMOVE_PRODUCT_USE'] === 'Y') {
                        include(__DIR__.'/parts/confirm.remove.product.php');
                    } ?>
                <?= Html::endTag('div') ?>
