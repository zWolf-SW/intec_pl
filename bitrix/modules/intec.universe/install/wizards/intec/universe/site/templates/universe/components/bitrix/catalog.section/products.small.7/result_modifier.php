...
$arParams = ArrayHelper::merge([
    ...
    'COLUMNS_MOBILE' => 1,
    'SLIDER_USE' => 'Y',
    'SLIDER_NAVIGATION_ARROW_USE' => 'Y',
    //'SLIDER_NAVIGATION_DOTS_USE' => 'N',
    'SLIDER_LOOP_USE' => 'N',
    'DELAY_USE' => 'N',
    'BORDERS' => 'N',
...
$arVisual = [
    ...
    'SLIDER' => [
        ...
        'ARROW' => $arParams['SLIDER_NAVIGATION_ARROW_USE'] === 'Y',
        'DOTS' => false,
...
if (empty($arVisual['BUTTONS']['BASKET']['TEXT']))
    $arVisual['BUTTONS']['BASKET']['TEXT'] = Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_7_BASKET_ADD');

if (empty($arVisual['BUTTONS']['ORDER']['TEXT']))
    $arVisual['BUTTONS']['ORDER']['TEXT'] = Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_7_ORDER');
...
foreach ($arResult['ITEMS'] as &$arItem) {
    ...
    $arItem['MARKS'] = [
        ...
        'VALUES' => [
            ...
            'SHARE' => ArrayHelper::getValue($arItem, ['PROPERTIES', $arCodes['MARKS']['SHARE'], 'VALUE'])
        ]
    ];
...
foreach ($arResult['ITEMS'] as $arItem) {
    ...
    $arResult['FORMATTED']['VALUES'][$sSectionId][] = $arItem;
}
...
$arResult['FORMATTED']['SECTIONS'] = $arSections;

unset($arSectionsIds, $sSectionId, $arSectionsFilter, $arSections);
