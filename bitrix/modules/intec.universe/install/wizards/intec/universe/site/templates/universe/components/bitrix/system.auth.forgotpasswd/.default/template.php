...
$sPrefix = 'C_SYSTEM_AUTH_FORGOTPASSWD_DEFAULT_';
?>
                    ...
                    <form method="POST" action="<?= $arResult['URL']['RESTORE'] ?>">
                        ...
                        <div class="system-auth-forgotpasswd-form-fields intec-ui-form-fields">
                            <div class="system-auth-forgotpasswd-form-field intec-ui-form-field intec-ui-form-field-required">
                                <label for="USER_EMAIL_RESTORE" class="intec-ui-form-field-title">
                            ...
                            <?php if ($arResult['PHONE_REGISTRATION']) { ?>
                                <div class="system-auth-forgotpasswd-form-field intec-ui-form-field intec-ui-form-field-required">
                                    <div class="intec-ui-form-field-title">
                                        <?= Loc::getMessage($sPrefix.'FIELDS_PHONE') ?>
                                    </div>
                                    <div class="intec-ui-form-field-content">
                            ...
                            <?php if ($arResult['USE_CAPTCHA']) { ?>
                                <div class="system-auth-forgotpasswd-form-field intec-ui-form-field intec-ui-form-field-required">
                                    <label for="captcha_word_restore" class="intec-ui-form-field-title">
                        ...
                        <div class="system-auth-forgotpasswd-form-buttons">
                            <div class="intec-grid intec-grid-wrap intec-grid-i-5">
                                <div class="intec-grid-item-auto">
                                    <?= Html::submitInput(Loc::getMessage($sPrefix.'BUTTONS_RESTORE'), [
                                ...
                                <div class="intec-grid-item-auto">
                                    <?= Html::a(Loc::getMessage($sPrefix.'BUTTONS_AUTHORIZE'), $arResult['URL']['AUTHORIZE'], [
                                        'class' => [
                                            'system-auth-forgotpasswd-form-button',
                                            'intec-ui' => [
                                                '',
