...
<?php if (ModuleManager::isModuleInstalled('sale')) { ?>
    <? $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            "QUICK_VIEW_IBLOCK_TYPE" => "#CATALOGS_PRODUCTS_IBLOCK_TYPE#",
            "QUICK_VIEW_IBLOCK_ID" => "#CATALOGS_PRODUCTS_IBLOCK_ID#",
...
<?php } else { ?>
    <? $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            "URL_ORDER_CREATED" => "#SITE_DIR#personal/profile/orders/#ID#/",
            "USE_ADAPTABILITY" => "Y",
