                    ...
                    <form method="POST" action="<?= $arResult['FORM_TARGET'] ?>?" enctype="multipart/form-data">
                        ...
                        <div class="main-profile-form-fields intec-ui-form-fields">
                            <div class="main-profile-form-field intec-ui-form-field">
                                <label class="intec-ui-form-field-title" for="PERSONAL_NAME">
                            ...
                            <div class="main-profile-form-field intec-ui-form-field">
                                <label class="intec-ui-form-field-title" for="LAST_NAME">
                            ...
                            <div class="main-profile-form-field intec-ui-form-field intec-ui-form-field-required">
                                <label class="intec-ui-form-field-title" for='PERSONAL_LOGIN'>
                            ...
                            <div class="main-profile-form-field intec-ui-form-field intec-ui-form-field-required">
                                <label class="intec-ui-form-field-title" for="PERSONAL_EMAIL" >
                            ...
                            <div class="main-profile-form-field intec-ui-form-field">
                                <label class="intec-ui-form-field-title" for="PERSONAL_PHONE">
