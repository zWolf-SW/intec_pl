...
if (!empty($arCurrentValues['IBLOCK_ID'])) {
    ...
    if ($arCurrentValues['BLOCKS_USE'] === 'Y') {
        ...
        if (!empty($arCurrentValues['BLOCKS_IBLOCK_ID'])) {
            ...
            $arTemplateParameters['BLOCKS_COLUMNS_MOBILE'] = [
                'PARENT' => 'BASE',
                'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_3_BLOCKS_COLUMNS_MOBILE'),
                'TYPE' => 'LIST',
                'VALUES' =>[
                    1 => '1',
                    2 => '2'
    ...
    $arTemplateParameters['PRODUCT_USE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_3_PRODUCT_USE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'REFRESH' => 'Y'
    ];

    if ($arCurrentValues['PRODUCT_USE'] === 'Y') {
        $arTemplateParameters['PROPERTY_PRODUCT'] = [
            'PARENT' => 'DATA_SOURCE',
            'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_3_PROPERTY_PRODUCT'),
            'TYPE' => 'LIST',
            'VALUES' => $arPropertyElems,
            'ADDITIONAL_VALUES' => 'Y',
            'REFRESH' => 'Y'
        ];

        include(__DIR__.'/parameters/product.php');
    }
    ...
    $arTemplateParameters['PROPERTY_TEXT_POSITION'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_3_PROPERTY_TEXT_POSITION'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertyList,
        'ADDITIONAL_VALUES' => 'Y',
        'REFRESH' => 'Y'
    ];
    $arTemplateParameters['MOBILE_BLOCK_SEPARATED'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_3_MOBILE_BLOCK_SEPARATED'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
...
if (!empty($arCurrentValues['PROPERTY_HEADER'])) {
    ...
    if ($arCurrentValues['HEADER_SHOW'] === 'Y') {
        $arTemplateParameters['HEADER_VIEW'] = [
            ...
            'TYPE' => 'LIST',
            'VALUES' => [
                1 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_3_VIEW', ['#NUMBER#' => 1]),
                2 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_3_VIEW', ['#NUMBER#' => 2]),
                3 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_3_VIEW', ['#NUMBER#' => 3]),
                4 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_3_VIEW', ['#NUMBER#' => 4]),
                5 => Loc::getMessage('C_MAIN_SLIDER_TEMPLATE_3_VIEW', ['#NUMBER#' => 5])
            ],
            'DEFAULT' => 1
        ];
    }
