...
foreach ($arResult['ITEMS'] as &$arItem) {
    ...
    $arItem['DATA']['STORES']['SHOW'] = $bBase && $arParams['USE_STORE'] === 'Y' && ArrayHelper::getValue($arItem, [
        'PROPERTIES',
    ...
    if (!empty($arItem['OFFERS']))
        foreach ($arItem['OFFERS'] as &$arOffer) {
            ...
            $arOffer['DATA']['STORES']['SHOW'] = $bBase && $arParams['USE_STORE'] === 'Y' && ArrayHelper::getValue($arOffer, [
                'PROPERTIES',
