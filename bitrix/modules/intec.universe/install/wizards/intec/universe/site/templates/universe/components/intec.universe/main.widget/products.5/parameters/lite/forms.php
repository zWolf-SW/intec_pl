...
$arTemplateParameters['FORM_REQUEST_ID'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_5_FORM_REQUEST_ID'),
    'TYPE' => 'LIST',
    'VALUES' => $forms,
    'ADDITIONAL_VALUES' => 'Y',
    'REFRESH' => 'Y'
...
if (!empty($arCurrentValues['FORM_REQUEST_ID'])) {
    ...
    $arTemplateParameters['FORM_REQUEST_PROPERTY_PRODUCT'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_5_FORM_REQUEST_PROPERTY_PRODUCT'),
        'TYPE' => 'LIST',
        'VALUES' => $fields->asArray($hFields),
        'ADDITIONAL_VALUES' => 'Y',
        'REFRESH' => 'Y'
    ...
    $arTemplateParameters['FORM_REQUEST_TEMPLATE'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('C_WIDGET_PRODUCTS_5_FORM_FORM_REQUEST_TEMPLATE'),
        'TYPE' => 'LIST',
        'VALUES' => $formTemplates,
        'ADDITIONAL_VALUES' => 'Y',
        'REFRESH' => 'Y'
