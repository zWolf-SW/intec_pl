...
if (!empty($arCurrentValues['IBLOCK_ID'])) {
    ...
    $arTemplateParameters['PROPERTY_MARK_SHARE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MAIN_CATEGORIES_TEMPLATE_10_PROPERTY_MARK_SHARE'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertyList,
        'ADDITIONAL_VALUES' => 'Y',
        'REFRESH' => 'Y'
...
if (!empty($arCurrentValues['PROPERTY_MARK_HIT']) || !empty($arCurrentValues['PROPERTY_MARK_RECOMMEND']) || !empty($arCurrentValues['PROPERTY_MARK_NEW']) || !empty($arCurrentValues['PROPERTY_MARK_SHARE'])) {
