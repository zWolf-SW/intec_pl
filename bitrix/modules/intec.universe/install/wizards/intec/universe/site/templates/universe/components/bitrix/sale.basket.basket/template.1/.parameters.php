...
$arTemplateParameters['SETTINGS_USE'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_BASKET_TEMPLATE_DEFAULT_1_SETTINGS_USE'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N'
];
...
$arTemplateParameters['CONFIRM_REMOVE_PRODUCT_USE'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_BASKET_TEMPLATE_DEFAULT_1_CONFIRM_REMOVE_PRODUCT_USE'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N'
];
$arTemplateParameters['OFFERS_VARIABLE_SELECT'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_BASKET_TEMPLATE_DEFAULT_1_OFFERS_VARIABLE_SELECT'),
    'TYPE' => 'STRING',
    'DEFAULT' => 'offer'
];
...
$arTemplateParameters['TOTAL_BLOCK_FIXED_MODE'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_BASKET_TEMPLATE_DEFAULT_1_TOTAL_BLOCK_FIXED_MODE'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N'
];
...
if ($arCurrentValues['USE_GIFTS'] === 'Y') {
    ...
    $arTemplateParameters['GIFTS_SHOW_SLIDER'] = [
        'PARENT' => 'GIFTS',
        'NAME' => Loc::getMessage('C_BASKET_TEMPLATE_DEFAULT_1_GIFTS_SHOW_SLIDER'),
        'TYPE' => 'CHECKBOX',
        'REFRESH' => 'Y',
        'DEFAULT' => 'N'
    ];
    ...
    if ( isset($arCurrentValues['GIFTS_SHOW_SLIDER']) && $arCurrentValues['GIFTS_SHOW_SLIDER'] === 'Y') {
        $arTemplateParameters['GIFTS_SLIDER_INTERVAL'] = [
            'PARENT' => 'GIFTS',
            'NAME' => Loc::getMessage('C_BASKET_TEMPLATE_DEFAULT_1_GIFTS_SLIDER_INTERVAL'),
            'TYPE' => 'STRING',
            'MULTIPLE' => 'N',
            'REFRESH' => 'N',
            'DEFAULT' => '3000'
        ...
        $arTemplateParameters['GIFTS_GIFTS_SLIDER_PROGRESS'] = [
            'PARENT' => 'GIFTS',
            'NAME' => Loc::getMessage('C_BASKET_TEMPLATE_DEFAULT_1_GIFTS_SLIDER_PROGRESS'),
            'TYPE' => 'CHECKBOX',
            'MULTIPLE' => 'N',
            'REFRESH' => 'N',
            'DEFAULT' => 'N'
...
$arTemplateParameters['QUICK_VIEW_USE'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_BASKET_TEMPLATE_DEFAULT_1_QUICK_VIEW_USE'),
    'TYPE' => 'CHECKBOX',
    'REFRESH' => 'Y',
    'DEFAULT' => 'N'
];
