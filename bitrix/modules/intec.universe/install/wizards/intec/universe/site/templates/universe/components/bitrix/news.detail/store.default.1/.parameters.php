...
$arTemplateParameters = array(
    'MAP_SHOW' => array(
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_NEWS_DETAIL_STORE_DEFAULT_1_PARAMETERS_MAP_SHOW'),
        'TYPE' => 'CHECKBOX',
        'REFRESH' => 'Y'
    ),
    'DESCRIPTION_SHOW' => array(
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_NEWS_DETAIL_STORE_DEFAULT_1_PARAMETERS_DESCRIPTION_SHOW'),
        'TYPE' => 'CHECKBOX',
        'REFRESH' => 'Y'
    ),
    'MAP_VENDOR' => array(
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_NEWS_DETAIL_STORE_DEFAULT_1_PARAMETERS_MAP_VENDOR'),
        'TYPE' => 'LIST',
        'VALUES' => array(
            'google' => Loc::getMessage('C_NEWS_DETAIL_STORE_DEFAULT_1_PARAMETERS_MAP_VENDOR_GOOGLE'),
            'yandex' => Loc::getMessage('C_NEWS_DETAIL_STORE_DEFAULT_1_PARAMETERS_MAP_VENDOR_YANDEX'),
        ),
        'ADDITIONAL_VALUES' => 'N',
        'DEFAULT' => 'yandex'
    )
...
if (!empty($iIBlockId)) {
    ...
    if ($arCurrentValues['MAP_SHOW'] == 'Y') {
        $arTemplateParameters['PROPERTY_MAP'] = array(
            'PARENT' => 'DATA_SOURCE',
            'NAME' => Loc::getMessage('C_NEWS_DETAIL_STORE_DEFAULT_1_PARAMETERS_PROPERTY_MAP'),
            'TYPE' => 'LIST',
        ...
        $arTemplateParameters['API_KEY_MAP'] = array(
            'PARENT' => 'DATA_SOURCE',
            'NAME' => Loc::getMessage('C_NEWS_DETAIL_STORE_DEFAULT_1_PARAMETERS_API_KEY_MAP'),
            'TYPE' => 'STRING'
        );
    }
    ...
    $arTemplateParameters['PROPERTY_ADDRESS'] = array(
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_NEWS_DETAIL_STORE_DEFAULT_1_PARAMETERS_PROPERTY_ADDRESS'),
        'TYPE' => 'LIST',
    ...
    $arTemplateParameters['PROPERTY_PHONE'] = array(
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_NEWS_DETAIL_STORE_DEFAULT_1_PARAMETERS_PROPERTY_PHONE'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertiesString,
        'ADDITIONAL_VALUES' => 'Y'
    );
    ...
    $arTemplateParameters['PROPERTY_EMAIL'] = array(
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_NEWS_DETAIL_STORE_DEFAULT_1_PARAMETERS_PROPERTY_EMAIL'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertiesString,
        'ADDITIONAL_VALUES' => 'Y'
    );
    ...
    $arTemplateParameters['PROPERTY_SCHEDULE'] = array(
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_NEWS_DETAIL_STORE_DEFAULT_1_PARAMETERS_PROPERTY_SCHEDULE'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertiesString,
        'ADDITIONAL_VALUES' => 'Y'
    );
