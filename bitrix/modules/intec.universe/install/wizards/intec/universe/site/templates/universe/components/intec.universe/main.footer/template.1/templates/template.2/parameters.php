...
$arReturn['ICONS'] = [
    ...
    'VALUES' => [
        ...
        'MIR' => Loc::getMessage('C_FOOTER_TEMPLATE_1_VIEW_2_ICONS_MIR'),
        'JCB' => Loc::getMessage('C_FOOTER_TEMPLATE_1_VIEW_2_ICONS_JCB'),
        'PayPal' => Loc::getMessage('C_FOOTER_TEMPLATE_1_VIEW_2_ICONS_PayPal')
    ],
    'MULTIPLE' => 'Y',
    'ADDITIONAL_VALUES' => 'Y'
];
