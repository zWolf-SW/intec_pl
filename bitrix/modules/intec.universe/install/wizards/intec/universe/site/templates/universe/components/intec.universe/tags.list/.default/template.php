...
?>
<div id="<?= $sTemplateId ?>" class="ns-intec-universe c-tags-list c-tags-list-default">
    <div class="tags-list-wrapper intec-content intec-content-visible">
        <div class="tags-list-wrapper-2 intec-content-wrapper">
            <form method="get" data-role="form">
                ...
                <?php } ?>
                <div class="tags-list-items intec-grid intec-grid-wrap intec-grid-i-h-5 intec-grid-i-v-2 intec-grid-a-h-start intec-grid-a-v-start" data-role="items">
