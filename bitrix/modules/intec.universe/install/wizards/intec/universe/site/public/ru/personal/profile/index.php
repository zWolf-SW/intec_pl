...
<?php if (ModuleManager::isModuleInstalled('sale')) { ?>
	...
	array(
		...
		"PRODUCT_VIEWED_IBLOCK_TYPE" => "#CATALOGS_PRODUCTS_IBLOCK_TYPE#",
		"PRODUCT_VIEWED_IBLOCK_ID" => "#CATALOGS_PRODUCTS_IBLOCK_ID#",
		...
		"PRODUCT_VIEWED_BASKET_URL" => "#SITE_DIR#personal/basket/",
		...
		"PRODUCT_VIEWED_COMPARE_PATH" => "#SITE_DIR#catalog/compare.php",
