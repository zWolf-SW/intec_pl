...
foreach ($arResult['ITEMS'] as &$arItem) {
    ...
    $sLink = !empty($arParams['DETAIL_URL']) ? $arParams['DETAIL_URL'] : $arItem['DETAIL_PAGE_URL'];

    $sStoreLink = StringHelper::replaceMacros($sLink, $arMacros);
    ...
    unset($iStoreId, $sStoreLink, $sLink);
}
