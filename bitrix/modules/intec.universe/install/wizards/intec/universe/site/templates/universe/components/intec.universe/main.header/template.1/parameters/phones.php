    ...
    if (Loader::includeModule('iblock')) {
        ...
        if (!empty($arCurrentValues['CONTACTS_IBLOCK_ID'])) {
            ...
            $hContactProperties = function ($sKey, $arProperty) {
                ...
                if ($arProperty['PROPERTY_TYPE'] == 'S' || $arProperty['PROPERTY_TYPE'] == 'L' || $arProperty['PROPERTY_TYPE'] == 'F')
                    return [
                        'skip' => false,
                        'key' => $arProperty['CODE'],
            ...
            $arTemplateParameters['CONTACTS_MOBILE_FORM_USE'] = [
                'PARENT' => 'BASE',
                'NAME' => Loc::getMessage('C_HEADER_TEMP1_CONTACTS_MOBILE_FORM_USE'),
                'TYPE' => 'CHECKBOX',
                'REFRESH' => 'Y'
            ];

            if ($arCurrentValues['PHONES_ADVANCED_MODE'] === 'Y' && $arCurrentValues['CONTACTS_MOBILE_FORM_USE'] === 'Y') {
                $arTemplateParameters['CONTACTS_MOBILE_FORM_ICON'] = [
                    'PARENT' => 'BASE',
                    'NAME' => Loc::getMessage('C_HEADER_TEMP1_CONTACTS_MOBILE_FORM_ICON'),
                    'TYPE' => 'LIST',
                    'VALUES' => $arProperties->asArray($hContactProperties),
                    'ADDITIONAL_VALUES' => 'N'
                ];
                $arTemplateParameters['CONTACTS_MOBILE_FORM_TEMPLATE'] = [
                    'PARENT' => 'BASE',
                    'NAME' => Loc::getMessage('C_HEADER_TEMP1_CONTACTS_MOBILE_FORM_TEMPLATE'),
                    'TYPE' => 'LIST',
                    'VALUES' => [
            ...
            $arTemplateParameters['CONTACTS_PROPERTY_ICON'] = [
                'PARENT' => 'BASE',
                'NAME' => Loc::getMessage('C_HEADER_TEMP1_CONTACTS_PROPERTY_ICON'),
                'TYPE' => 'LIST',
                'VALUES' => $arProperties->asArray($hContactProperties),
                'ADDITIONAL_VALUES' => 'Y'
            ];
