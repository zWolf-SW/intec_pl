    ...
    <div class="widget-wrapper intec-content intec-content-visible">
        <div class="widget-wrapper-2 intec-content-wrapper">
            ...
            <div class="widget-content">
                <div class="widget-items intec-grid intec-grid-wrap intec-grid-a-v-stretch intec-grid-i-16" data-columns="<?= $arVisual['COLUMNS'] ?>">
                    <?php foreach ($arResult['ITEMS'] as $arItem) {
                        ...
                        <?= Html::beginTag('div', [
                            ...
                            <?= Html::beginTag($sTag, [
                                ...
                                <div class="widget-item-content intec-grid intec-grid-a-h-center intec-grid-o-vertical">
