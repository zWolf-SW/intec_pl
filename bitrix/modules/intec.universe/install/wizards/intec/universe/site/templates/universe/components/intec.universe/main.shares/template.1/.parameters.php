...
$arTemplateParameters['ELEMENT_HEADER_PROPERTY_TEXT'] = [
    'PARENT' => 'DATA_SOURCE',
    'NAME' => Loc::getMessage('C_SHARES_TEMP1_ELEMENT_HEADER_PROPERTY_TEXT'),
    'TYPE' => 'LIST',
...
$arTemplateParameters['COLUMNS'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_SHARES_TEMP1_COLUMNS'),
    'TYPE' => 'LIST',
    'VALUES' => [
        3 => '3',
        4 => '4'
...
if ($arCurrentValues['LINK_USE'] === 'Y') {
    $arTemplateParameters['LINK_BLANK'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_SHARES_TEMP1_LINK_BLANK'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
}
...
if (!empty($arCurrentValues['ELEMENT_HEADER_PROPERTY_TEXT'])) {
    $arTemplateParameters['ELEMENT_HEADER_SHOW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_SHARES_TEMP1_ELEMENT_HEADER_SHOW'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
}
...
$arTemplateParameters['LINK_ALL_SHOW'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_SHARES_TEMP1_LINK_ALL_SHOW'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['LINK_ALL_SHOW'] == 'Y') {
    $arTemplateParameters['LINK_ALL_TEXT'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_SHARES_TEMP1_LINK_ALL_TEXT'),
        'TYPE' => 'STRING',
        'DEFAULT' => Loc::getMessage('C_SHARES_TEMP1_LINK_ALL_TEXT_DEFAULT')
    ];
}

$arTemplateParameters['TIMER_SHOW'] = [
    'PARENT' => 'TIMER',
    'NAME' => Loc::getMessage('C_SHARES_TEMP1_TIMER_SHOW'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['TIMER_SHOW'] === 'Y') {
    $arTemplateParameters['TIMER_PROPERTY_UNTIL_DATE'] = [
        'PARENT' => 'TIMER',
        'NAME' => Loc::getMessage('C_SHARES_TEMP1_TIMER_PROPERTY_UNTIL_DATE'),
        'TYPE' => 'LIST',
    ...
    if (!empty($arCurrentValues['TIMER_PROPERTY_UNTIL_DATE'])) {
        $arTemplateParameters['TIMER_PROPERTY_DISCOUNT'] = [
            'PARENT' => 'TIMER',
            'NAME' => Loc::getMessage('C_SHARES_TEMP1_TIMER_PROPERTY_DISCOUNT'),
            'TYPE' => 'LIST',
            'VALUES' => $arPropertyTextSingle,
            'ADDITIONAL_VALUES' => 'Y',
            'REFRESH' => 'Y'
