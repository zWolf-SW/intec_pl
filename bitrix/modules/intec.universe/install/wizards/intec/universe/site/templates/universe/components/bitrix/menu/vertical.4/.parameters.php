...
$arTemplateParameters['IBLOCK_TYPE'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_MENU_VERTICAL_4_PARAMETERS_IBLOCK_TYPE'),
    'TYPE' => 'LIST',
...
$arTemplateParameters['IBLOCK_ID'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_MENU_VERTICAL_4_PARAMETERS_IBLOCK_ID'),
    'TYPE' => 'LIST',
...
$arTemplateParameters['MAIN_VIEW'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MENU_VERTICAL_4_PARAMETERS_MAIN_VIEW'),
    'TYPE' => 'LIST',
    'VALUES' => [
        'simple' => Loc::getMessage('C_MENU_VERTICAL_4_PARAMETERS_MAIN_VIEW_SIMPLE_1'),
        'pictures' => Loc::getMessage('C_MENU_VERTICAL_4_PARAMETERS_MAIN_VIEW_PICTURES_1')
    ],
    'DEFAULT' => 'simple'
];
...
$arTemplateParameters['MAIN_LINK_SHOW'] = array(
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MENU_VERTICAL_4_MAIN_LINK_SHOW'),
    'TYPE' => 'CHECKBOX',
    'REFRESH' => 'Y',
    'DEFAULT' => 'N'
);
...
if ($arCurrentValues['MAIN_LINK_SHOW'] === 'Y') {
    $arTemplateParameters['MAIN_LINK'] = [
        'NAME' => Loc::getMessage('C_MENU_VERTICAL_4_MAIN_LINK'),
        'PARENT' => 'VISUAL',
        'TYPE' => 'STRING'
    ];

    $arTemplateParameters['MAIN_LINK_TEXT'] = [
        'NAME' => Loc::getMessage('C_MENU_VERTICAL_4_MAIN_LINK_TEXT'),
        'PARENT' => 'VISUAL',
        'TYPE' => 'STRING'
    ];
}
...
$arTemplateParameters['VIEW'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MENU_VERTICAL_4_PARAMETERS_VIEW'),
    'TYPE' => 'LIST',
    'VALUES' => [
        'simple.1' => Loc::getMessage('C_MENU_VERTICAL_4_PARAMETERS_VIEW_SIMPLE_1'),
        'pictures.1' => Loc::getMessage('C_MENU_VERTICAL_4_PARAMETERS_VIEW_PICTURES_1')
    ]
];
...
if (!empty($arIBlock)) {
    ...
    $arTemplateParameters['PROPERTY_PICTURE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MENU_VERTICAL_4_PARAMETERS_PROPERTY_PICTURE'),
        'TYPE' => 'LIST',
