...
<script type="text/javascript">
    template.load(function (data) {
        ...
        var messages = {
            'show': '<?= Loc::getMessage('C_CATALOG_SECTION_LIST_CATALOG_TILE_5_TEMPLATE_BUTTON_SHOW') ?>',
            'hide': '<?= Loc::getMessage('C_CATALOG_SECTION_LIST_CATALOG_TILE_5_TEMPLATE_BUTTON_HIDE') ?>'
        };
        ...
        'name': '[Component] bitrix:catalog.section.list (catalog.tile.6)',
