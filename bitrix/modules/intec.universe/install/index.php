...
class intec_universe extends CModule
{
    ...
    function InstallFiles()
    {
        ...
        CopyDirFiles($this->GetDirectory().'/install/components', $bitrixDirectory.'/components', true, true);
        CopyDirFiles($this->GetDirectory().'/install/modules', $bitrixDirectory.'/modules', true, true);
        CopyDirFiles($this->GetDirectory().'/install/resources', $bitrixDirectory.'/resources/intec.universe', true, true);
