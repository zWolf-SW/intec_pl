 ...
 * @property string $columnSettings Параметры таблицы.
...
class Template extends ActiveRecord
{
    ...
    {
        return 'intec_importexport_excel_export_profile';
    }
    ...
    {
        return [
            'id' => Loc::getMessage('intec.importexport.models.excel.export.template.attributes.id'),
            'name' => Loc::getMessage('intec.importexport.models.excel.export.template.attributes.name'),
            'fileType' => Loc::getMessage('intec.importexport.models.excel.export.template.attributes.file.type'),
            'createDate' => Loc::getMessage('intec.importexport.models.excel.export.template.attributes.create.date'),
            'editDate' => Loc::getMessage('intec.importexport.models.excel.export.template.attributes.edit.date')
        ];
    }
