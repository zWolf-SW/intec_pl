                                    ...
                                    <?= Html::beginTag('div', [
                                        ...
                                        <div class="sale-order-payment-change-item">
                                            ...
                                            if (empty($paySystem['LOGOTIP']))
                                                $paySystem['LOGOTIP'] = '/bitrix/templates/.default/components/bitrix/sale.order.payment.change/intec.cabinet.sale.order.payment.change.1/images/picture.missing.png';
                                            ?>
                                            <?= Html::tag('div', '', [
