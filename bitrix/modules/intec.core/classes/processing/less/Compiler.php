...
class Compiler {
	...
	protected function newFormatter() {
		$className = "intec\\core\\processing\\less\\Formatter\\JavaScript";
		if (!empty($this->formatterName)) {
			if (!is_string($this->formatterName))
				return $this->formatterName;
			$className = "intec\\core\\processing\\less\\Formatter\\$this->formatterName";
		}
    ...
    public function getVariable($name) {
        return ArrayHelper::getValue($this->registeredVars, $name);
    }
