...
namespace intec\core\processing\scss\Node;

use intec\core\processing\scss\Compiler;
use intec\core\processing\scss\Node;
use intec\core\processing\scss\Type;
...
class Number extends Node implements \ArrayAccess
{
     ...
     * @param array $units
     * @return \intec\core\processing\scss\Node\Number
     */
    ...
    /**
     * Output number
     * @param \intec\core\processing\scss\Compiler $compiler
     * @return string
     */
    public function output(Compiler $compiler = null)
    {
        ...
        reset($units);
        list($unit, ) = [key($units), current($units)];
