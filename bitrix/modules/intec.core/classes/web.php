...
if (FileHelper::isDirectory($directory)) {
    $js->addExtensions([
        ...
        new Extension([
            'id' => 'axios',
            'script' => $directory.'/js/axios.js'
        ]),
        new Extension([
            'id' => 'qs',
            'script' => $directory.'/js/qs.js'
        ]),
        new Extension([
            'id' => 'moment',
            'script' => $directory.'/js/moment.js'
        ]),
        new Extension([
            'id' => 'velocity',
            'script' => $directory.'/js/velocity.js'
        ]),
        new Extension([
            'id' => 'sortable',
            'script' => $directory.'/js/sortable.js'
        ]),
        new Extension([
            'id' => 'vue',
            'script' => $directory.'/js/vue.js'
        ]),
        new Extension([
            'id' => 'vue_runtime',
            'script' => $directory.'/js/vue.runtime.js'
        ]),
        new Extension([
            'id' => 'vue_vuetify',
            'script' => $directory.'/js/vue.vuetify.js',
            'style' => $directory.'/css/vue.vuetify.css',
            'dependencies' => ['vue']
        ]),
        new Extension([
            'id' => 'vue_vuescroll',
            'script' => $directory.'/js/vue.vuescroll.js',
            'style' => $directory.'/css/vue.vuescroll.css',
            'dependencies' => ['vue']
        ]),
        new Extension([
            'id' => 'vue_script2',
            'script' => $directory.'/js/vue.script2.js',
            'dependencies' => ['vue']
        ]),
        new Extension([
            'id' => 'vue_vuedraggable',
            'script' => $directory.'/js/vue.vuedraggable.js',
            'dependencies' => ['vue', 'sortable']
        ]),
        new Extension([
            'id' => 'knockout',
