...
class IBlockSections extends IBlock
{
     ...
     * @param Closure $fCallback
     * @return array
     */
    protected function getSections($arSort = null, $arFilter = null, $iCount = null, $iPage = null, $bQuantity = false, $arSelect = [], $fCallback = null)
    {
        global $APPLICATION;
        ...
        if ($fCallback instanceof Closure)
            $fCallback($rsResult);
