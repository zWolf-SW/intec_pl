...
/**
 * Class HtmlProperty
 * @package intec\core\bitrix\main\properties
 * @deprecated
 */
class HtmlProperty
{
     ...
     */
    public static function getEditFormHTML($arProperty, $arControl)
	{
     ...
     * @return mixed
     */
    public static function getAdminListViewHTML($arProperty, $arControl)
    {
     ...
     * @return mixed
     */
    public static function getAdminListEditHTML($arProperty, $arControl)
    {
     ...
     * @return mixed
     */
    public static function getPublicView($arProperty, $arAdditionalValues = [])
    {
     ...
     * @return null
     */
    public static function getSettingsHTML($arProperty = false, $arControl, $bVarsFromForm)
    {
        return null;
    }
}