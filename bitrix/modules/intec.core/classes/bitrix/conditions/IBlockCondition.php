...
/**
 * Класс, представляющий условие инфоблока по инфоблоку.
 * Class IBlockCondition
 * @property integer $value Идентификатор инфоблока.
 * @package intec\core\bitrix\conditions
 * @author apocalypsisdimon@gmail.com
 * @deprecated
 */
class IBlockCondition extends Condition
{
    /**
