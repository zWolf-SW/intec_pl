...
// синхронизация статусов
	...
	$MESS ['IPOLSDEK_callOrderStates_noNeed']  = "Активные заказы не обнаружены, проверка статусов не требуется.";
	$MESS ['IPOLSDEK_callOrderStates_proceed'] = "Производится синхронизация статусов";
