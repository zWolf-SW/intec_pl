		...
		<div class="landing-block-node-card js-slide">
			...
			<div class="landing-block-node-card-img g-flex-centered g-min-height-100vh h-100 g-bg-cover g-bg-pos-center g-bg-img-hero g-bg-black-opacity-0_5--after"
				...
				<div class="landing-block-node-container js-animation fadeInLeftBig container g-max-width-800 text-center g-z-index-1 g-mx-0 g-mb-40">
					...
					<div class="landing-block-node-card-text g-max-width-645 g-color-white-opacity-0_9 mx-auto g-mb-35" data-auto-font-scale>
						<p>This is
					...
					<div class="landing-block-node-card-button-container">
						<a class="landing-block-node-card-button btn g-btn-primary g-btn-type-solid g-btn-size-md g-btn-px-m text-uppercase g-rounded-50"
