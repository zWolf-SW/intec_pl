<section class="landing-block g-pos-rel" data-slider-autoplay="1" data-slider-autoplay-speed="5000">
	...
	<div class="u-bg-overlay__inner g-absolute-centered w-100 g-width-80x--md">
		<div class="landing-block-node-text-container js-animation fadeIn container text-center">
			<h2 class="landing-block-node-subtitle text-uppercase g-letter-spacing-1 g-font-weight-700 g-font-size-18 g-color-white g-brd-primary g-pb-5 g-mb-20 u-heading-v2-8-3--bottom">
				Fitness program for all</h2>
			<h3 class="landing-block-node-title text-uppercase g-line-height-1_4 g-letter-spacing-5 g-font-weight-700 g-font-size-40 g-color-white g-mb-20">
			...
			<ul class="list-inline g-mb-30">
				<li class="landing-block-node-card-list-item list-inline-item g-mx-20 g-mb-10 g-mb-0--md">
					...
					<div class="landing-block-node-icon-text g-font-size-16 g-color-white d-inline-block g-valign-middle">
			...
			<div class="landing-block-node-button-container">
				<a href="#"
				   class="landing-block-node-button btn g-btn-type-outline g-btn-white g-btn-size-md g-btn-px-l text-uppercase g-letter-spacing-1 g-rounded-50">
					Learn More</a>
			</div>
		</div>
	</div>
