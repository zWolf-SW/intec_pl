<section class="landing-block g-pt-30 g-pb-30">
	<div class="container">
		<div class="landing-block-node-header js-animation fadeIn text-uppercase text-center u-heading-v2-4--bottom g-brd-primary g-mb-80">
			<h6 class="landing-block-node-title g-font-weight-700 g-font-size-12 g-letter-spacing-1 g-color-primary g-mb-20">Our services</h6>
			<h2 class="landing-block-node-subtitle h1 u-heading-v2__title g-line-height-1_3 g-font-weight-700 g-font-size-40 g-mb-minus-10">What we do</h2>
		</div>
		<!-- Icon Blocks -->
