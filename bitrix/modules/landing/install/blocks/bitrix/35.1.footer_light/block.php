				...
				<address class="g-mb-20">
					...
					<div class="landing-block-card-contact g-pos-rel d-flex g-mb-7" data-card-preset="link">
						...
						<div>
							...
							<a class="landing-block-node-card-contact-link g-font-weight-700"
							   href="tel:#crmPhone1"
							   target="_blank">
								#crmPhoneTitle1
							</a>
					...
					<div class="landing-block-card-contact g-pos-rel d-flex g-mb-7" data-card-preset="link">
						...
						<div>
							...
							<a class="landing-block-node-card-contact-link g-font-weight-700" href="mailto:#crmEmail1" target="_blank">#crmEmailTitle1</a>
						</div>
					</div>
				</address>
