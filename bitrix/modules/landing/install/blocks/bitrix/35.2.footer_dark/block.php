<section class="g-pt-60 g-pb-60 g-bg-gray-dark-v1">
	<div class="container">
		<div class="row">
			<div class="landing-block-node-main-card js-animation fadeInLeft col-sm-12 col-md-6 col-lg-6 g-mb-25 g-mb-0--lg">
				<h2 class="landing-block-node-title text-uppercase g-color-white g-font-weight-700 g-font-size-16 g-mb-20">
					Contact us</h2>
				<div class="landing-block-node-text g-color-gray-light-v1 g-mb-20">
				...
				<address class="g-mb-20">
					...
					<div class="landing-block-card-contact d-flex g-pos-rel g-mb-7" data-card-preset="link">
						...
						<div>
							...
							<a class="landing-block-node-card-contact-link g-color-gray-light-v1 g-font-weight-700" href="tel:#crmPhone1" target="_blank">#crmPhoneTitle1</a>
						</div>
					</div>
					...
					<div class="landing-block-card-contact d-flex g-pos-rel g-mb-7" data-card-preset="link">
						...
						<div>
							...
							<a class="landing-block-node-card-contact-link g-color-gray-light-v1 g-font-weight-700" href="mailto:#crmEmail1" target="_blank">#crmEmailTitle1</a>
						</div>
					</div>
				</address>
