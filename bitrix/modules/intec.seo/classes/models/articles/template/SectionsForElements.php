...
/**
 * Модель привязки шаблона статей к разделу для выбора элементов.
 * Class Section
 ...
 */
class SectionsForElements extends ActiveRecord
{
    /**
     * @var array $cache
     */
    ...
    {
        return 'seo_articles_templates_sections_for_elements';
    }
