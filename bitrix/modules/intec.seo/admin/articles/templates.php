...
foreach ($templates as $template) {
    ...
    $actions[] = [
        ...
        'ACTION' => $list->ActionRedirect(StringHelper::replaceMacros($arUrlTemplates['articles.templates.edit'], [
    ...
    $actions[] = [
        ...
        'ACTION' => $list->ActionRedirect(StringHelper::replaceMacros($arUrlTemplates['articles.templates.copy'], [
            'template' => $template->id
        ]))
    ];
