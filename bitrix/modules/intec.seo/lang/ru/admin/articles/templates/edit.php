...
$MESS['fields.sections'] = 'Заполняемые разделы';
$MESS['fields.sectionsForElements'] = 'Разделы для выбора заполняемых элементов';
$MESS['fields.elements'] = 'Заполняемые элементы';
$MESS['list.all'] = 'Все разделы';
