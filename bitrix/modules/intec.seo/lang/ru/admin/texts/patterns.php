...
$MESS['list.rows.actions.delete.confirm'] = 'Вы действительно хотите удалить текстовый шаблон?';
$MESS['list.navigation.title'] = 'Текстовые шаблоны';