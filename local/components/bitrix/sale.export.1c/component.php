...
$mfile = $_SERVER['DOCUMENT_ROOT'].'/upload/tmp/1c_ex.log';
...
file_put_contents($mfile, $DIR_NAME."\n",FILE_APPEND);
...
file_put_contents($mfile, $filename."\n",FILE_APPEND);
...
file_put_contents($mfile, $ABS_FILE_NAME."\n",FILE_APPEND);
			}
		}
	}
...
file_put_contents($mfile, "zip=".$arParams["FILE_SIZE_LIMIT"]."\n",FILE_APPEND);
			if($_GET["version"] <> '')
			{
				echo bitrix_sessid_get()."\n";
				echo "version=2.09";
...
file_put_contents($mfile, "SaleExport"."\n",FILE_APPEND);
		}
