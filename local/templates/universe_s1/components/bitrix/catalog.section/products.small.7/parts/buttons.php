        ...
        <?= Html::beginTag('div', [
            ...
            <?php if ($arParentValues['DELAY'] && $arItem['CAN_BUY']) { ?>
                ...
                <?= Html::beginTag('div', [
                    ...
                    'title' => Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_7_DELAY_ADD_TITLE'),
                    'data' => [
                        'basket-id' => $arItem['ID'],
                        'basket-action' => 'delay',
                        'basket-state' => 'none',
                ...
                <?= Html::beginTag('div', [
                    ...
                    'title' => Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_7_DELAY_ADDED_TITLE')
                ]) ?>
                    <i class="intec-ui-icon intec-ui-icon-heart-1"></i>
                <?= Html::endTag('div') ?>
            <?php } ?>
            <?php if ($arResult['COMPARE']['USE']) { ?>
                <?= Html::beginTag('div', [
                    ...
                    'title' => Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_7_COMPARE_ADD_TITLE')
                ]) ?>
                ...
                <?= Html::beginTag('div', [
                    ...
                    'title' => Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_7_COMPARE_ADDED_TITLE')
                ]) ?>
                    <i class="glyph-icon-compare"></i>
                <?= Html::endTag('div') ?>
            <?php } ?>
            <?php if ($arItem['ORDER_FAST']['USE'] && $arItem['CAN_BUY']) { ?>
                <?= Html::beginTag('div', [
                    ...
                    'title' => Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_7_ORDER_FAST_TITLE')
                ]) ?>
            ...
            <?php if ($arResult['QUICK_VIEW']['USE']) { ?>
                <?= Html::beginTag('div', [
                    ...
                    'title' => Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_7_QUICK_VIEW_TITLE')
                ]) ?>
