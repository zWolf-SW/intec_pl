...
<div id="<?= $sTemplateId ?>" class="ns-bitrix c-form-result-new c-form-result-new-default intec-ui-form">
	...
	<script type="text/javascript">
		 document.getElementById('modaltr').style.height = '150px';
		 document.getElementById('modaltr').style.width = '250px';
		 document.getElementById('modaltr').style.overflow = 'hidden';
	</script>
        <div class="form-result-new-message form-result-new-message-note" style="padding:0px 10px">
            <div class="intec-grid intec-grid-wrap intec-grid-a-v-center">
                <div class="intec-grid-item-1 intec-grid intec-grid-a-v-center">
                    ...
                    <div class="form-result-new-message-note-text intec-grid-item" align=center>
                        <?= $arResult['FORM_NOTE'] ?>
                    </div>
                </div>
                <div style="width:100%;"><br><div style="margin:auto; width:120px;">
        ...
        <?= $arResult['FORM_HEADER'] ?>
            ...
            <?php if (!empty($arResult['arForm']["DESCRIPTION"])) { ?>
                <div class="form-result-new-description">
					<img src="<?=CFile::GetPath($arResult['arForm']['IMAGE_ID'])?>">
            ...
            <?php if (!empty($arResult['QUESTIONS']) || $arResult['isUseCaptcha']) { ?>
                <div class="form-result-new-fields intec-ui-form-fields" data-role="fields" style="padding:0px 10px">
                            ...
                            <?php } ?>
                              <?
								if ($arQuestion["STRUCTURE"][0]["FIELD_TYPE"]=='text'){
									$nn  = "<input type=\"text\" class=\"intec-ui intec-ui-control-input intec-ui-mod-block intec-ui-mod-round-2\" ";
									$nn .= "name=\"form_text_".$arQuestion["STRUCTURE"][0]["FIELD_ID"]."\" ";
									$nn .= " value=\"\">";
//									echo $nn;
									...
									if ($arQuestion["STRUCTURE"][0]["FIELD_TYPE"]=='email'){
										$nn  = "<input type=\"text\" class=\"intec-ui intec-ui-control-input intec-ui-mod-block intec-ui-mod-round-2\" ";
										$nn .= "name=\"form_email_".$arQuestion["STRUCTURE"][0]["FIELD_ID"]."\" ";
										$nn .= " value=\"\">";
//										echo $nn;
										echo $arQuestion['HTML_CODE'];
									 }else{
            ...
            <?php if ($arResult['CONSENT']['SHOW']) { ?>
                <div class="form-result-new-consent" style="width:100%">
...
<!--                    </label>-->
            ...
            <?php } ?>
                ...
                <div class="intec-grid intec-grid-wrap intec-grid-i-5" style="padding:0px 10px">
