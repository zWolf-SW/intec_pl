...
$arViews = [
    'TEXT' => [
        'NAME' => Loc::getMessage('C_CATALOG_CATALOG_1_VIEWS_TEXT'),
        'VALUE' => 'text',
        'ICON' => 'glyph-icon-view_text'
    ],
    'LIST' => [
        'NAME' => Loc::getMessage('C_CATALOG_CATALOG_1_VIEWS_LIST'),
        'VALUE' => 'list',
        'ICON' => 'glyph-icon-view_list'
    ],
    'TILE' => [
        'NAME' => Loc::getMessage('C_CATALOG_CATALOG_1_VIEWS_TILE'),
        'VALUE' => 'tile',
...
if ($arElements['SHOW'] || !empty($arElements['TEMPLATE'])) {
    ...
    foreach ($arParams as $sKey => $mValue) {
        if (StringHelper::startsWith($sKey, $sPrefix)) {
            ...
            $arElements['PARAMETERS'][$sKey] = $mValue;
        } else if (StringHelper::startsWith($sKey, 'CATALOG_TIMER_')) {
            $sKey = StringHelper::cut(
                $sKey,
                StringHelper::length('CATALOG_')
            );
            $arElements['PARAMETERS']['SECTION_'.$sKey] = $mValue;
    ...
    $arElements['PARAMETERS'] = ArrayHelper::merge($arElements['PARAMETERS'], [
        ...
        'QUICK_VIEW_TIMER_SHOW' => $arParams['QUICK_VIEW_TIMER_SHOW'],
        'SECTION_TIMER_SHOW' => $arParams[$sPrefix.'SECTION_TIMER_SHOW'],
        ...
        'GIFTS_SECTION_LIST_POSITION' => $arParams['GIFTS_SECTION_LIST_POSITION'],
        'GIFTS_SECTION_LIST_VIEW' => $arParams['GIFTS_SECTION_LIST_VIEW'],
        'GIFTS_SECTION_LIST_COLUMNS' => $arParams['GIFTS_SECTION_LIST_COLUMNS'],
        'GIFTS_SECTION_LIST_NAVIGATION_BUTTON_POSITION' => $arParams['GIFTS_SECTION_LIST_NAVIGATION_BUTTON_POSITION'],
