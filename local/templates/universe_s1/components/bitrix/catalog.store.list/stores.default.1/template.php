...
if (empty($arResult['STORES']))
    return;
?>
<div class="ns-bitrix c-catalog-store-list c-catalog-store-list-stores-default-1">
...
<?php if (count($arResult['STORES']) > 1) { ?>
    <script type="text/javascript">
        template.load(function (data) {
            ...
            initialize = function () {
                ...
                <?php } else if ($arResult['MAP']['VENDOR'] == 1) { ?>
                    ...
                    <?php foreach ($arResult["STORES"] as $arStore) {?>
                        ...
                        _.merge(bounds, new google.maps.LatLng(
                            <?= $arStore['MAP']['GPS']['N'] ?>,
                            <?= $arStore['MAP']['GPS']['S'] ?>
                        ));
                    <?php } ?>
            ...
            'name': '[Component] bitrix:catalog.store.list (stores.default.1)',
