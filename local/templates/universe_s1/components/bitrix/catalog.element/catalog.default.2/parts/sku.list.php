                ...
                ?>
                    <?= Html::beginTag('div', [
                        ...
                        <div class="catalog-element-offer-content intec-grid intec-grid-wrap intec-grid-a-v-baseline intec-grid-i-12">
                            <?php if ($arOffer['NAME'] || $arResult['SKU_PROPS'])  {?>
                                <div class="catalog-element-offer-info intec-grid-item intec-grid-item-800-1">
                                    ...
                                    <?php if ($arResult['SKU_PROPS_SHOW'] && $arResult['SKU_PROPS']) { ?>
                    ...
                    <?= Html::endTag('div') ?><!--/catalog-element-offer-->
                <?php } ?>
            </div><!--/catalog-element-section-offers-list-->
        </div><!--/catalog-element-section-content-->
    </div><!--/catalog-element-section-->
<?= Html::endTag('div') ?>
