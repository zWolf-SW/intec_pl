...
$fHandle = function (&$arItem, $arData, &$arParent = null) use (&$fHandle, &$arPricesTypes, &$arParams, &$arCurrency, $arVisual) {
    $bOffer = !empty($arParent);

    if ($bOffer && $arItem['ACTIVE'] === 'N' && !$arVisual['DEACTIVATED']['SHOW'])
        return;
