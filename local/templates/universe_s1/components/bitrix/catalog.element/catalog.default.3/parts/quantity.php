...
<?php $vQuantity = function (&$arItem, $bOffer = false) use (&$arVisual) { ?>
    <?= Html::beginTag('div', [
        ...
        <?php if ($arItem['CAN_BUY']) { ?>
            <span class="catalog-element-quantity-icon catalog-element-quantity-available">
            ...
            <?php } ?>
        <?php } else { ?>
            <span class="catalog-element-quantity-icon catalog-element-quantity-unavailable">
