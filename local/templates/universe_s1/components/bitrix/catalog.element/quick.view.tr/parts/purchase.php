...
?>
<?php $vPurchase = function (&$arItem, $bOffer = false) use (&$arResult, &$arPrice, &$APPLICATION, &$component, &$sTemplateId, &$arVisual) { ?>
    <?php if ($arResult['ACTION'] === 'buy') { ?>
            ...
            <div class="catalog-element-purchase-buttons" data-offer="<?= $bOffer ? $arItem['ID'] : 'false' ?>">
                <?= Html::beginTag('div', [
                    ...
                    'data' => [
                        ...
                        'basket-data' => $arVisual['ADDITIONAL_PRODUCTS']['SHOW'] ? Json::htmlEncode([
                            'additional' => true
                        ]) : null
                    ]
                ]) ?>
        ...
        <?php } else { ?>
            ...
            <?php } ?>
        <?php } ?>
    <?php } else if ($arResult['ACTION'] === 'order' || $arResult['ACTION'] === 'detail') { ?>
