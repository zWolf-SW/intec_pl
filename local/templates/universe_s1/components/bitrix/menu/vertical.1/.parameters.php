...
$arTemplateParameters['MAIN_VIEW'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MENU_VERTICAL_1_PARAMETERS_MAIN_VIEW'),
    'TYPE' => 'LIST',
    'VALUES' => [
        'simple' => Loc::getMessage('C_MENU_VERTICAL_1_PARAMETERS_MAIN_VIEW_SIMPLE_1'),
        'pictures' => Loc::getMessage('C_MENU_VERTICAL_1_PARAMETERS_MAIN_VIEW_PICTURES_1')
    ],
    'DEFAULT' => 'simple'
];
...
$arTemplateParameters['MAIN_LINK_SHOW'] = array(
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MENU_VERTICAL_1_MAIN_LINK_SHOW'),
    'TYPE' => 'CHECKBOX',
    'REFRESH' => 'Y',
    'DEFAULT' => 'N'
);
...
if ($arCurrentValues['MAIN_LINK_SHOW'] === 'Y') {
    $arTemplateParameters['MAIN_LINK'] = [
        'NAME' => Loc::getMessage('C_MENU_VERTICAL_1_MAIN_LINK'),
        'PARENT' => 'VISUAL',
        'TYPE' => 'STRING'
    ];

    $arTemplateParameters['MAIN_LINK_TEXT'] = [
        'NAME' => Loc::getMessage('C_MENU_VERTICAL_1_MAIN_LINK_TEXT'),
        'PARENT' => 'VISUAL',
        'TYPE' => 'STRING'
    ];
}
