    ...
    <?php $fRender = function (&$arItem, $bOffer = false) use (&$arResult, &$arVisual, &$APPLICATION, &$component, &$sTemplateId, &$arParentValues) { ?>
        <?php if ($bOffer || $arItem['ACTION'] === 'buy') { ?>
            ...
            <?php if ($arItem['CAN_BUY']) { ?>
                ...
                <?= Html::beginTag('div', [
                    'class' => 'catalog-products-viewed-item-purchase-buttons',
                    ...
                    <?= Html::beginTag('div', [
                        'class' => [
                            ...
                            'catalog-products-viewed-item-purchase-button',
                            'catalog-products-viewed-item-purchase-button-add',
                            'intec-cl-background',
                    ...
                    <?= Html::beginTag('a', [
                        'class' => [
                            'catalog-products-viewed-item-purchase-button',
                            'catalog-products-viewed-item-purchase-button-added',
                        ...
                        <?= Loc::getMessage('C_CATALOG_PRODUCTS_VIEWED_TILE_2_TEMPLATE_BASKET_ADDED') ?>
                    <?= Html::endTag('a') ?>
                <?= Html::endTag('div') ?>
            <?php } else { ?>
                ...
                <?php } else { ?>
                    <?= Html::beginTag('div', [
                        ...
                        <?= Html::tag('div', Loc::getMessage('C_CATALOG_PRODUCTS_VIEWED_TILE_2_TEMPLATE_UNAVAILABLE'), [
                            'class' => [
                                'catalog-products-viewed-item-purchase-button',
                                'intec-cl-background',
                                'intec-cl-background-light-hover'
                            ],
                            'title' => Loc::getMessage('C_CATALOG_PRODUCTS_VIEWED_TILE_2_TEMPLATE_UNAVAILABLE')
                        ]) ?>
                    <?= Html::endTag('div') ?>
                <?php } ?>
            <?php } ?>
        <?php } else if ($arItem['ACTION'] === 'detail') { ?>
            <div class="catalog-products-viewed-item-purchase-detail">
                <?= Html::beginTag($arResult['QUICK_VIEW']['DETAIL'] ? 'div' : 'a', [
                    ...
                    <?= Loc::getMessage('C_CATALOG_PRODUCTS_VIEWED_TILE_2_TEMPLATE_MORE_INFO') ?>
                <?= Html::endTag($arResult['QUICK_VIEW']['DETAIL'] ? 'div' : 'a') ?>
            </div>
        <?php } else if ($arItem['ACTION'] === 'order') { ?>
            <div class="catalog-products-viewed-item-purchase-order">
                <?= Html::beginTag('div', [
                    'class' => [
                        'catalog-products-viewed-item-purchase-button',
                        'intec-cl-background',
