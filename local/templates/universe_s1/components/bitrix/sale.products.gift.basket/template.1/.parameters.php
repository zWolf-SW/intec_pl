...
if ($iblockExists)
{
    ...
    if (!empty($showedProperties))
    {
        ...
        $arTemplateParameters['PROPERTY_CODE_MOBILE'] = array(
            'PARENT' => 'VISUAL',
            'NAME' => GetMessage('CP_SPGB_TPL_PROPERTY_CODE_MOBILE'),
            'TYPE' => 'LIST',
            'MULTIPLE' => 'Y',
            'VALUES' => $selected
        );
    ...
    $arTemplateParameters['ENLARGE_PRODUCT'] = array(
        'PARENT' => 'VISUAL',
        'NAME' => GetMessage('CP_SPGB_TPL_ENLARGE_PRODUCT'),
        'TYPE' => 'LIST',
        'MULTIPLE' => 'N',
        'ADDITIONAL_VALUES' => 'N',
        'REFRESH' => 'Y',
        'DEFAULT' => 'N',
        'VALUES' => array(
            'STRICT' => GetMessage('CP_SPGB_TPL_ENLARGE_PRODUCT_STRICT'),
            'PROP' => GetMessage('CP_SPGB_TPL_ENLARGE_PRODUCT_PROP')
        )
    );
    ...
    if (isset($arCurrentValues['ENLARGE_PRODUCT']) && $arCurrentValues['ENLARGE_PRODUCT'] === 'PROP')
    {
        $arTemplateParameters['ENLARGE_PROP'] = array(
            'PARENT' => 'VISUAL',
            'NAME' => GetMessage('CP_SPGB_TPL_ENLARGE_PROP'),
            'TYPE' => 'LIST',
            'MULTIPLE' => 'N',
            'ADDITIONAL_VALUES' => 'N',
            'REFRESH' => 'N',
    ...
    $arTemplateParameters['PRODUCT_BLOCKS_ORDER'] = array(
        ...
        'JS_DATA' => Json::encode(array(
            ...
            'quantityLimit' => GetMessage('CP_SPGB_TPL_PRODUCT_BLOCK_QUANTITY_LIMIT'),
            'quantity' => GetMessage('CP_SPGB_TPL_PRODUCT_BLOCK_QUANTITY'),
            'buttons' => GetMessage('CP_SPGB_TPL_PRODUCT_BLOCK_BUTTONS'),
            'props' => GetMessage('CP_SPGB_TPL_PRODUCT_BLOCK_PROPS'),
            'sku' => GetMessage('CP_SPGB_TPL_PRODUCT_BLOCK_SKU')
        )),
    ...
    $arTemplateParameters['SHOW_SLIDER'] = array(
        'PARENT' => 'VISUAL',
        'NAME' => GetMessage('CP_SPGB_TPL_SHOW_SLIDER'),
        'TYPE' => 'CHECKBOX',
        'MULTIPLE' => 'N',
        'REFRESH' => 'Y',
        'DEFAULT' => 'Y'
    ...
    if (isset($arCurrentValues['SHOW_SLIDER']) && $arCurrentValues['SHOW_SLIDER'] === 'Y')
    {
        $arTemplateParameters['SLIDER_INTERVAL'] = array(
            'PARENT' => 'VISUAL',
            'NAME' => GetMessage('CP_SPGB_TPL_SLIDER_INTERVAL'),
            'TYPE' => 'STRING',
            'MULTIPLE' => 'N',
            'REFRESH' => 'N',
            'DEFAULT' => '3000'
        ...
        $arTemplateParameters['SLIDER_PROGRESS'] = array(
            'PARENT' => 'VISUAL',
            'NAME' => GetMessage('CP_SPGB_TPL_SLIDER_PROGRESS'),
            'TYPE' => 'CHECKBOX',
            'MULTIPLE' => 'N',
            'REFRESH' => 'N',
            'DEFAULT' => 'N'
    ...
    $arTemplateParameters['LABEL_PROP'] = array(
        'PARENT' => 'VISUAL',
        'NAME' => GetMessage('CP_SPGB_TPL_LABEL_PROP'),
        'TYPE' => 'LIST',
        'MULTIPLE' => 'Y',
        'ADDITIONAL_VALUES' => 'N',
        'REFRESH' => 'Y',
    ...
    if (isset($arCurrentValues['LABEL_PROP']) && !empty($arCurrentValues['LABEL_PROP']))
    {
        ...
        $arTemplateParameters['LABEL_PROP_MOBILE'] = array(
            'PARENT' => 'VISUAL',
            'NAME' => GetMessage('CP_SPGB_TPL_LABEL_PROP_MOBILE'),
            'TYPE' => 'LIST',
            'MULTIPLE' => 'Y',
            'ADDITIONAL_VALUES' => 'N',
            'REFRESH' => 'N',
...
if ($boolCatalog)
{
    ...
    $arTemplateParameters['SHOW_DISCOUNT_PERCENT'] = array(
        'PARENT' => 'VISUAL',
        'NAME' => GetMessage('CP_SPGB_TPL_SHOW_DISCOUNT_PERCENT'),
        'TYPE' => 'CHECKBOX',
        'REFRESH' => 'Y',
        'DEFAULT' => 'N'
    );
    ...
    $arTemplateParameters['SHOW_OLD_PRICE'] = array(
        'PARENT' => 'VISUAL',
        'NAME' => GetMessage('CP_SPGB_TPL_SHOW_OLD_PRICE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    );
    $arTemplateParameters['SHOW_MAX_QUANTITY'] = array(
        'PARENT' => 'VISUAL',
        'NAME' => GetMessage('CP_SPGB_TPL_SHOW_MAX_QUANTITY'),
        'TYPE' => 'LIST',
        'REFRESH' => 'Y',
        'MULTIPLE' => 'N',
        'VALUES' => array(
            'N' => GetMessage('CP_SPGB_TPL_SHOW_MAX_QUANTITY_N'),
            'Y' => GetMessage('CP_SPGB_TPL_SHOW_MAX_QUANTITY_Y'),
            'M' => GetMessage('CP_SPGB_TPL_SHOW_MAX_QUANTITY_M')
        ),
        'DEFAULT' => array('N'),
    );
    ...
    if (isset($arCurrentValues['SHOW_MAX_QUANTITY']))
    {
        if ($arCurrentValues['SHOW_MAX_QUANTITY'] !== 'N')
        {
            $arTemplateParameters['MESS_SHOW_MAX_QUANTITY'] = array(
                'PARENT' => 'VISUAL',
                'NAME' => GetMessage('CP_SPGB_TPL_MESS_SHOW_MAX_QUANTITY'),
                'TYPE' => 'STRING',
                'DEFAULT' => GetMessage('CP_SPGB_TPL_MESS_SHOW_MAX_QUANTITY_DEFAULT')
            );
        }
        ...
        if ($arCurrentValues['SHOW_MAX_QUANTITY'] === 'M')
        {
            $arTemplateParameters['RELATIVE_QUANTITY_FACTOR'] = array(
                'PARENT' => 'VISUAL',
                'NAME' => GetMessage('CP_SPGB_TPL_RELATIVE_QUANTITY_FACTOR'),
                'TYPE' => 'STRING',
                'DEFAULT' => '5'
            );
            $arTemplateParameters['MESS_RELATIVE_QUANTITY_MANY'] = array(
                'PARENT' => 'VISUAL',
                'NAME' => GetMessage('CP_SPGB_TPL_MESS_RELATIVE_QUANTITY_MANY'),
                'TYPE' => 'STRING',
                'DEFAULT' => GetMessage('CP_SPGB_TPL_MESS_RELATIVE_QUANTITY_MANY_DEFAULT')
            );
            $arTemplateParameters['MESS_RELATIVE_QUANTITY_FEW'] = array(
                'PARENT' => 'VISUAL',
                'NAME' => GetMessage('CP_SPGB_TPL_MESS_RELATIVE_QUANTITY_FEW'),
                'TYPE' => 'STRING',
                'DEFAULT' => GetMessage('CP_SPGB_TPL_MESS_RELATIVE_QUANTITY_FEW_DEFAULT')
            );
        }
    }
    ...
    $arTemplateParameters['SHOW_CLOSE_POPUP'] = array(
        'PARENT' => 'VISUAL',
        'NAME' => GetMessage('CP_SPGB_TPL_SHOW_CLOSE_POPUP'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
    );
}
...
if (isset($arCurrentValues['DISPLAY_COMPARE']) && $arCurrentValues['DISPLAY_COMPARE'] === 'Y')
{
    $arTemplateParameters['MESS_BTN_COMPARE'] = array(
        'PARENT' => 'COMPARE',
        'NAME' => GetMessage('CP_SPGB_TPL_MESS_BTN_COMPARE'),
        'TYPE' => 'STRING',
        'DEFAULT' => GetMessage('CP_SPGB_TPL_MESS_BTN_COMPARE_DEFAULT')
    );
    $arTemplateParameters['COMPARE_NAME'] = array(
        'PARENT' => 'COMPARE',
        'NAME' => GetMessage('CP_SPGB_TPL_COMPARE_NAME'),
        'TYPE' => 'STRING',
...
$arTemplateParameters['MESS_NOT_AVAILABLE'] = array(
    'PARENT' => 'VISUAL',
    'NAME' => GetMessage('CP_SPGB_TPL_MESS_NOT_AVAILABLE'),
    'TYPE' => 'STRING',
    'DEFAULT' => GetMessage('CP_SPGB_TPL_MESS_NOT_AVAILABLE_DEFAULT')
);
