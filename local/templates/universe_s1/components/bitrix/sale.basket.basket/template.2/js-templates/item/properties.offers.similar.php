...
<div class="basket-alert-wrap">
    <?= Html::beginTag('div', [
        ...
        {{#USE_FILTER}}
            <div class="basket-alert-interactive intec-cl-text" data-entity="basket-item-show-similar-link">
                <span class="basket-alert-interactive-text">
                    <?= Loc::getMessage('C_BASKET_DEFAULT_2_TEMPLATE_ITEM_OFFERS_SIMILAR_PART_1') ?>
                </span>
            </div>
            <span class="basket-alert-text">
                <?= Loc::getMessage('C_BASKET_DEFAULT_2_TEMPLATE_ITEM_OFFERS_SIMILAR_PART_2').' {{SIMILAR_ITEMS_QUANTITY}} {{MEASURE_TEXT}}.' ?>
            </span>
        {{/USE_FILTER}}
        <div class="basket-alert-interactive intec-cl-text" data-entity="basket-item-merge-sku-link">
            ...
            <span class="basket-alert-interactive-text">
                <?= Loc::getMessage('C_BASKET_DEFAULT_2_TEMPLATE_ITEM_OFFERS_SIMILAR_PART_3') ?>
            </span>
        </div>
    <?= Html::endTag('div') ?>
</div>
