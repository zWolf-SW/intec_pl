    ...
    template.load(function (data) {
        ...
        clear.on('click', function () {
            if (confirmRemoveProductUse) {
                confirmRemoveProductTitle.html('<?= Loc::getMessage('C_BASKET_DEFAULT_2_TEMPLATE_CONFIRM_REMOVE_PRODUCTS_TITLE') ?>');
                confirmRemoveProductText.html('<?= Loc::getMessage('C_BASKET_DEFAULT_2_TEMPLATE_CONFIRM_REMOVE_PRODUCTS_TEXT') ?>');
        ...
        confirmRemoveProductCancel.each(function () {
            $(this).on('click', function () {
                ...
                confirmRemoveProductTitle.html('<?= Loc::getMessage('C_BASKET_DEFAULT_2_TEMPLATE_CONFIRM_REMOVE_PRODUCT_TITLE') ?>');
                confirmRemoveProductText.html('<?= Loc::getMessage('C_BASKET_DEFAULT_2_TEMPLATE_CONFIRM_REMOVE_PRODUCT_TEXT') ?>');
            });
        });
