...
$sComponent = 'bitrix:catalog.store.list';
...
$arTemplateParameters[$sPrefix.'TEMPLATE'] = [
    ...
    'NAME' => Loc::getMessage('C_NEWS_STORES_1_LIST_STORES_TEMPLATE'),
    'TYPE' => 'LIST',
    'VALUES' => $arTemplates,
    'REFRESH' => 'Y'
];
...
if (!empty($sTemplate)) {
    $arTemplateParameters = ArrayHelper::merge($arTemplateParameters, Component::getParameters(
        ...
        function ($key, &$arParameter) {
            ...
            $arParameter['NAME'] = Loc::getMessage('C_NEWS_STORES_1_LIST_STORES') . '. ' . $arParameter['NAME'];
