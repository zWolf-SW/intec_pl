...
$arProps = ArrayHelper::merge([
    ...
    'DESCRIPTION_FULL' => $arParams['DESCRIPTION_DETAIL_FULL'],
    ...
    'PROPERTY_ORDER_PROJECT' => $arParams['PROPERTY_ORDER_PROJECT'],
    'PROPERTY_SOLUTION_FULL' => $arParams['PROPERTY_SOLUTION_FULL'],
    ...
    'SOLUTION_IMAGE_BORDER' => $arParams['SOLUTION_IMAGE_BORDER'],
