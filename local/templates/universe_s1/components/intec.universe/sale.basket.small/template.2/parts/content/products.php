                ...
                <div class="intec-grid intec-grid-nowrap intec-grid-a-v-stretch">
                    ...
                    <div class="intec-grid-item-auto">
                        <div class="sale-basket-small-product-quantity">
                            <?php if (!$arItem['DELAY']) { ?>
                                <div class="sale-basket-small-product-quantity-wrapper"
                                     data-role="counter"
                                     data-settings="<?= Html::encode(Json::htmlEncode([
                                         'bounds' => array(
                                             'minimum' => $arItem['MEASURE']['RATIO'],
                                             'maximum' => !$arItem['QUANTITY']['TRACE'] || $arItem['QUANTITY']['UNLIMITED'] ? false : $arItem['QUANTITY']['AVAILABLE']
                                         ),
                                    ...
                                    <input type="text"
                                           data-type="input"
                                           class="intec-ui intec-ui-control-input intec-ui-view-1 sale-basket-small-product-quantity-value"
                                           value="<?= $arItem['QUANTITY']['VALUE'] ?>" />
