...
if ($bTemplateDescription) {
    ...
    $sDescriptionLineHeight = ArrayHelper::getValue($arParams, 'DESCRIPTION_LINE_HEIGHT');
    $arStyleDescription = array(
        ...
        'style' => array(
            ...
            'line-height' => !empty($sDescriptionLineHeight) ? $sDescriptionLineHeight.'px' : 'inherit'
        )
    );
}
...
foreach ($arResult['ITEMS'] as $arItem) {
    ...
    $bUseLink = ArrayHelper::getValue($arItem, ['PROPERTIES', $arParams['PROPERTY_USE_LINK'], 'VALUE']);
