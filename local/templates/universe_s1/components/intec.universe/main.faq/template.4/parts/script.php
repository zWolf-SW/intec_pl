...
<script type="text/javascript">
    template.load(function (data) {
        ...
        var button = $('[data-role="container.toggle"]', root);
        ...
        var messages = {
            'show': '<?= Loc::getMessage('C_MAIN_FAQ_TEMPLATE_4_TEMPLATE_BUTTON_SHOW') ?>',
            'hide': '<?= Loc::getMessage('C_MAIN_FAQ_TEMPLATE_4_TEMPLATE_BUTTON_HIDE') ?>'
        };
        ...
        'name': '[Component] intec.universe:main.faq (template.4)',
