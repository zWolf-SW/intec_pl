...
?>
<div class="widget c-vk c-vk-template-1 fragment" id="<?= $sTemplateId ?>">
                    ...
                    <div class="fragment-title intec-grid intec-grid-a-v-baseline intec-grid-a-v-768-center">
                        ...
                        <?php if ($arVisual['URL']['LIST']['SHOW']) { ?>
                            ...
                            if (empty($arVisual['URL']['LIST']['TEXT']))
                                $arVisual['URL']['LIST']['TEXT'] = Loc::getMessage('C_MAIN_VK_TEMPLATE_1_TEMPLATE_URL_LIST_TEXT_DEFAULT');
                        ...
                        ?>
                            <?= Html::beginTag('div', [
                                ...
                                <div class="fragment-item-content">
                                    ...
                                    <div class="fragment-item-overlay"></div>
                                    <div class="fragment-item-info intec-grid intec-grid-o-vertical ind-p-v-24 ind-p-l-24 ind-p-r-16">
                                        <?= Html::beginTag($sItemTag, [
                                            'class' => Html::cssClassFromArray([
