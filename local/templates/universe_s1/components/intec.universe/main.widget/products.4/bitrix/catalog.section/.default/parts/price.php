...
?>
<?php return function (&$arItem) use (&$arVisual, &$arSvg) { ?>
    ...
    <?= Html::beginTag('div', [
        ...
        <?= Html::beginTag('div', [
            ...
            <div class="widget-item-price-limit intec-grid-item-auto">
                <div class="widget-item-price-discount intec-grid intec-grid-a-v-center">
                    <?php if (!empty($arItem['ITEM_PRICES']) && count($arItem['ITEM_PRICES']) > 1) { ?>
                    <?php
