...
if ($arCurrentValues['SLIDER_USE'] !== 'Y') {
    $arTemplateParameters['ALIGNMENT'] = [
        ...
        'TYPE' => 'LIST',
        'VALUES' => [
            'start' => Loc::getMessage('C_MAIN_PROJECTS_TEMPLATE_1_POSITION_LEFT'),
            'center' => Loc::getMessage('C_MAIN_PROJECTS_TEMPLATE_1_POSITION_CENTER'),
            'end' => Loc::getMessage('C_MAIN_PROJECTS_TEMPLATE_1_POSITION_RIGHT')
        ],
        'DEFAULT' => 'center'
    ];
}
...
$arTemplateParameters['BUTTON_ALL_SHOW'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MAIN_PROJECTS_TEMPLATE_1_BUTTON_ALL_SHOW'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['BUTTON_ALL_SHOW'] == 'Y') {
    $arTemplateParameters['BUTTON_ALL_TEXT'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_PROJECTS_TEMPLATE_1_BUTTON_ALL_TEXT'),
        'TYPE' => 'STRING',
        'DEFAULT' => Loc::getMessage('C_MAIN_PROJECTS_TEMPLATE_1_BUTTON_ALL_TEXT_DEFAULT')
    ];
}