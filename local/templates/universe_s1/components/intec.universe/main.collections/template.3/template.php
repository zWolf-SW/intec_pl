...
?>
<div class="widget c-collections c-collections-template-3" id="<?= $sTemplateId ?>">
                                    ...
                                    <div class="intec-grid-item-auto">
                                        <?= Html::beginTag('a', [
                                            ...
                                            <span class="widget-all-desktop intec-cl-text-hover">
                                                ...
                                                <?php } else { ?>
                                                    <?= Loc::getMessage('C_MAIN_COLLECTIONS_TEMPLATE_3_TEMPLATE_LINK_ALL_TEXT_DEFAULT') ?>
                                                <?php } ?>
                                            </span>
                        ...
                        <?= Html::beginTag('div', [
                            ...
                            <?= Html::beginTag($arVisual['LINK']['USE'] ? 'a' : 'div', [
                                ...
                                <?= Html::tag('div', '', [
                                    ...
                                    'style' => [
                                        'background' => !$arVisual['LAZYLOAD']['USE'] ? 'url(\''.$sPicture.'\')' : null
                                    ]
                                ]) ?>
