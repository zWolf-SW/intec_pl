...
?>
<div class="widget c-shares c-shares-template-5" id="<?= $sTemplateId ?>">
                            ...
                            <div class="intec-grid-item-auto">
                                <?= Html::beginTag('a', [
                                    ...
                                    <span class="widget-all-desktop intec-cl-text-hover">
                                        ...
                                        <?php } else { ?>
                                            <?= Loc::getMessage('C_SHARES_TEMP5_TEMPLATE_LINK_ALL_BLOCK_TEXT_DEFAULT') ?>
                                        <?php } ?>
                                    </span>
                                    ...
                                    <?php if (!defined('EDITOR')) { ?>
                                        <script type="text/javascript">
                                            template.load(function (data) {
                                                ...
                                                'name': '[Component] intec.universe:main.shares (template.5) > Timer',
