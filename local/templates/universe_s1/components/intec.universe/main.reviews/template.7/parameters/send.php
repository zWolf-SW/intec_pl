...
$arTemplateParameters['SEND_USE'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_MAIN_REVIEW_TEMPLATE_7_SEND_USE'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
];
...
$arTemplateParameters['SEND_TEMPLATE'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MAIN_REVIEW_TEMPLATE_7_SEND_TEMPLATE'),
    'TYPE' => 'LIST',
    'VALUES' => $arTemplates,
    'ADDITIONAL_VALUES' => 'Y',
    'REFRESH' => 'Y'
...
$arTemplateParameters['SEND_TITLE'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MAIN_REVIEW_TEMPLATE_7_SEND_TITLE'),
    'TYPE' => 'STRING',
    'DEFAULT' => Loc::getMessage('C_MAIN_REVIEW_TEMPLATE_7_SEND_TITLE_DEFAULT')
];
...
$arTemplateParameters = ArrayHelper::merge($arTemplateParameters, Component::getParameters(
    ...
    function ($key, &$parameter) use (&$arSendExcluded) {
        ...
        $parameter['NAME'] = Loc::getMessage('C_MAIN_REVIEW_TEMPLATE_7_SEND').' '.$parameter['NAME'];
