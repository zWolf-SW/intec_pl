...
$arReturn['LOGOTYPE_WIDTH'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_HEADER_TEMP1_DESKTOP_TEMP8_LOGOTYPE_WIDTH'),
    'TYPE' => 'STRING',
    'DEFAULT' => '130'
];
$arReturn['MENU_INFO_SHOW'] = [
    'NAME' => Loc::getMessage('C_HEADER_TEMP1_DESKTOP_TEMP8_MENU_INFO_SHOW'),
    'PARENT' => 'VISUAL',
    'TYPE' => 'CHECKBOX',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['MENU_INFO_SHOW'] == 'Y') {
    $arReturn['MENU_INFO_ROOT'] = [
        'NAME' => Loc::getMessage('C_HEADER_TEMP1_DESKTOP_TEMP8_MENU_INFO_ROOT'),
        'PARENT' => 'BASE',
        'TYPE' => 'LIST',
        'DEFAULT ' => 'left',
        'VALUES' => $arMenuTypes,
    ...
    $arReturn['MENU_INFO_CHILD'] = [
        'NAME' => Loc::getMessage('C_HEADER_TEMP1_DESKTOP_TEMP8_MENU_INFO_CHILD'),
        'PARENT' => 'BASE',
        'TYPE' => 'LIST',
        'DEFAULT ' => 'left',
        'VALUES' => $arMenuTypes,
    ...
    $arReturn['MENU_INFO_LEVEL'] = [
        'NAME' => Loc::getMessage('C_HEADER_TEMP1_DESKTOP_TEMP8_MENU_INFO_LEVEL'),
        'PARENT' => 'BASE',
        'TYPE' => 'LIST',
        'DEFAULT ' => 1,
        'VALUES' => [
