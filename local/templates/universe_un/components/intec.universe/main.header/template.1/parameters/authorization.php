...
if ($arCurrentValues['AUTHORIZATION_SHOW'] === 'Y' || $arCurrentValues['AUTHORIZATION_SHOW_FIXED'] === 'Y' || $arCurrentValues['AUTHORIZATION_SHOW_MOBILE'] === 'Y') {
    $arTemplateParameters['AUTHORIZATION_FORM_USE_REGISTRATION'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_HEADER_TEMP1_AUTHORIZATION_FORM_USE_REGISTRATION'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
}
