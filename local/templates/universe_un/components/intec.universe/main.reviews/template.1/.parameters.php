    ...
    if (!empty($arCurrentValues['VIDEO_IBLOCK_ID'])) {
        ...
        if (!empty($arCurrentValues['PROPERTY_VIDEO'])) {
            ...
            $arTemplateParameters['VIDEO_IBLOCK_PROPERTY_LINK'] = [
                ...
                'TYPE' => 'LIST',
                'VALUES' => $arVideoProperties->asArray(function ($key, $value) {
                    return [
                        'key' => $value['CODE'],
...
$arTemplateParameters['PREVIEW_TRUNCATE_USE'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MAIN_REVIEW_TEMPLATE_1_PREVIEW_TRUNCATE_USE'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['PREVIEW_TRUNCATE_USE'] === 'Y') {
    $arTemplateParameters['PREVIEW_TRUNCATE_WORDS'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_REVIEW_TEMPLATE_1_PREVIEW_TRUNCATE_WORDS'),
        'TYPE' => 'STRING',
        'DEFAULT' => 40
    ];
}
