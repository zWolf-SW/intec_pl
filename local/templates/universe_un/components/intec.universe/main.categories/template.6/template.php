                        ...
                        <?= Html::beginTag('div', [
                            ...
                            <?= Html::beginTag($sTag, [
                                ...
                                <?php if ($arVisual['STICKER']['SHOW'] && !empty($arData['STICKER'])) { ?>
                                    <div class="intec-grid intec-grid-wrap widget-item-sticker-wrap" data-horizontal="<?= $arVisual['STICKER']['HORIZONTAL'] ?>" data-vertical="<?= $arVisual['STICKER']['VERTICAL'] ?>">
                                        <div class="intec-grid-item-auto widget-item-sticker">
                                            <?= $arData['STICKER'] ?>
                                        </div>
                                    </div>
                                <?php } ?>
                                <div class="intec-grid intec-grid-wrap widget-item-name-wrap" data-horizontal="<?= $arVisual['NAME']['HORIZONTAL'] ?>" data-vertical="<?= $arVisual['NAME']['VERTICAL'] ?>">
