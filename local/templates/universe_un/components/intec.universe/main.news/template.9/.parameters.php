...
$arTemplateParameters['COLUMNS'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MAIN_NEWS_TEMPLATE_7_COLUMNS'),
    'TYPE' => 'LIST',
    'VALUES' => [
        2 => '2',
        3 => '3',
...
if ($arCurrentValues['COLUMNS'] !== '2') {
    $arTemplateParameters['LIST_VIEW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_NEWS_TEMPLATE_7_LIST_VIEW'),
        'TYPE' => 'LIST',
        'VALUES' => [
            'default' => Loc::getMessage('C_MAIN_NEWS_TEMPLATE_7_LIST_VIEW_DEFAULT'),
            'big' => Loc::getMessage('C_MAIN_NEWS_TEMPLATE_7_LIST_VIEW_BIG')
        ],
        'DEFAULT' => 'default'
    ];
}
