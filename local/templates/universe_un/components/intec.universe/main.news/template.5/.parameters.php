...
if ($arCurrentValues['HEADER_BLOCK_SHOW'] === 'Y' || $arCurrentValues['DESCRIPTION_BLOCK_SHOW'] === 'Y') {
    $arTemplateParameters['HEADER_WIDE'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MAIN_NEWS_TEMPLATE_5_HEADER_WIDE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
}
