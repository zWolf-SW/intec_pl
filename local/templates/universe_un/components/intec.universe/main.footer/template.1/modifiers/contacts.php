...
$arResult['PHONE']['SECOND'] = [
    'SHOW' => $arParams['SECOND_PHONE_SHOW'] === 'Y',
    'ID' => null,
    'VALUE' => [
        'DISPLAY' => null,
        'LINK' => null
...
if ($arResult['PHONE']['SECOND']['SHOW']) {
    if (!empty($arParams['SECOND_PHONE_ELEMENT']) && !empty($arResult['CONTACTS']['ITEMS'][$arParams['SECOND_PHONE_ELEMENT']])) {
        $arElement = $arResult['CONTACTS']['ITEMS'][$arParams['SECOND_PHONE_ELEMENT']];

        $arResult['PHONE']['SECOND']['ID'] = $arElement['ID'];
        $arResult['PHONE']['SECOND']['VALUE']['DISPLAY'] = $arElement['DATA']['PHONE']['DISPLAY'];
        $arResult['PHONE']['SECOND']['VALUE']['LINK'] = $arElement['DATA']['PHONE']['LINK'];
