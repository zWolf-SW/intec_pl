...
$arParams = ArrayHelper::merge([
    ...
    'BANNER_PRODUCT_USE' => 'N',
    'PROPERTY_BANNER_PRODUCT' => null,
    'HEIGHT' => 600,
    'HEADER_SHOW' => 'N',
    'HEADER_VIEW' => 1,
    'DESCRIPTION_SHOW' => 'N',
...
$arVisual = [
    ...
    'MOBILE' => [
        ...
        'SEPARATED' => [
            'USE' => $arParams['MOBILE_BLOCK_SEPARATED'] === 'Y'
        ]
    ],
    'PRODUCT' => [
        'USE' => $arParams['PRODUCT_USE'] === 'Y' && !empty($arParams['PROPERTY_PRODUCT'])
    ],
    'VIDEO' => [
    ...
    'BLOCKS' => [
        ...
        'COLUMNS' => [
            'MOBILE' => ArrayHelper::fromRange([1,2], $arParams['BLOCKS_COLUMNS_MOBILE'])
        ]
    ],
...
foreach ($arResult['ITEMS'] as &$arItem) {
    ...
    if (!empty($arParams['PROPERTY_PICTURE'])) {
        ...
        if (!empty($arProperty)) {
            ...
            if (!$arPictures->has($arProperty)) {
                ...
                $arItem['DATA']['PICTURE']['SHOW'] = $arVisual['PICTURE']['SHOW'];
            }
        }
    }
    ...
    if (!empty($arParams['PROPERTY_MOBILE_PICTURE'])) {
        ...
        if (!empty($arProperty)) {
            ...
            if (!empty($arProperty)) {
                ...
                $arItem['DATA']['MOBILE']['PICTURE']['USE'] = $arVisual['MOBILE']['PICTURE']['USE'];
            }
        }
    }
    ...
    if ($arItem['DATA']['PRODUCT']['USE']) {
        $arProperty = ArrayHelper::getValue($arItem, [
            'PROPERTIES',
            $arParams['PROPERTY_PRODUCT'],
            'VALUE'
        ]);
        ...
        if (!empty($arProperty)) {
            ...
            if (!empty($arProperty))
                $arItem['DATA']['PRODUCT']['VALUE'] = $arProperty;
        } else {
            $arItem['DATA']['PRODUCT']['USE'] = false;
        }
    }
}
