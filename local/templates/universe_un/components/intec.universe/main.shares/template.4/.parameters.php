...
if ($arCurrentValues['SEE_ALL_SHOW'] == 'Y') {
    $arTemplateParameters['SEE_ALL_PLACE'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_SHARES_TEMPLATE_4_SEE_ALL_PLACE'),
        'TYPE' => 'LIST',
        'VALUES' => [
            'top' => Loc::getMessage('C_SHARES_TEMPLATE_4_POSITION_TOP'),
            'bottom' => Loc::getMessage('C_SHARES_TEMPLATE_4_POSITION_BOTTOM')
        ],
        'DEFAULT' => 'bottom'
    ];
