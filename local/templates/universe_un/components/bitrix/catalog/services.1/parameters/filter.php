...
if ($arCurrentValues['USE_FILTER'] === 'Y') {
    ...
    $arTemplateParameters[$sPrefix.'AJAX'] = [
        ...
        'NAME' => Loc::getMessage('C_CATALOG_SERVICES_1_'.$sPrefix.'AJAX'),
        'TYPE' => 'CHECKBOX'
    ];

    $arTemplateParameters[$sPrefix.'TYPE'] = [
        'PARENT' => 'FILTER_SETTINGS',
        'NAME' => Loc::getMessage('C_CATALOG_SERVICES_1_'.$sPrefix.'TYPE'),
        'TYPE' => 'LIST',
        'VALUES' => [
            'horizontal' => Loc::getMessage('C_CATALOG_SERVICES_1_'.$sPrefix.'TYPE_HORIZONTAL'),
            'vertical' => Loc::getMessage('C_CATALOG_SERVICES_1_'.$sPrefix.'TYPE_VERTICAL')
        ],
        'REFRESH' => 'Y'
    ];
    ...
    if (!empty($sTemplate)) {
        $arTemplateParameters = ArrayHelper::merge($arTemplateParameters, Component::getParameters(
            ...
            function ($sKey, &$arParameter) {
                ...
                $arParameter['NAME'] = Loc::getMessage('C_CATALOG_SERVICES_1_FILTER').'. '.$arParameter['NAME'];
