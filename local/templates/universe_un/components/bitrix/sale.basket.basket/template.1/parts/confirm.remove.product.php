...
<?= Html::beginTag('div', [
    ...
    <div class="basket-confirm-remove-product-wrapper">
        ...
        <div class="basket-confirm-remove-product-title" data-role="confirm.remove.product.title">
            <?= Loc::getMessage('C_BASKET_DEFAULT_1_TEMPLATE_CONFIRM_REMOVE_PRODUCT_TITLE') ?>
        </div>
        <div class="basket-confirm-remove-product-text" data-role="confirm.remove.product.text">
            <?= Loc::getMessage('C_BASKET_DEFAULT_1_TEMPLATE_CONFIRM_REMOVE_PRODUCT_TEXT') ?>
        </div>
        <div class="intec-grid intec-grid-wrap intec-grid-a-v-center intec-grid-i-8">
            <div class="intec-grid-item-auto">
                <?= Html::tag('div', Loc::getMessage('C_BASKET_DEFAULT_1_TEMPLATE_CONFIRM_REMOVE_PRODUCT_BUTTON_YES'), [
                    'class' => [
            ...
            <div class="intec-grid-item-auto">
                <?= Html::tag('div', Loc::getMessage('C_BASKET_DEFAULT_1_TEMPLATE_CONFIRM_REMOVE_PRODUCT_BUTTON_NO'), [
                    'class' => [
                        'basket-confirm-remove-product-button',
                        'intec-ui' => [
                            '',
                ...
                <?= Html::beginTag('div', [
                    ...
                    <div class="intec-grid-item-auto">
                        <div data-role="confirm.remove.product.delay.message">
                            <?= Loc::getMessage('C_BASKET_DEFAULT_1_TEMPLATE_CONFIRM_REMOVE_PRODUCT_BUTTON_DELAY') ?>
                        </div>
                    </div>
                <?= Html::endTag('div') ?>
            </div>
