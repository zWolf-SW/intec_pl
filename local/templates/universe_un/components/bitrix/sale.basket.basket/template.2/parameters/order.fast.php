...
$arTemplateParameters['ORDER_FAST_TEMPLATE'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_BASKET_TEMPLATE_DEFAULT_2_ORDER_FAST_TEMPLATE'),
    'TYPE' => 'LIST',
    'VALUES' => $arTemplates,
    'ADDITIONAL_VALUES' => 'Y',
    'REFRESH' => 'Y'
...
if (!empty($sTemplate)) {
    $arTemplateParameters = ArrayHelper::merge($arTemplateParameters, Component::getParameters(
        ...
        function ($key, &$arParameter) {
            $arParameter['NAME'] = Loc::getMessage('C_BASKET_TEMPLATE_DEFAULT_2_ORDER_FAST').'. '.$arParameter['NAME'];
