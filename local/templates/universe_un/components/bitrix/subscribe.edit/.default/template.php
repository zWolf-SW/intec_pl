                            ...
                            <? if ($bSubscribed && !$bConfirmed) { ?>
                                <div class="subscribe-edit-confirm">
                                    ...
                                    <div class="intec-grid intec-grid-wrap intec-grid-i-5">
                                        ...
                                        <div class="intec-grid-item-auto">
                                            <input class="subscribe-edit-confirm-button intec-ui intec-ui-control-button intec-ui-scheme-current" type="submit" name="confirm" value="<?= Loc::getMessage('SE_DEFAULT_CONFIRM_BUTTON') ?>" />
                                        </div>
                                    </div>
                                </div>
                            <? } ?>
