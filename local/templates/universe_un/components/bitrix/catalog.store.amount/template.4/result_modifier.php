...
$arVisual = [
    ...
    'DESCRIPTION_BLOCK' => [
        ...
        'VALUE' => !empty($arParams['STORE_BLOCK_DESCRIPTION_TEXT']) ? Html::encode($arParams['STORE_BLOCK_DESCRIPTION_TEXT']) : Loc::getMessage('C_CATALOG_STORE_AMOUNT_TEMPLATE_4_TEMPLATE_INFO')
    ]
];
