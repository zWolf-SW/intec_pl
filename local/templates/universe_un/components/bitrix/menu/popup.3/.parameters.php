...
if ($arCurrentValues['SOCIAL_SHOW'] == 'Y') {
    ...
    $arTemplateParameters['SOCIAL_YOUTUBE_LINK'] = [
        'PARENT' => 'DATA_SOURCE',
        'TYPE' => 'STRING',
        'NAME' => Loc::getMessage('C_MENU_POPUP_3_SOCIAL_YOUTUBE_LINK'),
    ...
    $arTemplateParameters['SOCIAL_ODNOKLASSNIKI_LINK'] = [
        'PARENT' => 'DATA_SOURCE',
        'TYPE' => 'STRING',
        'NAME' => Loc::getMessage('C_MENU_POPUP_3_SOCIAL_ODNOKLASSNIKI_LINK'),
        'DEFAULT' => 'https://ok.ru'
    ];
    $arTemplateParameters['SOCIAL_VIBER_LINK'] = [
        'PARENT' => 'DATA_SOURCE',
        'TYPE' => 'STRING',
        'NAME' => Loc::getMessage('C_MENU_POPUP_3_SOCIAL_VIBER_LINK'),
        'DEFAULT' => 'https://viber.com'
    ];
    $arTemplateParameters['SOCIAL_WHATSAPP_LINK'] = [
        'PARENT' => 'DATA_SOURCE',
        'TYPE' => 'STRING',
        'NAME' => Loc::getMessage('C_MENU_POPUP_3_SOCIAL_WHATSAPP_LINK'),
        'DEFAULT' => 'https://whatsapp.com'
    ];
    $arTemplateParameters['SOCIAL_YANDEX_DZEN_LINK'] = [
        'PARENT' => 'DATA_SOURCE',
        'TYPE' => 'STRING',
        'NAME' => Loc::getMessage('C_MENU_POPUP_3_SOCIAL_YANDEX_DZEN_LINK'),
        'DEFAULT' => 'https://zen.yandex.ru'
    ];
    $arTemplateParameters['SOCIAL_MAIL_RU_LINK'] = [
        'PARENT' => 'DATA_SOURCE',
        'TYPE' => 'STRING',
        'NAME' => Loc::getMessage('C_MENU_POPUP_3_SOCIAL_MAIL_RU_LINK'),
        'DEFAULT' => 'https://mail.ru'
    ];
    $arTemplateParameters['SOCIAL_TELEGRAM_LINK'] = [
        'PARENT' => 'DATA_SOURCE',
        'TYPE' => 'STRING',
        'NAME' => Loc::getMessage('C_MENU_POPUP_3_SOCIAL_TELEGRAM_LINK'),
        'DEFAULT' => 'https://web.telegram.org'
    ];
    $arTemplateParameters['SOCIAL_PINTEREST_LINK'] = [
        'PARENT' => 'DATA_SOURCE',
        'TYPE' => 'STRING',
        'NAME' => Loc::getMessage('C_MENU_POPUP_3_SOCIAL_PINTEREST_LINK'),
        'DEFAULT' => 'https://pinterest.com'
    ];
    $arTemplateParameters['SOCIAL_TIKTOK_LINK'] = [
        'PARENT' => 'DATA_SOURCE',
        'TYPE' => 'STRING',
        'NAME' => Loc::getMessage('C_MENU_POPUP_3_SOCIAL_TIKTOK_LINK'),
        'DEFAULT' => 'https://toktok.com'
    ];
    $arTemplateParameters['SOCIAL_SNAPCHAT_LINK'] = [
        'PARENT' => 'DATA_SOURCE',
        'TYPE' => 'STRING',
        'NAME' => Loc::getMessage('C_MENU_POPUP_3_SOCIAL_SNAPCHAT_LINK'),
        'DEFAULT' => 'https://snapchat.com'
    ];
    $arTemplateParameters['SOCIAL_LINKEDIN_LINK'] = [
        'PARENT' => 'DATA_SOURCE',
        'TYPE' => 'STRING',
        'NAME' => Loc::getMessage('C_MENU_POPUP_3_SOCIAL_LINKEDIN_LINK'),
