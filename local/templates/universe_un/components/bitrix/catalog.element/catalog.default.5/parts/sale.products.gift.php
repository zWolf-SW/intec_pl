...
if($arVisual['GIFTS']['COLUMNS'] === 'auto') {
    $iColumns = 1;
    ...
    $arVisual['GIFTS']['COLUMNS'] = $iColumns;
}
?>
    ...
    array(
        ...
        'DEFERRED_PRODUCT_ROW_VARIANTS' => \Bitrix\Main\Web\Json::encode(
            SaleProductsGiftComponent::predictRowVariants(
                (int)$arVisual['GIFTS']['QUANTITY'],
                (int)$arVisual['GIFTS']['QUANTITY']
            )
        ),

        'DEFERRED_PRODUCT_ROW_VARIANTS' => (int)$arVisual['GIFTS']['QUANTITY'],
        'DEFERRED_PAGE_ELEMENT_COUNT' => (int)$arVisual['GIFTS']['QUANTITY'],
