...
$arTemplateParameters['FORM_ID'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_BANNER_PRODUCT_1_FORM_ID'),
    'TYPE' => 'LIST',
...
if (!empty($arForm)) {
    ...
    $arTemplateParameters['FORM_PROPERTY_PRODUCT'] = [
        'PARENT' => 'BASE',
        'TYPE' => 'LIST',
        'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_BANNER_PRODUCT_1_FORM_PROPERTY_PRODUCT'),
        'VALUES' => $arFormFields,
        'ADDITIONAL_VALUES' => 'Y'
    ];
...
$arTemplateParameters['FORM_TEMPLATE'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_CATALOG_ELEMENT_BANNER_PRODUCT_1_FORM_TEMPLATE'),
    'TYPE' => 'LIST',
