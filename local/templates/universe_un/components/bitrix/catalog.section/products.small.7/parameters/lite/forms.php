...
$arTemplateParameters['FORM_ID'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_7_FORM_ID'),
    'TYPE' => 'LIST',
...
if (!empty($arCurrentValues['FORM_ID'])) {
    $arTemplateParameters['FORM_PROPERTY_PRODUCT'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_7_FORM_PROPERTY_PRODUCT'),
        'TYPE' => 'LIST',
    ...
    $arTemplateParameters['FORM_TEMPLATE'] = [
        'PARENT' => 'BASE',
        'NAME' => Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_7_FORM_TEMPLATE'),
        'TYPE' => 'LIST',
