...
$arVisual = [
    ...
    'BUTTONS' => [
        ...
        'MORE' => [
            'SHOW' => $arParams['SHOW_ALL_ITEMS'] === 'N',
...
if (empty($arVisual['BUTTONS']['BASKET']['TEXT']))
    $arVisual['BUTTONS']['BASKET']['TEXT'] = Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_8_BUTTON_ADD');

if (empty($arVisual['BUTTONS']['ORDER']['TEXT']))
    $arVisual['BUTTONS']['ORDER']['TEXT'] = Loc::getMessage('C_CATALOG_SECTION_PRODUCTS_SMALL_8_BUTTON_ORDER');
...
foreach ($arResult['ITEMS'] as $iKey => &$arItem) {
    ...
    $arItem['MARKS'] = [
        ...
        'share' => ArrayHelper::getValue($arItem, ['PROPERTIES', $arParams['PROPERTY_MARKS_SHARE'], 'VALUE']) != null
    ];
