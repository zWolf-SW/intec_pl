...
$arTemplateParameters['ACTION'] = [
    ...
    'VALUES' => [
        ...
        'request' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_ACTION_REQUEST')
    ],
    'DEFAULT' => 'buy',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['COUNTER_SHOW'] === 'Y') {
    ...
    $arTemplateParameters['COUNTER_MESSAGE_MAX_SHOW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_COUNTER_MESSAGE_MAX_SHOW'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'Y'
    ];
}
...
if ($arCurrentValues['OFFERS_USE'] === 'Y' && $bOffersIblockExist) {
    $arTemplateParameters['OFFERS_PROPERTY_PICTURE_DIRECTORY'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_OFFERS_PROPERTY_PICTURE_DIRECTORY'),
        'TYPE' => 'LIST',
    ...
    $arTemplateParameters['OFFERS_VARIABLE_SELECT'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_OFFERS_VARIABLE_SELECT'),
        'TYPE' => 'STRING'
    ];
}
...
if (!empty($arIBlock)) {
    ...
    $arTemplateParameters['PROPERTY_REQUEST_USE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_PROPERTY_REQUEST_USE'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertyCheckbox,
        'ADDITIONAL_VALUES' => 'Y'
    ];
    ...
    $arTemplateParameters['PROPERTY_MARKS_SHARE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_PROPERTY_MARKS_SHARE'),
        'TYPE' => 'LIST',
        'VALUES' => $arPropertyCheckbox,
        'ADDITIONAL_VALUES' => 'Y'
    ];
...
if ($arCurrentValues['SECTION_TIMER_SHOW'] === 'Y' || $arCurrentValues['QUICK_VIEW_TIMER_SHOW'] === 'Y') {
    if ($arCurrentValues['SECTION_TIMER_SHOW'] === 'Y' ) {
...
$arTemplateParameters['PURCHASE_REQUEST_BUTTON_TEXT'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_PURCHASE_REQUEST_BUTTON_TEXT'),
    'TYPE' => 'STRING',
    'DEFAULT' => Loc::getMessage('C_CATALOG_SECTION_CATALOG_LIST_2_PURCHASE_REQUEST_BUTTON_TEXT_DEFAULT')
];