        ...
        <form name="support_edit" method="post" action="<?=$arResult["REAL_FILE_PATH"]?>" enctype="multipart/form-data">
            ...
            <?php if (empty($arResult["TICKET"]['ID'])) { ?>
                <div class="support-ticket-edit-form-field">
                    ...
                    <input class="support-ticket-edit-form-field-inputtext" type="text" name="TITLE" value="<?= Html::encode($_REQUEST["TITLE"]) ?>" size="48" maxlength="255" />
                </div>
            <?php } ?>
            <div class="support-ticket-edit-form-field">
                ...
                <textarea class="support-ticket-edit-form-field-textarea" name="MESSAGE" id="MESSAGE" rows="20" cols="5" wrap="virtual"><?= Html::encode($_REQUEST["MESSAGE"]) ?></textarea>
            </div>
            <div class="support-ticket-edit-form-field">
                <div class="support-ticket-edit-form-field-title">
            ...
            <?php if ($arParams['SHOW_COUPON_FIELD'] == 'Y' && $arParams['ID'] <= 0) { ?>
                <div class="support-ticket-edit-form-field">
                    ...
                    <input class="support-ticket-edit-form-field-inputtext" type="text" name="COUPON" value="<?= Html::encode($_REQUEST["COUPON"]) ?>" size="48" maxlength="255" />
                </div>
            <?php } ?>
