...
<script>
    $(document).ready(function () {
        ...
        var closeButton = root.find('[data-role="close"]');
        ...
        closeButton.on('click', function () {
            if ($(this).hasClass('intec-ui-mod-transparent')) {
                $(this).removeClass('intec-ui-mod-transparent');
            } else {
                $(this).addClass('intec-ui-mod-transparent');
            }
        });
